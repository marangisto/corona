...
////
//
//      STM32F0 CAN peripherals
//
///

// CAN: Controller area network

struct stm32f0x1_can_t
{
    ...
    volatile uint32_t CAN_BTR; // CAN BTR
...
using can_t = peripheral_t<svd, CAN>;

template<int INST> struct can_traits {};

template<> struct can_traits<0>
{
    using can = can_t;
    ...
    static void enable()
    {
        RCC::V.APB1ENR |= RCC::T::APB1ENR_CANEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR |= RCC::T::APB1RSTR_CANRST;
    }
};
