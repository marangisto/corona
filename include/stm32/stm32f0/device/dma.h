...
template<>
struct peripheral_t<STM32F0x0, DMA1>
{
    typedef stm32f0x0_dma1_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F0x1, DMA1>
{
    typedef stm32f0x0_dma1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F0x1, DMA2>
{
    typedef stm32f0x0_dma1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F0x2, DMA1>
{
    typedef stm32f0x0_dma1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F0x8, DMA1>
{
    typedef stm32f0x0_dma1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F0x8, DMA2>
{
    typedef stm32f0x0_dma1_t T;
    static T& V;
};
