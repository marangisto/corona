...
struct stm32f0x0_rcc_t
{
    ...
    typedef bit_field_t<8, 0x7> CFGR_PPRE; // APB Low speed prescaler (APB1)
    static constexpr uint32_t CFGR_ADCPRE = 0x4000; // ADC prescaler
    typedef bit_field_t<15, 0x3> CFGR_PLLSRC; // PLL input clock source
    ...
    static constexpr uint32_t CR2_RESET_VALUE = 0x80; // Reset value
    ...
    typedef bit_field_t<3, 0x1f> CR2_HSI14TRIM; // HSI14 clock trimming
    typedef bit_field_t<8, 0xff> CR2_HSI14CAL; // HSI14 clock calibration
