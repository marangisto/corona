...
template<>
struct peripheral_t<STM32F0x1, SYSCFG>
{
    static constexpr periph_t P = SYSCFG;
    using T = stm32f0x1_syscfg_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F0x2, SYSCFG>
{
    static constexpr periph_t P = SYSCFG;
    using T = stm32f0x1_syscfg_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F0x8, SYSCFG>
{
    static constexpr periph_t P = SYSCFG;
    using T = stm32f0x1_syscfg_t;
    static T& V;
