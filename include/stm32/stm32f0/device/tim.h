...
struct stm32f0x0_tim3_t
{
    ...
    static constexpr uint32_t DMAR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> DMAR_DMAR; // DMA register for burst accesses
};
...
struct stm32f0x0_tim14_t
{
    ...
    typedef bit_field_t<0, 0x3> OR_RMP; // Timer input 1 remap
};
