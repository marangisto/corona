...
template<>
struct peripheral_t<STM32F0x1, TSC>
{
    typedef stm32f0x1_tsc_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F0x2, TSC>
{
    typedef stm32f0x1_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F0x8, TSC>
{
    typedef stm32f0x1_tsc_t T;
    static T& V;
};
