...
{
    static constexpr periph_t P = USART7;
    using T = stm32f0x0_usart1_t;
    static T& V;
};
...
{
    static constexpr periph_t P = USART8;
    using T = stm32f0x0_usart1_t;
    static T& V;
};
...
using usart7_t = peripheral_t<svd, USART7>;
using usart8_t = peripheral_t<svd, USART8>;
...
template<> struct usart_traits<7>
{
    ...
    static constexpr signal_t CK = USART7_CK;
    static constexpr signal_t RTS = USART7_RTS;
    static constexpr signal_t RX = USART7_RX;
    static constexpr signal_t TX = USART7_TX;
    static constexpr clock_source_t CS = APB2_PERIPH;

    template<typename RCC>
    static void enable()
    {
        RCC::V.APB2ENR |= RCC::T::APB2ENR_USART7EN;
    }
...
template<> struct usart_traits<8>
{
    ...
    static constexpr signal_t CK = USART8_CK;
    static constexpr signal_t RTS = USART8_RTS;
    static constexpr signal_t RX = USART8_RX;
    static constexpr signal_t TX = USART8_TX;
    static constexpr clock_source_t CS = APB2_PERIPH;

    template<typename RCC>
    static void enable()
    {
        RCC::V.APB2ENR |= RCC::T::APB2ENR_USART8EN;
    }
