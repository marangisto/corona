...
template<> void handler<interrupt::DMA1_CH2_3>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
template<> void handler<interrupt::DMA1_CH4_5>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
template<> void handler<interrupt::USART3_4_5_6>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
void (*vectors[])(void) __attribute__ ((section(".vectors"))) =
    ...
    , handler<interrupt::RCC>                             // 4: RCC global interruptr
    ...
    , handler<interrupt::DMA1_CH2_3>                      // 10: DMA1 channel 2 and 3 interrupt
    , handler<interrupt::DMA1_CH4_5>                      // 11: DMA1 channel 4 and 5 interrupt
    , handler<interrupt::ADC>                             // 12: ADC interrupt
    ...
    , handler<interrupt::TIM6>                            // 17: TIM6 global interrupt
    ...
    , handler<interrupt::USART3_4_5_6>                    // 29: USART3, USART4, USART5, USART6 global interrupt
