...
template<> struct mco_sel<PA8, mco_hsi14> { static const int value = 0x1; };
template<> struct mco_sel<PA8, mco_lsi> { static const int value = 0x2; };
template<> struct mco_sel<PA8, mco_lse> { static const int value = 0x3; };
...
template<> struct mco_pre<32> { static const int value = 0x5; };
template<> struct mco_pre<64> { static const int value = 0x6; };
template<> struct mco_pre<128> { static const int value = 0x7; };
