...
////
//
//      STM32F1 CAN peripherals
//
///

// CAN1: Controller area network

struct stm32f101_can1_t
{
...
struct stm32f102_can1_t
{
    volatile uint32_t CAN_MCR; // CAN_MCR
    ...
    volatile uint32_t CAN_IER; // CAN_IER
    volatile uint32_t CAN_ESR; // CAN_ESR
    volatile uint32_t CAN_BTR; // CAN_BTR
    reserved_t<0x58> _0x20;
    volatile uint32_t CAN_TI0R; // CAN_TI0R
    volatile uint32_t CAN_TDT0R; // CAN_TDT0R
    volatile uint32_t CAN_TDL0R; // CAN_TDL0R
    volatile uint32_t CAN_TDH0R; // CAN_TDH0R
    volatile uint32_t CAN_TI1R; // CAN_TI1R
    volatile uint32_t CAN_TDT1R; // CAN_TDT1R
    volatile uint32_t CAN_TDL1R; // CAN_TDL1R
    volatile uint32_t CAN_TDH1R; // CAN_TDH1R
    volatile uint32_t CAN_TI2R; // CAN_TI2R
    volatile uint32_t CAN_TDT2R; // CAN_TDT2R
    volatile uint32_t CAN_TDL2R; // CAN_TDL2R
    volatile uint32_t CAN_TDH2R; // CAN_TDH2R
    volatile uint32_t CAN_RI0R; // CAN_RI0R
    volatile uint32_t CAN_RDT0R; // CAN_RDT0R
    volatile uint32_t CAN_RDL0R; // CAN_RDL0R
    volatile uint32_t CAN_RDH0R; // CAN_RDH0R
    volatile uint32_t CAN_RI1R; // CAN_RI1R
    volatile uint32_t CAN_RDT1R; // CAN_RDT1R
    volatile uint32_t CAN_RDL1R; // CAN_RDL1R
    volatile uint32_t CAN_RDH1R; // CAN_RDH1R
    reserved_t<0xc> _0x1d0;
    volatile uint32_t CAN_FMR; // CAN_FMR
    volatile uint32_t CAN_FM1R; // CAN_FM1R
    reserved_t<0x1> _0x208;
    volatile uint32_t CAN_FS1R; // CAN_FS1R
    reserved_t<0x1> _0x210;
    volatile uint32_t CAN_FFA1R; // CAN_FFA1R
    reserved_t<0x1> _0x218;
    volatile uint32_t CAN_FA1R; // CAN_FA1R
    reserved_t<0x8> _0x220;
    volatile uint32_t F0R1; // Filter bank 0 register 1
    volatile uint32_t F0R2; // Filter bank 0 register 2
    volatile uint32_t F1R1; // Filter bank 1 register 1
    ...
    static constexpr uint32_t CAN_MCR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CAN_MSR_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t CAN_MSR_RX = 0x800; // RX
    static constexpr uint32_t CAN_MSR_SAMP = 0x400; // SAMP
    static constexpr uint32_t CAN_MSR_RXM = 0x200; // RXM
    static constexpr uint32_t CAN_MSR_TXM = 0x100; // TXM
    static constexpr uint32_t CAN_MSR_SLAKI = 0x10; // SLAKI
    static constexpr uint32_t CAN_MSR_WKUI = 0x8; // WKUI
    static constexpr uint32_t CAN_MSR_ERRI = 0x4; // ERRI
    static constexpr uint32_t CAN_MSR_SLAK = 0x2; // SLAK
    static constexpr uint32_t CAN_MSR_INAK = 0x1; // INAK

    static constexpr uint32_t CAN_TSR_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t CAN_TSR_LOW2 = 0x80000000; // Lowest priority flag for mailbox 2
    static constexpr uint32_t CAN_TSR_LOW1 = 0x40000000; // Lowest priority flag for mailbox 1
    static constexpr uint32_t CAN_TSR_LOW0 = 0x20000000; // Lowest priority flag for mailbox 0
    static constexpr uint32_t CAN_TSR_TME2 = 0x10000000; // Lowest priority flag for mailbox 2
    static constexpr uint32_t CAN_TSR_TME1 = 0x8000000; // Lowest priority flag for mailbox 1
    static constexpr uint32_t CAN_TSR_TME0 = 0x4000000; // Lowest priority flag for mailbox 0
    typedef bit_field_t<24, 0x3> CAN_TSR_CODE; // CODE
    static constexpr uint32_t CAN_TSR_ABRQ2 = 0x800000; // ABRQ2
    static constexpr uint32_t CAN_TSR_TERR2 = 0x80000; // TERR2
    static constexpr uint32_t CAN_TSR_ALST2 = 0x40000; // ALST2
    static constexpr uint32_t CAN_TSR_TXOK2 = 0x20000; // TXOK2
    static constexpr uint32_t CAN_TSR_RQCP2 = 0x10000; // RQCP2
    static constexpr uint32_t CAN_TSR_ABRQ1 = 0x8000; // ABRQ1
    static constexpr uint32_t CAN_TSR_TERR1 = 0x800; // TERR1
    static constexpr uint32_t CAN_TSR_ALST1 = 0x400; // ALST1
    static constexpr uint32_t CAN_TSR_TXOK1 = 0x200; // TXOK1
    static constexpr uint32_t CAN_TSR_RQCP1 = 0x100; // RQCP1
    static constexpr uint32_t CAN_TSR_ABRQ0 = 0x80; // ABRQ0
    static constexpr uint32_t CAN_TSR_TERR0 = 0x8; // TERR0
    static constexpr uint32_t CAN_TSR_ALST0 = 0x4; // ALST0
    static constexpr uint32_t CAN_TSR_TXOK0 = 0x2; // TXOK0
    static constexpr uint32_t CAN_TSR_RQCP0 = 0x1; // RQCP0

    static constexpr uint32_t CAN_RF0R_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t CAN_RF0R_RFOM0 = 0x20; // RFOM0
    static constexpr uint32_t CAN_RF0R_FOVR0 = 0x10; // FOVR0
    static constexpr uint32_t CAN_RF0R_FULL0 = 0x8; // FULL0
    typedef bit_field_t<0, 0x3> CAN_RF0R_FMP0; // FMP0

    static constexpr uint32_t CAN_RF1R_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t CAN_RF1R_RFOM1 = 0x20; // RFOM1
    static constexpr uint32_t CAN_RF1R_FOVR1 = 0x10; // FOVR1
    static constexpr uint32_t CAN_RF1R_FULL1 = 0x8; // FULL1
    typedef bit_field_t<0, 0x3> CAN_RF1R_FMP1; // FMP1

    static constexpr uint32_t CAN_IER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CAN_ESR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_ESR_REC; // REC
    typedef bit_field_t<16, 0xff> CAN_ESR_TEC; // TEC
    typedef bit_field_t<4, 0x7> CAN_ESR_LEC; // LEC
    static constexpr uint32_t CAN_ESR_BOFF = 0x4; // BOFF
    static constexpr uint32_t CAN_ESR_EPVF = 0x2; // EPVF
    static constexpr uint32_t CAN_ESR_EWGF = 0x1; // EWGF

    static constexpr uint32_t CAN_BTR_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t CAN_BTR_SILM = 0x80000000; // SILM
    static constexpr uint32_t CAN_BTR_LBKM = 0x40000000; // LBKM
    typedef bit_field_t<24, 0x3> CAN_BTR_SJW; // SJW
    typedef bit_field_t<20, 0x7> CAN_BTR_TS2; // TS2
    typedef bit_field_t<16, 0xf> CAN_BTR_TS1; // TS1
    typedef bit_field_t<0, 0x3ff> CAN_BTR_BRP; // BRP


    static constexpr uint32_t CAN_TI0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<21, 0x7ff> CAN_TI0R_STID; // STID
    typedef bit_field_t<3, 0x3ffff> CAN_TI0R_EXID; // EXID
    ...
    static constexpr uint32_t CAN_TDT0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<16, 0xffff> CAN_TDT0R_TIME; // TIME
    static constexpr uint32_t CAN_TDT0R_TGT = 0x100; // TGT
    typedef bit_field_t<0, 0xf> CAN_TDT0R_DLC; // DLC

    static constexpr uint32_t CAN_TDL0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_TDL0R_DATA3; // DATA3
    typedef bit_field_t<16, 0xff> CAN_TDL0R_DATA2; // DATA2
    typedef bit_field_t<8, 0xff> CAN_TDL0R_DATA1; // DATA1
    typedef bit_field_t<0, 0xff> CAN_TDL0R_DATA0; // DATA0

    static constexpr uint32_t CAN_TDH0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_TDH0R_DATA7; // DATA7
    typedef bit_field_t<16, 0xff> CAN_TDH0R_DATA6; // DATA6
    typedef bit_field_t<8, 0xff> CAN_TDH0R_DATA5; // DATA5
    typedef bit_field_t<0, 0xff> CAN_TDH0R_DATA4; // DATA4

    static constexpr uint32_t CAN_TI1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<21, 0x7ff> CAN_TI1R_STID; // STID
    typedef bit_field_t<3, 0x3ffff> CAN_TI1R_EXID; // EXID
    ...
    static constexpr uint32_t CAN_TDT1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<16, 0xffff> CAN_TDT1R_TIME; // TIME
    static constexpr uint32_t CAN_TDT1R_TGT = 0x100; // TGT
    typedef bit_field_t<0, 0xf> CAN_TDT1R_DLC; // DLC

    static constexpr uint32_t CAN_TDL1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_TDL1R_DATA3; // DATA3
    typedef bit_field_t<16, 0xff> CAN_TDL1R_DATA2; // DATA2
    typedef bit_field_t<8, 0xff> CAN_TDL1R_DATA1; // DATA1
    typedef bit_field_t<0, 0xff> CAN_TDL1R_DATA0; // DATA0

    static constexpr uint32_t CAN_TDH1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_TDH1R_DATA7; // DATA7
    typedef bit_field_t<16, 0xff> CAN_TDH1R_DATA6; // DATA6
    typedef bit_field_t<8, 0xff> CAN_TDH1R_DATA5; // DATA5
    typedef bit_field_t<0, 0xff> CAN_TDH1R_DATA4; // DATA4

    static constexpr uint32_t CAN_TI2R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<21, 0x7ff> CAN_TI2R_STID; // STID
    typedef bit_field_t<3, 0x3ffff> CAN_TI2R_EXID; // EXID
    ...
    static constexpr uint32_t CAN_TDT2R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<16, 0xffff> CAN_TDT2R_TIME; // TIME
    static constexpr uint32_t CAN_TDT2R_TGT = 0x100; // TGT
    typedef bit_field_t<0, 0xf> CAN_TDT2R_DLC; // DLC

    static constexpr uint32_t CAN_TDL2R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_TDL2R_DATA3; // DATA3
    typedef bit_field_t<16, 0xff> CAN_TDL2R_DATA2; // DATA2
    typedef bit_field_t<8, 0xff> CAN_TDL2R_DATA1; // DATA1
    typedef bit_field_t<0, 0xff> CAN_TDL2R_DATA0; // DATA0

    static constexpr uint32_t CAN_TDH2R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_TDH2R_DATA7; // DATA7
    typedef bit_field_t<16, 0xff> CAN_TDH2R_DATA6; // DATA6
    typedef bit_field_t<8, 0xff> CAN_TDH2R_DATA5; // DATA5
    typedef bit_field_t<0, 0xff> CAN_TDH2R_DATA4; // DATA4

    static constexpr uint32_t CAN_RI0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<21, 0x7ff> CAN_RI0R_STID; // STID
    typedef bit_field_t<3, 0x3ffff> CAN_RI0R_EXID; // EXID
    static constexpr uint32_t CAN_RI0R_IDE = 0x4; // IDE
    static constexpr uint32_t CAN_RI0R_RTR = 0x2; // RTR

    static constexpr uint32_t CAN_RDT0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<16, 0xffff> CAN_RDT0R_TIME; // TIME
    typedef bit_field_t<8, 0xff> CAN_RDT0R_FMI; // FMI
    typedef bit_field_t<0, 0xf> CAN_RDT0R_DLC; // DLC

    static constexpr uint32_t CAN_RDL0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_RDL0R_DATA3; // DATA3
    typedef bit_field_t<16, 0xff> CAN_RDL0R_DATA2; // DATA2
    typedef bit_field_t<8, 0xff> CAN_RDL0R_DATA1; // DATA1
    typedef bit_field_t<0, 0xff> CAN_RDL0R_DATA0; // DATA0

    static constexpr uint32_t CAN_RDH0R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_RDH0R_DATA7; // DATA7
    typedef bit_field_t<16, 0xff> CAN_RDH0R_DATA6; // DATA6
    typedef bit_field_t<8, 0xff> CAN_RDH0R_DATA5; // DATA5
    typedef bit_field_t<0, 0xff> CAN_RDH0R_DATA4; // DATA4

    static constexpr uint32_t CAN_RI1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<21, 0x7ff> CAN_RI1R_STID; // STID
    typedef bit_field_t<3, 0x3ffff> CAN_RI1R_EXID; // EXID
    static constexpr uint32_t CAN_RI1R_IDE = 0x4; // IDE
    static constexpr uint32_t CAN_RI1R_RTR = 0x2; // RTR

    static constexpr uint32_t CAN_RDT1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<16, 0xffff> CAN_RDT1R_TIME; // TIME
    typedef bit_field_t<8, 0xff> CAN_RDT1R_FMI; // FMI
    typedef bit_field_t<0, 0xf> CAN_RDT1R_DLC; // DLC

    static constexpr uint32_t CAN_RDL1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_RDL1R_DATA3; // DATA3
    typedef bit_field_t<16, 0xff> CAN_RDL1R_DATA2; // DATA2
    typedef bit_field_t<8, 0xff> CAN_RDL1R_DATA1; // DATA1
    typedef bit_field_t<0, 0xff> CAN_RDL1R_DATA0; // DATA0

    static constexpr uint32_t CAN_RDH1R_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> CAN_RDH1R_DATA7; // DATA7
    typedef bit_field_t<16, 0xff> CAN_RDH1R_DATA6; // DATA6
    typedef bit_field_t<8, 0xff> CAN_RDH1R_DATA5; // DATA5
    typedef bit_field_t<0, 0xff> CAN_RDH1R_DATA4; // DATA4


    static constexpr uint32_t CAN_FMR_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t CAN_FMR_FINIT = 0x1; // FINIT

    static constexpr uint32_t CAN_FM1R_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CAN_FS1R_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CAN_FFA1R_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CAN_FA1R_RESET_VALUE = 0x0; // Reset value
...
struct stm32f107_can1_t
{
    ...
    static constexpr uint32_t CAN_FMR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> CAN_FMR_CAN2SB; // CAN2SB
    static constexpr uint32_t CAN_FMR_FINIT = 0x1; // FINIT
    ...
    static constexpr uint32_t CAN_FM1R_FBM12 = 0x1000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM13 = 0x2000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM14 = 0x4000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM15 = 0x8000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM16 = 0x10000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM17 = 0x20000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM18 = 0x40000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM19 = 0x80000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM20 = 0x100000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM21 = 0x200000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM22 = 0x400000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM23 = 0x800000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM24 = 0x1000000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM25 = 0x2000000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM26 = 0x4000000; // Filter mode
    static constexpr uint32_t CAN_FM1R_FBM27 = 0x8000000; // Filter mode
    ...
    static constexpr uint32_t CAN_FS1R_FSC12 = 0x1000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC13 = 0x2000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC14 = 0x4000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC15 = 0x8000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC16 = 0x10000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC17 = 0x20000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC18 = 0x40000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC19 = 0x80000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC20 = 0x100000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC21 = 0x200000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC22 = 0x400000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC23 = 0x800000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC24 = 0x1000000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC25 = 0x2000000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC26 = 0x4000000; // Filter scale configuration
    static constexpr uint32_t CAN_FS1R_FSC27 = 0x8000000; // Filter scale configuration
    ...
    static constexpr uint32_t CAN_FFA1R_FFA12 = 0x1000; // Filter FIFO assignment for filter 12
    static constexpr uint32_t CAN_FFA1R_FFA13 = 0x2000; // Filter FIFO assignment for filter 13
    static constexpr uint32_t CAN_FFA1R_FFA14 = 0x4000; // Filter FIFO assignment for filter 14
    static constexpr uint32_t CAN_FFA1R_FFA15 = 0x8000; // Filter FIFO assignment for filter 15
    static constexpr uint32_t CAN_FFA1R_FFA16 = 0x10000; // Filter FIFO assignment for filter 16
    static constexpr uint32_t CAN_FFA1R_FFA17 = 0x20000; // Filter FIFO assignment for filter 17
    static constexpr uint32_t CAN_FFA1R_FFA18 = 0x40000; // Filter FIFO assignment for filter 18
    static constexpr uint32_t CAN_FFA1R_FFA19 = 0x80000; // Filter FIFO assignment for filter 19
    static constexpr uint32_t CAN_FFA1R_FFA20 = 0x100000; // Filter FIFO assignment for filter 20
    static constexpr uint32_t CAN_FFA1R_FFA21 = 0x200000; // Filter FIFO assignment for filter 21
    static constexpr uint32_t CAN_FFA1R_FFA22 = 0x400000; // Filter FIFO assignment for filter 22
    static constexpr uint32_t CAN_FFA1R_FFA23 = 0x800000; // Filter FIFO assignment for filter 23
    static constexpr uint32_t CAN_FFA1R_FFA24 = 0x1000000; // Filter FIFO assignment for filter 24
    static constexpr uint32_t CAN_FFA1R_FFA25 = 0x2000000; // Filter FIFO assignment for filter 25
    static constexpr uint32_t CAN_FFA1R_FFA26 = 0x4000000; // Filter FIFO assignment for filter 26
    static constexpr uint32_t CAN_FFA1R_FFA27 = 0x8000000; // Filter FIFO assignment for filter 27
    ...
    static constexpr uint32_t CAN_FA1R_FACT12 = 0x1000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT13 = 0x2000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT14 = 0x4000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT15 = 0x8000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT16 = 0x10000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT17 = 0x20000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT18 = 0x40000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT19 = 0x80000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT20 = 0x100000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT21 = 0x200000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT22 = 0x400000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT23 = 0x800000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT24 = 0x1000000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT25 = 0x2000000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT26 = 0x4000000; // Filter active
    static constexpr uint32_t CAN_FA1R_FACT27 = 0x8000000; // Filter active
...
template<>
struct peripheral_t<STM32F101, CAN1>
{
    using T = stm32f101_can1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F101, CAN2>
{
    using T = stm32f101_can1_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F102, CAN1>
{
    using T = stm32f102_can1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F102, CAN2>
{
    using T = stm32f102_can1_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F103, CAN1>
{
    using T = stm32f102_can1_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F103, CAN2>
{
    using T = stm32f102_can1_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F107, CAN1>
{
    using T = stm32f107_can1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F107, CAN2>
{
    using T = stm32f107_can2_t;
    static T& V;
};
