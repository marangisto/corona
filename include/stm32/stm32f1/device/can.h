...
struct stm32f102_can1_t
{
    ...
    static constexpr uint32_t CAN_MCR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CAN_MSR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CAN_TSR_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CAN_TSR_CODE =             // CODE
        bit_field_t<24, 0x3>::value<X>();
    ...
    static constexpr uint32_t CAN_RF0R_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CAN_RF0R_FMP0 =        // FMP0
        bit_field_t<0, 0x3>::value<X>();

    static constexpr uint32_t CAN_RF1R_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CAN_RF1R_FMP1 =        // FMP1
        bit_field_t<0, 0x3>::value<X>();

    static constexpr uint32_t CAN_IER_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CAN_ESR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_ESR_REC =       // REC
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_ESR_TEC =       // TEC
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_ESR_LEC =       // LEC
        bit_field_t<4, 0x7>::value<X>();
    ...
    static constexpr uint32_t CAN_BTR_RESET_VALUE = 0x0;
    static constexpr uint32_t CAN_BTR_SILM = 0x80000000; // SILM
    static constexpr uint32_t CAN_BTR_LBKM = 0x40000000; // LBKM
    template<uint32_t X>
    static constexpr uint32_t CAN_BTR_SJW =              // SJW
        bit_field_t<24, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_BTR_TS2 =              // TS2
        bit_field_t<20, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_BTR_TS1 =              // TS1
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_BTR_BRP =              // BRP
        bit_field_t<0, 0x3ff>::value<X>();

    static constexpr uint32_t CAN_TI0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TI0R_STID =      // STID
        bit_field_t<21, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TI0R_EXID =      // EXID
        bit_field_t<3, 0x3ffff>::value<X>();
    ...
    static constexpr uint32_t CAN_TDT0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDT0R_TIME =       // TIME
        bit_field_t<16, 0xffff>::value<X>();
    static constexpr uint32_t CAN_TDT0R_TGT = 0x100; // TGT
    template<uint32_t X>
    static constexpr uint32_t CAN_TDT0R_DLC =        // DLC
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t CAN_TDL0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL0R_DATA3 =   // DATA3
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL0R_DATA2 =   // DATA2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL0R_DATA1 =   // DATA1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL0R_DATA0 =   // DATA0
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_TDH0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH0R_DATA7 =   // DATA7
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH0R_DATA6 =   // DATA6
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH0R_DATA5 =   // DATA5
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH0R_DATA4 =   // DATA4
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_TI1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TI1R_STID =      // STID
        bit_field_t<21, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TI1R_EXID =      // EXID
        bit_field_t<3, 0x3ffff>::value<X>();
    ...
    static constexpr uint32_t CAN_TDT1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDT1R_TIME =       // TIME
        bit_field_t<16, 0xffff>::value<X>();
    static constexpr uint32_t CAN_TDT1R_TGT = 0x100; // TGT
    template<uint32_t X>
    static constexpr uint32_t CAN_TDT1R_DLC =        // DLC
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t CAN_TDL1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL1R_DATA3 =   // DATA3
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL1R_DATA2 =   // DATA2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL1R_DATA1 =   // DATA1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL1R_DATA0 =   // DATA0
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_TDH1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH1R_DATA7 =   // DATA7
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH1R_DATA6 =   // DATA6
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH1R_DATA5 =   // DATA5
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH1R_DATA4 =   // DATA4
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_TI2R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TI2R_STID =      // STID
        bit_field_t<21, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TI2R_EXID =      // EXID
        bit_field_t<3, 0x3ffff>::value<X>();
    ...
    static constexpr uint32_t CAN_TDT2R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDT2R_TIME =       // TIME
        bit_field_t<16, 0xffff>::value<X>();
    static constexpr uint32_t CAN_TDT2R_TGT = 0x100; // TGT
    template<uint32_t X>
    static constexpr uint32_t CAN_TDT2R_DLC =        // DLC
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t CAN_TDL2R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL2R_DATA3 =   // DATA3
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL2R_DATA2 =   // DATA2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL2R_DATA1 =   // DATA1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDL2R_DATA0 =   // DATA0
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_TDH2R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH2R_DATA7 =   // DATA7
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH2R_DATA6 =   // DATA6
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH2R_DATA5 =   // DATA5
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_TDH2R_DATA4 =   // DATA4
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_RI0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RI0R_STID =     // STID
        bit_field_t<21, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RI0R_EXID =     // EXID
        bit_field_t<3, 0x3ffff>::value<X>();
    static constexpr uint32_t CAN_RI0R_IDE = 0x4; // IDE
    static constexpr uint32_t CAN_RI0R_RTR = 0x2; // RTR

    static constexpr uint32_t CAN_RDT0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RDT0R_TIME =   // TIME
        bit_field_t<16, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDT0R_FMI =    // FMI
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDT0R_DLC =    // DLC
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t CAN_RDL0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL0R_DATA3 =   // DATA3
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL0R_DATA2 =   // DATA2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL0R_DATA1 =   // DATA1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL0R_DATA0 =   // DATA0
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_RDH0R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH0R_DATA7 =   // DATA7
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH0R_DATA6 =   // DATA6
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH0R_DATA5 =   // DATA5
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH0R_DATA4 =   // DATA4
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_RI1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RI1R_STID =     // STID
        bit_field_t<21, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RI1R_EXID =     // EXID
        bit_field_t<3, 0x3ffff>::value<X>();
    static constexpr uint32_t CAN_RI1R_IDE = 0x4; // IDE
    static constexpr uint32_t CAN_RI1R_RTR = 0x2; // RTR

    static constexpr uint32_t CAN_RDT1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RDT1R_TIME =   // TIME
        bit_field_t<16, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDT1R_FMI =    // FMI
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDT1R_DLC =    // DLC
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t CAN_RDL1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL1R_DATA3 =   // DATA3
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL1R_DATA2 =   // DATA2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL1R_DATA1 =   // DATA1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDL1R_DATA0 =   // DATA0
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_RDH1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH1R_DATA7 =   // DATA7
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH1R_DATA6 =   // DATA6
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH1R_DATA5 =   // DATA5
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CAN_RDH1R_DATA4 =   // DATA4
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CAN_FMR_RESET_VALUE = 0x0;
    static constexpr uint32_t CAN_FMR_FINIT = 0x1; // FINIT

    static constexpr uint32_t CAN_FM1R_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CAN_FS1R_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CAN_FFA1R_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CAN_FA1R_RESET_VALUE = 0x0;
...
struct stm32f107_can1_t
{
    ...
    static constexpr uint32_t CAN_FMR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CAN_FMR_CAN2SB =     // CAN2SB
        bit_field_t<8, 0x3f>::value<X>();
    static constexpr uint32_t CAN_FMR_FINIT = 0x1; // FINIT
