...
struct stm32f100_dac_t
{
    ...
    static constexpr uint32_t DHR12LD_DACC1DHR =   // DAC channel1 12-bit left-aligned data
        bit_field_t<4, 0xfff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DHR12LD_DACC2DHR =   // DAC channel2 12-bit right-aligned data
...
template<>
struct peripheral_t<STM32F100, DAC>
{
    typedef stm32f100_dac_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F102, DAC>
{
    typedef stm32f100_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F101, DAC>
{
    typedef stm32f101_dac_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F103, DAC>
{
    typedef stm32f101_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F107, DAC>
{
    typedef stm32f101_dac_t T;
    static T& V;
};
