...
template<> struct alt_fun_traits<PA11, CAN1_RX> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
...
template<> struct alt_fun_traits<PA12, CAN1_TX> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
...
template<> struct alt_fun_traits<PA15, I2S3_WS> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
template<> struct alt_fun_traits<PA15, SPI3_NSS> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
...
template<> struct alt_fun_traits<PA7, ETH_CRS_DV> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
template<> struct alt_fun_traits<PA7, ETH_RX_DV> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
...
template<> struct alt_fun_traits<PB0, ETH_RXD2> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
template<> struct alt_fun_traits<PB0, TIM3_CH3> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB1, ETH_RXD3> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
template<> struct alt_fun_traits<PB1, TIM3_CH4> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB10, USART3_TX> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PB11, USART3_RX> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PB12, CAN2_RX> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
template<> struct alt_fun_traits<PB12, TIM1_BKIN> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB12, USART3_CK> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PB13, CAN2_TX> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
template<> struct alt_fun_traits<PB13, TIM1_CH1N> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB13, USART3_CTS> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PB14, TIM1_CH2N> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB14, USART3_RTS> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PB15, TIM1_CH3N> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB3, I2S3_CK> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
template<> struct alt_fun_traits<PB3, SPI3_SCK> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
template<> struct alt_fun_traits<PB4, SPI3_MISO> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
template<> struct alt_fun_traits<PB5, I2S3_SD> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
template<> struct alt_fun_traits<PB5, SPI3_MOSI> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC)> AF = AF0; };
template<> struct alt_fun_traits<PB6, I2C1_SCL> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB6, TIM4_CH1> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PB7, I2C1_SDA> { static const alt_fun_t AF = AF0; };
template<> struct alt_fun_traits<PB7, TIM4_CH2> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
...
template<> struct alt_fun_traits<PB8, TIM4_CH3> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
...
template<> struct alt_fun_traits<PB9, TIM4_CH4> { static const alt_fun<gpio_conf & (STM32F107|STM32F103xF|STM32F103xC|STM32F103x8|STM32F100xC|STM32F100x8)> AF = AF0; };
template<> struct alt_fun_traits<PC4, ETH_RXD0> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
template<> struct alt_fun_traits<PC4, TIM12_CH1> { static const alt_fun<gpio_conf & STM32F100xC> AF = AF0; };
template<> struct alt_fun_traits<PC5, ETH_RXD1> { static const alt_fun<gpio_conf & STM32F107> AF = AF0; };
