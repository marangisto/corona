...
struct stm32f100_rcc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR2_PREDIV1 =   // PREDIV1 division factor
...
struct stm32f107_rcc_t
{
    ...
    volatile uint32_t BDCR;     // Backup domain control register (RCC_BDCR)
    volatile uint32_t CSR;      // Control/status register (RCC_CSR)
    volatile uint32_t AHBRSTR;  // [read-write] AHB peripheral clock reset register (RCC_AHBRSTR)
    volatile uint32_t CFGR2;    // [read-write] Clock configuration register2 (RCC_CFGR2)
    ...
    static constexpr uint32_t CFGR2_PREDIV1 =             // PREDIV1 division factor
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR2_PREDIV2 =             // PREDIV2 division factor
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR2_PLL2MUL =             // PLL2 Multiplication Factor
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR2_PLL3MUL =             // PLL3 Multiplication Factor
