...
////
//
//      STM32F1 USB_OTG_FS peripherals
//
////
...
struct stm32f101_otg_fs_device_t
{
...
struct stm32f101_otg_fs_global_t
{
...
struct stm32f101_otg_fs_host_t
{
...
struct stm32f101_otg_fs_pwrclk_t
{
...
template<>
struct peripheral_t<STM32F101, OTG_FS_DEVICE>
{
    typedef stm32f101_otg_fs_device_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F102, OTG_FS_DEVICE>
{
    typedef stm32f101_otg_fs_device_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F103, OTG_FS_DEVICE>
{
    typedef stm32f101_otg_fs_device_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F107, USB_OTG_DEVICE>
{
    typedef stm32f101_otg_fs_device_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F101, OTG_FS_GLOBAL>
{
    typedef stm32f101_otg_fs_global_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F102, OTG_FS_GLOBAL>
{
    typedef stm32f101_otg_fs_global_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F103, OTG_FS_GLOBAL>
{
    typedef stm32f101_otg_fs_global_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F101, OTG_FS_HOST>
{
    typedef stm32f101_otg_fs_host_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F102, OTG_FS_HOST>
{
    typedef stm32f101_otg_fs_host_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F103, OTG_FS_HOST>
{
    typedef stm32f101_otg_fs_host_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F107, USB_OTG_HOST>
{
    typedef stm32f101_otg_fs_host_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F101, OTG_FS_PWRCLK>
{
    typedef stm32f101_otg_fs_pwrclk_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F102, OTG_FS_PWRCLK>
{
    typedef stm32f101_otg_fs_pwrclk_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F103, OTG_FS_PWRCLK>
{
    typedef stm32f101_otg_fs_pwrclk_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F107, USB_OTG_PWRCLK>
{
    typedef stm32f101_otg_fs_pwrclk_t T;
    static T& V;
};
...
using usb_otg_device_t = peripheral_t<mcu_svd, USB_OTG_DEVICE>;
using usb_otg_host_t = peripheral_t<mcu_svd, USB_OTG_HOST>;
using usb_otg_pwrclk_t = peripheral_t<mcu_svd, USB_OTG_PWRCLK>;
