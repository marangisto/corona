...
template<> void handler<interrupt::RTCALARM>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
void (*vectors[])(void) __attribute__ ((section(".vectors"))) =
    ...
    , handler<interrupt::RTCALARM>                  // 41: RTC Alarms through EXTI line interrupt
    , handler<interrupt::CEC>                       // 42: CEC global interrupt
    , handler<interrupt::TIM12>                     // 43: TIM12 global interrupt
    , handler<interrupt::TIM13>                     // 44: TIM13 global interrupt
    , handler<interrupt::TIM14>                     // 45: TIM14 global interrupt
