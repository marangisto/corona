...
struct stm32f215_adc1_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t SMPR1_SMP18 =   // Channel 18 sampling time selection
...
template<>
struct peripheral_t<STM32F215, ADC1>
{
    typedef stm32f215_adc1_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F215, ADC2>
{
    typedef stm32f215_adc1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F215, ADC3>
{
    typedef stm32f215_adc1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F217, ADC1>
{
    typedef stm32f215_adc1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F217, ADC2>
{
    typedef stm32f215_adc1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F217, ADC3>
{
    typedef stm32f215_adc1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F215, ADC_COMMON>
{
    typedef stm32f215_adc_common_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F217, ADC_COMMON>
{
    typedef stm32f215_adc_common_t T;
    static T& V;
};
