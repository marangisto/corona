...
struct stm32f215_can2_t
{
    ...
    static constexpr uint32_t MSR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t TSR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t FMR_RESET_VALUE = 0x0;
    template<uint32_t X>
