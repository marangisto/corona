...
////
//
//      STM32F2 CAN peripherals
//
///

// CAN2: Controller area network

struct stm32f215_can2_t
{
    ...
    static constexpr uint32_t MSR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TSR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t FMR_RESET_VALUE = 0x0; // Reset value
...
template<>
struct peripheral_t<STM32F215, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32f215_can2_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F215, CAN2>
{
...
template<>
struct peripheral_t<STM32F217, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32f215_can2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F217, CAN2>
{
    static constexpr periph_t P = CAN2;
    using T = stm32f215_can2_t;
    static T& V;
