...
template<>
struct peripheral_t<STM32F215, DMA2>
{
    typedef stm32f215_dma2_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F215, DMA1>
{
    typedef stm32f215_dma2_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F217, DMA2>
{
    typedef stm32f215_dma2_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F217, DMA1>
{
    typedef stm32f215_dma2_t T;
    static T& V;
};
