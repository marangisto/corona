...
struct stm32f215_hash_t
{
    volatile uint32_t CR;    // control register
    volatile uint32_t DIN;   // [read-write] data input register
    volatile uint32_t STR;   // [write-only] start register
    ...
    static constexpr uint32_t CR_ALGO = 0x80;    // Algorithm selection
...
template<>
struct peripheral_t<STM32F215, HASH>
{
    typedef stm32f215_hash_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F217, HASH>
{
    typedef stm32f215_hash_t T;
    static T& V;
};
