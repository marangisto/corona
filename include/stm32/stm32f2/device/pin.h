...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA0, ETH_CRS> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA0, SYS_WKUP> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, ETH_REF_CLK> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, ETH_RX_CLK> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA2, ETH_MDIO> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA3, ETH_COL> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, ETH_CRS_DV> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, ETH_RX_DV> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB0, ETH_RXD2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB1, ETH_RXD3> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB10, ETH_RX_ER> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB10, I2C2_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB10, I2S2_SCK> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB11, ETH_TX_EN> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, CAN2_RX> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, ETH_TXD0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, CAN2_TX> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, ETH_TXD1> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, I2S2_SCK> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, USB_OTG_HS_VBUS> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, I2S3_SCK> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, CAN2_RX> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, DCMI_D10> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, ETH_PPS_OUT> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB6, CAN2_TX> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB7, FSMC_NL> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, ETH_TXD3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, I2C1_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, SDIO_D4> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, SDIO_D5> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC1, ETH_MDC> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, DCMI_D8> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, I2S3_SCK> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, SDIO_D2> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, SDIO_D3> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, SDIO_CK> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC13, RTC_AF1> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC2, ETH_TXD2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC3, ETH_TX_CLK> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC4, ETH_RXD0> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, ETH_RXD1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, SDIO_D6> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, SDIO_D7> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC8, SDIO_D0> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, SDIO_D1> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, FSMC_D2> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, FSMC_DA2> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, CAN1_TX> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, FSMC_D3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, FSMC_DA3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, FSMC_D15> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, FSMC_DA15> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, USART3_CK> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD11, FSMC_A16> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD11, FSMC_CLE> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD11, USART3_CTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD12, FSMC_A17> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD12, FSMC_ALE> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD13, FSMC_A18> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD13, TIM4_CH2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD14, FSMC_D0> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD14, FSMC_DA0> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD14, TIM4_CH3> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, FSMC_D1> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, FSMC_DA1> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, SDIO_CMD> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, FSMC_CLK> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, USART2_CTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, FSMC_NOE> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, USART2_RTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD5, FSMC_NWE> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD5, USART2_TX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, FSMC_NWAIT> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, USART2_RX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, FSMC_NCE2> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, FSMC_NE1> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, USART2_CK> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, FSMC_D13> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, FSMC_DA13> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, USART3_TX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, FSMC_D14> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, FSMC_DA14> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, FSMC_NBL0> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, FSMC_NBL1> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE10, FSMC_D7> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE10, FSMC_DA7> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE10, TIM1_CH2N> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, FSMC_D8> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, FSMC_DA8> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, TIM1_CH2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE12, FSMC_D9> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE12, FSMC_DA9> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE12, TIM1_CH3N> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, FSMC_D10> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, FSMC_DA10> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, TIM1_CH3> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, FSMC_D11> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, FSMC_DA11> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, TIM1_CH4> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, FSMC_D12> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, FSMC_DA12> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, TIM1_BKIN> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, ETH_TXD3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, FSMC_A23> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, SYS_TRACECLK> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE3, FSMC_A19> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, FSMC_A20> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, FSMC_A21> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, FSMC_A22> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE7, FSMC_D4> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE7, FSMC_DA4> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE7, TIM1_ETR> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE8, FSMC_D5> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE8, FSMC_DA5> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE8, TIM1_CH1N> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE9, FSMC_D6> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE9, FSMC_DA6> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE9, TIM1_CH1> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF0, FSMC_A0> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF0, I2C2_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF1, FSMC_A1> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF1, I2C2_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, FSMC_INTR> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, DCMI_D12> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF12, FSMC_A6> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, FSMC_A7> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, FSMC_A8> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF15, FSMC_A9> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF2, FSMC_A2> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF2, I2C2_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF3, FSMC_A3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF4, FSMC_A4> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF5, FSMC_A5> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF6, FSMC_NIORD> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF6, TIM10_CH1> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF7, FSMC_NREG> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF7, TIM11_CH1> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF8, FSMC_NIOWR> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF8, TIM13_CH1> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF9, FSMC_CD> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF9, TIM14_CH1> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG0, FSMC_A10> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG1, FSMC_A11> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, FSMC_NCE4_1> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, FSMC_NE3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, ETH_TX_EN> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, FSMC_NCE4_2> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, FSMC_NE4> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, USART6_RTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, ETH_TXD0> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, FSMC_A24> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, USART6_CTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, ETH_TXD1> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, FSMC_A25> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG2, FSMC_A12> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG3, FSMC_A13> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG4, FSMC_A14> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG5, FSMC_A15> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG6, FSMC_INT2> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, FSMC_INT3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, USART6_CK> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, ETH_PPS_OUT> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, USART6_RTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, FSMC_NCE3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, FSMC_NE2> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH2, ETH_CRS> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH3, ETH_COL> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, ETH_RXD2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, ETH_RXD3> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI1, I2S2_SCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI1, SPI2_SCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, ETH_RX_ER> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI8, RTC_AF2> { static const alt_fun_t AF = AF0; };
