...
struct stm32f215_rcc_t
{
    ...
    static constexpr uint32_t CFGR_MCO21 = 0x80000000;    // Microcontroller clock output 2
    static constexpr uint32_t CFGR_MCO20 = 0x40000000;    // Microcontroller clock output 2
    static constexpr uint32_t CFGR_MCO2PRE2 = 0x20000000; // MCO2 prescaler
    static constexpr uint32_t CFGR_MCO2PRE1 = 0x10000000; // MCO2 prescaler
    static constexpr uint32_t CFGR_MCO2PRE0 = 0x8000000;  // MCO2 prescaler
    static constexpr uint32_t CFGR_MCO1PRE2 = 0x4000000;  // MCO1 prescaler
    static constexpr uint32_t CFGR_MCO1PRE1 = 0x2000000;  // MCO1 prescaler
    static constexpr uint32_t CFGR_MCO1PRE0 = 0x1000000;  // MCO1 prescaler
    static constexpr uint32_t CFGR_I2SSRC = 0x800000;     // I2S clock selection
    static constexpr uint32_t CFGR_MCO11 = 0x400000;      // Microcontroller clock output 1
    static constexpr uint32_t CFGR_MCO10 = 0x200000;      // Microcontroller clock output 1
