...
struct stm32f215_tim2_t
{
    ...
    volatile uint32_t DCR;          // [read-write] DMA control register
    volatile uint32_t DMAR;         // [read-write] DMA address for full transfer
    volatile uint32_t TIM2_OR;      // [read-write] TIM2 option register
    ...
    static constexpr uint32_t TIM2_OR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t TIM2_OR_IT4_RMP =   // Timer Input 4 remap
...
struct stm32f215_tim5_t
{
    ...
    volatile uint32_t DCR;          // [read-write] DMA control register
    volatile uint32_t DMAR;         // [read-write] DMA address for full transfer
    volatile uint32_t TIM5_OR;      // [read-write] TIM5 option register
    ...
    static constexpr uint32_t TIM5_OR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t TIM5_OR_IT4_RMP =   // Timer Input 4 remap
        bit_field_t<6, 0x3>::value<X>();
};
