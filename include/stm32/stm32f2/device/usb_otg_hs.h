...
////
//
//      STM32F2 USB_OTG_HS peripherals
//
///

// OTG_HS_DEVICE: USB on the go high speed

struct stm32f215_otg_hs_device_t
{
    ...
    static constexpr uint32_t OTG_HS_DIEPEACHMSK1_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t OTG_HS_DOEPEACHMSK1_RESET_VALUE = 0x0; // Reset value
...
struct stm32f215_otg_hs_global_t
{
    ...
    volatile uint32_t OTG_HS_GNPTXFSIZ_HOST; // OTG_HS nonperiodic transmit FIFO size register (host mode)
...
struct stm32f215_otg_hs_host_t
{
...
struct stm32f215_otg_hs_pwrclk_t
{
...
template<>
struct peripheral_t<STM32F215, OTG_HS_DEVICE>
{
    static constexpr periph_t P = OTG_HS_DEVICE;
    using T = stm32f215_otg_hs_device_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F217, OTG_HS_DEVICE>
{
    static constexpr periph_t P = OTG_HS_DEVICE;
    using T = stm32f215_otg_hs_device_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F215, OTG_HS_GLOBAL>
{
    static constexpr periph_t P = OTG_HS_GLOBAL;
    using T = stm32f215_otg_hs_global_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F217, OTG_HS_GLOBAL>
{
    static constexpr periph_t P = OTG_HS_GLOBAL;
    using T = stm32f215_otg_hs_global_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F215, OTG_HS_HOST>
{
    static constexpr periph_t P = OTG_HS_HOST;
    using T = stm32f215_otg_hs_host_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F217, OTG_HS_HOST>
{
    static constexpr periph_t P = OTG_HS_HOST;
    using T = stm32f215_otg_hs_host_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F215, OTG_HS_PWRCLK>
{
    static constexpr periph_t P = OTG_HS_PWRCLK;
    using T = stm32f215_otg_hs_pwrclk_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F217, OTG_HS_PWRCLK>
{
    static constexpr periph_t P = OTG_HS_PWRCLK;
    using T = stm32f215_otg_hs_pwrclk_t;
    static T& V;
