...
{
    typedef stm32f215_otg_hs_global_t T;
    static T& V;
};
...
{
    typedef stm32f215_otg_hs_host_t T;
    static T& V;
};
...
{
    typedef stm32f215_otg_hs_device_t T;
    static T& V;
};
...
{
    typedef stm32f215_otg_hs_pwrclk_t T;
    static T& V;
};
