...
struct stm32f302_can_t
{
    ...
    volatile uint32_t TI1R;  // [read-write] TX mailbox identifier register
    ...
    volatile uint32_t TI2R;  // [read-write] TX mailbox identifier register
    ...
    volatile uint32_t RDT0R; // [read-only] receive FIFO mailbox data length control and time stamp register
    volatile uint32_t RDL0R; // [read-only] receive FIFO mailbox data low register
    volatile uint32_t RDH0R; // [read-only] receive FIFO mailbox data high register
    volatile uint32_t RI1R;  // [read-only] receive FIFO mailbox identifier register
    volatile uint32_t RDT1R; // [read-only] receive FIFO mailbox data length control and time stamp register
    volatile uint32_t RDL1R; // [read-only] receive FIFO mailbox data low register
    volatile uint32_t RDH1R; // [read-only] receive FIFO mailbox data high register
    ...
    volatile uint32_t FA1R;  // [read-write] CAN filter activation register
    ...
    static constexpr uint32_t BTR_RESET_VALUE = 0x1230000;
    ...
    template<uint32_t X>
    static constexpr uint32_t FMR_CAN2SB =     // CAN2 start bank
        bit_field_t<8, 0x3f>::value<X>();
    static constexpr uint32_t FMR_FINIT = 0x1; // Filter init mode
...
template<>
struct peripheral_t<STM32F302, CAN>
{
    typedef stm32f302_can_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F303, CAN>
{
    typedef stm32f302_can_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F373, CAN>
{
    typedef stm32f302_can_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F3x4, CAN>
{
    typedef stm32f302_can_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F3x8, CAN>
{
    typedef stm32f302_can_t T;
    static T& V;
};
