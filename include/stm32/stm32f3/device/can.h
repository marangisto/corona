...
struct stm32f302_can_t
{
    ...
    volatile uint32_t TI1R; // TX mailbox identifier register
    ...
    volatile uint32_t TI2R; // TX mailbox identifier register
    ...
    volatile uint32_t RDT0R; // receive FIFO mailbox data length control and time stamp register
    volatile uint32_t RDL0R; // receive FIFO mailbox data low register
    volatile uint32_t RDH0R; // receive FIFO mailbox data high register
    volatile uint32_t RI1R; // receive FIFO mailbox identifier register
    volatile uint32_t RDT1R; // receive FIFO mailbox data length control and time stamp register
    volatile uint32_t RDL1R; // receive FIFO mailbox data low register
    volatile uint32_t RDH1R; // receive FIFO mailbox data high register
    ...
    static constexpr uint32_t BTR_RESET_VALUE = 0x1230000; // Reset value
    ...
    typedef bit_field_t<8, 0x3f> FMR_CAN2SB; // CAN2 start bank
