...
struct stm32f301_exti_t
{
    ...
    static constexpr uint32_t IMR_RESET_VALUE = 0x1f800000; // Reset value
...
struct stm32f302_exti_t
{
    ...
    static constexpr uint32_t IMR1_RESET_VALUE = 0x1f800000; // Reset value
    ...
    static constexpr uint32_t IMR2_RESET_VALUE = 0xfffffffc; // Reset value
