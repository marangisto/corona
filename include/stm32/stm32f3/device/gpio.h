...
struct stm32f301_gpioc_t
{
    ...
    static constexpr uint32_t PUPDR_RESET_VALUE = 0xc000000;
    template<uint32_t X>
    static constexpr uint32_t PUPDR_PUPDR15 =   // Port x configuration bits (y = 0..15)
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
