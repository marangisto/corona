...
struct interrupt
{
    ...
    enum interrupt_t
        ...
        , EXTI2_RI = 8 // EXTI Line 2 and routing interface interrupt
        ...
        , COMP2 = 64 // COMP2 interrupt combined with EXTI Lines
        , COMP4_6 = 65 // COMP4 &amp; COMP6 interrupts combined with
        , COMP7 = 66 // COMP7 interrupt combined with EXTI Line 33 interrupt
        , I2C3_EV_EXTI27 = 72 // I2C3 event interrupt &amp; EXTI Line27 interrupt
