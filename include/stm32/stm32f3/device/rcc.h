...
struct stm32f301_rcc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR2_ADC1PRES =   // ADC1 prescaler
        bit_field_t<4, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR3_TIM17SW =        // Timer17 clock source selection
...
struct stm32f302_rcc_t
{
    ...
    static constexpr uint32_t CFGR_PPRE2 =             // APB high speed prescaler (APB2)
        bit_field_t<11, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_PLLSRC =            // PLL entry clock source
    ...
    static constexpr uint32_t AHBENR_IOPFEN = 0x400000;    // I/O port F clock enable
    static constexpr uint32_t AHBENR_TSCEN = 0x1000000;    // Touch sensing controller clock enable
    static constexpr uint32_t AHBENR_ADC12EN = 0x10000000; // ADC1 and ADC2 clock enable
    ...
    static constexpr uint32_t AHBRSTR_IOPFRST = 0x400000;    // I/O port F reset
    static constexpr uint32_t AHBRSTR_TSCRST = 0x1000000;    // Touch sensing controller reset
    static constexpr uint32_t AHBRSTR_ADC12RST = 0x10000000; // ADC1 and ADC2 reset
    ...
    static constexpr uint32_t CFGR2_PREDIV =      // PREDIV division factor
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR2_ADC12PRES =   // ADC1 and ADC2 prescaler
        bit_field_t<4, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR2_ADC34PRES =   // ADC3 and ADC4 prescaler
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR3_USART3SW =      // USART3 clock source selection
        bit_field_t<18, 0x3>::value<X>();
    static constexpr uint32_t CFGR3_TIM1SW = 0x100; // Timer1 clock source selection
    static constexpr uint32_t CFGR3_TIM8SW = 0x200; // Timer8 clock source selection
    template<uint32_t X>
    static constexpr uint32_t CFGR3_UART4SW =       // UART4 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR3_UART5SW =       // UART5 clock source selection
...
struct stm32f373_rcc_t
{
    ...
    static constexpr uint32_t CFGR_PPRE2 =             // APB high speed prescaler (APB2)
        bit_field_t<11, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_ADCPRE =            // ADC prescaler
    ...
    static constexpr uint32_t CFGR_MCO =               // Microcontroller clock output
        bit_field_t<24, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_SDPRE =             // SDADC prescaler
