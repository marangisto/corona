...
struct stm32f301_syscfg_comp_opamp_t
{
    ...
    volatile uint32_t SYSCFG_CFGR3;   // [read-write] configuration register 3
    ...
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_CFGR3_ADC2_DMA_RMP_0 =          // ADC2 DMA channel remapping bit
    ...
    template<uint32_t X>
    static constexpr uint32_t OPAMP2_CSR_CAL_SEL =            // Calibration selection
...
struct stm32f3x4_syscfg_comp_opamp_t
{
    ...
    static constexpr uint32_t COMP2_CSR_COMP2EN = 0x1;           // Comparator 2 enable
    template<uint32_t X>
    static constexpr uint32_t COMP2_CSR_COMP2INMSEL =            // Comparator 2 inverting input selection
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP2_CSR_COMP2OUTSEL =            // Comparator 2 output selection
        bit_field_t<10, 0xf>::value<X>();
    static constexpr uint32_t COMP2_CSR_COMP2POL = 0x8000;       // Comparator 2 output polarity
    template<uint32_t X>
    static constexpr uint32_t COMP2_CSR_COMP2_BLANKING =         // Comparator 2 blanking source
    ...
    static constexpr uint32_t COMP4_CSR_COMP4EN = 0x1;           // Comparator 4 enable
    template<uint32_t X>
    static constexpr uint32_t COMP4_CSR_COMP4INMSEL =            // Comparator 4 inverting input selection
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP4_CSR_COMP4OUTSEL =            // Comparator 4 output selection
        bit_field_t<10, 0xf>::value<X>();
    static constexpr uint32_t COMP4_CSR_COMP4POL = 0x8000;       // Comparator 4 output polarity
    template<uint32_t X>
    static constexpr uint32_t COMP4_CSR_COMP4_BLANKING =         // Comparator 4 blanking source
    ...
    static constexpr uint32_t COMP6_CSR_COMP6EN = 0x1;           // Comparator 6 enable
    template<uint32_t X>
    static constexpr uint32_t COMP6_CSR_COMP6INMSEL =            // Comparator 6 inverting input selection
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP6_CSR_COMP6OUTSEL =            // Comparator 6 output selection
        bit_field_t<10, 0xf>::value<X>();
    static constexpr uint32_t COMP6_CSR_COMP6POL = 0x8000;       // Comparator 6 output polarity
    template<uint32_t X>
    static constexpr uint32_t COMP6_CSR_COMP6_BLANKING =         // Comparator 6 blanking source
...
{
    typedef stm32f301_syscfg_comp_opamp_t T;
    static T& V;
};
...
{
    typedef stm32f3x4_syscfg_comp_opamp_t T;
    static T& V;
};
