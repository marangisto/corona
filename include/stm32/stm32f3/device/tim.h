...
struct stm32f301_tim2_t
{
    ...
    static constexpr uint32_t CR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CR1_UIFREMAP =   // UIF status bit remapping
    ...
    static constexpr uint32_t CCR1_CCR1L =   // Low Capture/Compare 1 value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR1_CCR1H =   // High Capture/Compare 1 value
        bit_field_t<16, 0xffff>::value<X>();
    ...
    static constexpr uint32_t CCR2_CCR2L =   // Low Capture/Compare 2 value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR2_CCR2H =   // High Capture/Compare 2 value
        bit_field_t<16, 0xffff>::value<X>();
    ...
    static constexpr uint32_t CCR3_CCR3L =   // Low Capture/Compare value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR3_CCR3H =   // High Capture/Compare value
        bit_field_t<16, 0xffff>::value<X>();
    ...
    static constexpr uint32_t CCR4_CCR4L =   // Low Capture/Compare value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR4_CCR4H =   // High Capture/Compare value
        bit_field_t<16, 0xffff>::value<X>();
...
struct stm32f373_tim2_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t OR_ITR1_RMP =   // Internal trigger 1 remap
        bit_field_t<10, 0x3>::value<X>();
};
...
using tim18_t = peripheral_t<mcu_svd, TIM18>;
using tim19_t = peripheral_t<mcu_svd, TIM19>;
...
{
    using tim = tim19_t;
    static constexpr alternate_function_t CH1 = TIM19_CH1;
    static constexpr alternate_function_t CH2 = TIM19_CH2;
    static constexpr alternate_function_t CH3 = TIM19_CH3;
    static constexpr alternate_function_t CH4 = TIM19_CH4;
    static constexpr alternate_function_t ETR = TIM19_ETR;
};
