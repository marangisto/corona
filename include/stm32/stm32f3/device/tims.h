...
struct stm32f302_tim1_t
{
    ...
    volatile uint32_t CCR6;         // [read-write] capture/compare register 6
    volatile uint32_t OR;           // [read-write] option registers
    ...
    static constexpr uint32_t CCMR3_Output_OC5M_3 = 0x10000;   // Outout Compare 5 mode bit 3
    static constexpr uint32_t CCMR3_Output_OC6M_3 = 0x1000000; // Outout Compare 6 mode bit 3
    ...
    template<uint32_t X>
    static constexpr uint32_t CCR6_CCR6 =   // Capture/Compare 6 value
        bit_field_t<0, 0xffff>::value<X>();
    ...
    static constexpr uint32_t OR_TIM1_ETR_ADC1_RMP =   // TIM1_ETR_ADC1 remapping capability
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OR_TIM1_ETR_ADC4_RMP =   // TIM1_ETR_ADC4 remapping capability
        bit_field_t<2, 0x3>::value<X>();
};
...
struct stm32f302_tim2_t
{
    ...
    static constexpr uint32_t CCMR2_Output_OC4M =              // Output compare 4 mode
        bit_field_t<12, 0x7>::value<X>();
    static constexpr uint32_t CCMR2_Output_O24CE = 0x8000;     // Output compare 4 clear enable
    static constexpr uint32_t CCMR2_Output_OC3M_3 = 0x10000;   // Output compare 3 mode bit3
    static constexpr uint32_t CCMR2_Output_OC4M_3 = 0x1000000; // Output compare 4 mode bit3
    ...
    static constexpr uint32_t CNT_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CNT_CNTL =                      // Low counter value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CNT_CNTH =                      // High counter value
    ...
    static constexpr uint32_t ARR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t ARR_ARRL =   // Low Auto-reload value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ARR_ARRH =   // High Auto-reload value
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t CCR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CCR1_CCR1L =   // Low Capture/Compare 1 value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR1_CCR1H =   // High Capture/Compare 1 value (on TIM2)
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t CCR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CCR2_CCR2L =   // Low Capture/Compare 2 value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR2_CCR2H =   // High Capture/Compare 2 value (on TIM2)
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t CCR3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CCR3_CCR3L =   // Low Capture/Compare value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR3_CCR3H =   // High Capture/Compare value (on TIM2)
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t CCR4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CCR4_CCR4L =   // Low Capture/Compare value
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCR4_CCR4H =   // High Capture/Compare value (on TIM2)
        bit_field_t<16, 0xffff>::value<X>();
...
struct stm32f302_tim8_t
{
    ...
    static constexpr uint32_t OR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OR_TIM8_ETR_ADC2_RMP =   // TIM8_ETR_ADC2 remapping capability
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OR_TIM8_ETR_ADC3_RMP =   // TIM8_ETR_ADC3 remapping capability
        bit_field_t<2, 0x3>::value<X>();
};
...
{
    using tim = tim20_t;
    static constexpr alternate_function_t BKIN = TIM20_BKIN;
    static constexpr alternate_function_t BKIN2 = TIM20_BKIN2;
    static constexpr alternate_function_t CH1 = TIM20_CH1;
    static constexpr alternate_function_t CH1N = TIM20_CH1N;
    static constexpr alternate_function_t CH2 = TIM20_CH2;
    static constexpr alternate_function_t CH2N = TIM20_CH2N;
    static constexpr alternate_function_t CH3 = TIM20_CH3;
    static constexpr alternate_function_t CH3N = TIM20_CH3N;
    static constexpr alternate_function_t CH4 = TIM20_CH4;
    static constexpr alternate_function_t ETR = TIM20_ETR;
};
