...
struct stm32f302_usb_fs_t
{
    ...
    static constexpr uint32_t DADDR_ADD = 0x1; // Device address
    static constexpr uint32_t DADDR_ADD1 = 0x2; // Device address
    static constexpr uint32_t DADDR_ADD2 = 0x4; // Device address
    static constexpr uint32_t DADDR_ADD3 = 0x8; // Device address
    static constexpr uint32_t DADDR_ADD4 = 0x10; // Device address
    static constexpr uint32_t DADDR_ADD5 = 0x20; // Device address
    static constexpr uint32_t DADDR_ADD6 = 0x40; // Device address
...
template<int INST> struct usb_fs_traits {};

template<> struct usb_fs_traits<0>
{
    using usb_fs = usb_t;
