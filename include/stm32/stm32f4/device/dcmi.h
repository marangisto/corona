...
struct stm32f446_dcmi_t
{
    ...
    static constexpr uint32_t CR_ENABLE = 0x4000; // DCMI enable
    template<uint32_t X>
    static constexpr uint32_t CR_BSM =            // Byte Select mode
        bit_field_t<16, 0x3>::value<X>();
    static constexpr uint32_t CR_OEBS = 0x40000;  // Odd/Even Byte Select
    static constexpr uint32_t CR_LSM = 0x80000;   // Line Select mode
    static constexpr uint32_t CR_OELS = 0x100000; // Odd/Even Line Select
    template<uint32_t X>
    static constexpr uint32_t CR_FCRC =           // Frame capture rate control
        bit_field_t<8, 0x3>::value<X>();
...
template<>
struct peripheral_t<STM32F405, DCMI>
{
    typedef stm32f405_dcmi_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F407, DCMI>
{
    typedef stm32f405_dcmi_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F427, DCMI>
{
    typedef stm32f405_dcmi_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F429, DCMI>
{
    typedef stm32f405_dcmi_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F469, DCMI>
{
    typedef stm32f405_dcmi_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F446, DCMI>
{
    typedef stm32f446_dcmi_t T;
    static T& V;
};
