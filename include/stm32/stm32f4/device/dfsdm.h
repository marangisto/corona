...
struct stm32f413_dfsdm2_t
{
    ...
    volatile uint32_t CH6CFGR2;    // [read-write] CHCFG6R2
    ...
    volatile uint32_t FLT1AWCFR;   // [read-write] analog watchdog clear flag register
