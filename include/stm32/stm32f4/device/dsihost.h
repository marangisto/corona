...
struct stm32f469_dsihost_t
{
    ...
    volatile uint32_t DSIHSOT_CCR; // DSI HOST Clock Control Register
    ...
    volatile uint32_t DSI_TCCR1; // DSI Host Timeout Counter Configuration Register1
    volatile uint32_t DSI_TCCR2; // DSI Host Timeout Counter Configuration Register2
    volatile uint32_t DSI_TCCR3; // DSI Host Timeout Counter Configuration Register3
    volatile uint32_t DSI_TCCR4; // DSI Host Timeout Counter Configuration Register4
    volatile uint32_t DSI_TCCR5; // DSI Host Timeout Counter Configuration Register5
    volatile uint32_t DSI_TCCR6; // DSI Host Timeout Counter Configuration Register6
    ...
    volatile uint32_t DSI_PCCONFR; // DSI Host PHY Configuration Register
    ...
    static constexpr uint32_t DSIHSOT_CCR_RESET_VALUE = 0x3133302a; // Reset value
    typedef bit_field_t<8, 0xff> DSIHSOT_CCR_TOCKDIV; // TOCKDIV
    typedef bit_field_t<0, 0xff> DSIHSOT_CCR_TXECKDIV; // TXECKDIV
    ...
    typedef bit_field_t<0, 0x7fff> DSI_VPCR_VPSIZE; // Video Packet Size

    static constexpr uint32_t DSI_VCCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x3fff> DSI_VCCR_NUMC; // Number of Chunks

    static constexpr uint32_t DSI_VNPCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x3fff> DSI_VNPCR_NPSIZE; // Null Packet Size

    static constexpr uint32_t DSI_VHSACR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x1fff> DSI_VHSACR_HSA; // Horizontal Synchronism Active duration

    static constexpr uint32_t DSI_VHBPCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x1fff> DSI_VHBPCR_HBP; // Horizontal Back-Porch duration
    ...
    static constexpr uint32_t DSI_GPSR_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<16, 0xffff> DSI_TCCR1_HSTX_TOCNT; // High-Speed Transmission Timeout Counter
    typedef bit_field_t<0, 0xffff> DSI_TCCR1_LPRX_TOCNT; // Low-power Reception Timeout Counter

    static constexpr uint32_t DSI_TCCR2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> DSI_TCCR2_HSRD_TOCNT; // High-Speed Read Timeout Counter

    static constexpr uint32_t DSI_TCCR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> DSI_TCCR3_LPRD_TOCNT; // Low-Power Read Timeout Counter
    ...
    typedef bit_field_t<0, 0xffff> DSI_TCCR4_HSWR_TOCNT; // High-Speed Write Timeout Counter

    static constexpr uint32_t DSI_TCCR5_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> DSI_TCCR5_LSWR_TOCNT; // Low-Power Write Timeout Counter

    static constexpr uint32_t DSI_TCCR6_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> DSI_TCCR6_BTA_TOCNT; // Bus-Turn-Around Timeout Counter
    ...
    typedef bit_field_t<24, 0xff> DSI_DLTCR_HS2LP_TIME; // High-Speed To Low-Power Time
    typedef bit_field_t<16, 0xff> DSI_DLTCR_LP2HS_TIME; // Low-Power To High-Speed Time
    ...
    static constexpr uint32_t DSI_PCCONFR_RESET_VALUE = 0x3133302a; // Reset value
    typedef bit_field_t<8, 0xff> DSI_PCCONFR_SW_TIME; // SW_TIME
    typedef bit_field_t<0, 0x3> DSI_PCCONFR_NL; // NL
    ...
    typedef bit_field_t<0, 0x7fff> DSI_VPCCR_VPSIZE; // Video Packet Size

    static constexpr uint32_t DSI_VCCCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x3fff> DSI_VCCCR_NUMC; // Number of Chunks

    static constexpr uint32_t DSI_VNPCCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x3fff> DSI_VNPCCR_NPSIZE; // Null Packet Size

    static constexpr uint32_t DSI_VHSACCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x1fff> DSI_VHSACCR_HSA; // Horizontal Synchronism Active duration

    static constexpr uint32_t DSI_VHBPCCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x1fff> DSI_VHBPCCR_HBP; // Horizontal Back-Porch duration
    ...
    typedef bit_field_t<0, 0x3f> DSI_WPCR1_UIX4; // Unit Interval multiplied by 4

    static constexpr uint32_t DSI_WPCR2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0x3> DSI_WPCR2_LPRXFT; // Low-Power RX low-pass Filtering Tuning
    static constexpr uint32_t DSI_WPCR2_FLPRXLPM = 0x400000; // Forces LP Receiver in Low-Power Mode
    typedef bit_field_t<18, 0x3> DSI_WPCR2_HSTXSRCDL; // High-Speed Transmission Slew Rate Control on Data Lanes
    typedef bit_field_t<16, 0x3> DSI_WPCR2_HSTXSRCCL; // High-Speed Transmission Slew Rate Control on Clock Lane
    static constexpr uint32_t DSI_WPCR2_SDCC = 0x1000; // SDD Control
    typedef bit_field_t<8, 0x3> DSI_WPCR2_LPSRDL; // Low-Power transmission Slew Rate Compensation on Data Lanes
    typedef bit_field_t<6, 0x3> DSI_WPCR2_LPSRCL; // Low-Power transmission Slew Rate Compensation on Clock Lane
    typedef bit_field_t<2, 0x3> DSI_WPCR2_HSTXDLL; // High-Speed Transmission Delay on Data Lanes
    typedef bit_field_t<0, 0x3> DSI_WPCR2_HSTXDCL; // High-Speed Transmission Delay on Clock Lane

    static constexpr uint32_t DSI_WPCR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0xff> DSI_WPCR3_THSTRAIL; // tHSTRAIL
    typedef bit_field_t<16, 0xff> DSI_WPCR3_THSPREP; // tHS-PREPARE
    typedef bit_field_t<8, 0xff> DSI_WPCR3_TCLKZEO; // tCLK-ZERO
    typedef bit_field_t<0, 0xff> DSI_WPCR3_TCLKPREP; // tCLK-PREPARE

    static constexpr uint32_t DSI_WPCR4_RESET_VALUE = 0x3133302a; // Reset value
    typedef bit_field_t<24, 0xff> DSI_WPCR4_TLPXC; // tLPXC for Clock lane
    typedef bit_field_t<16, 0xff> DSI_WPCR4_THSEXIT; // tHSEXIT
    typedef bit_field_t<8, 0xff> DSI_WPCR4_TLPXD; // tLPX for Data lanes
    typedef bit_field_t<0, 0xff> DSI_WPCR4_THSZERO; // tHS-ZERO

    static constexpr uint32_t DSI_WPCR5_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xff> DSI_WPCR5_THSZERO; // tCLK-POST
