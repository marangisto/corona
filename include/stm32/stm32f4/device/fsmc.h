...
struct stm32f413_fsmc_t
{
    ...
    typedef bit_field_t<20, 0xf> BTR1_CLKDIV; // Clock divide ratio
    typedef bit_field_t<24, 0xf> BTR1_DATLAT; // Data latency
    ...
    typedef bit_field_t<24, 0xf> BTR2_DATLAT; // Data latency
    typedef bit_field_t<20, 0xf> BTR2_CLKDIV; // Clock divide ratio
    ...
    typedef bit_field_t<24, 0xf> BTR3_DATLAT; // Data latency
    typedef bit_field_t<20, 0xf> BTR3_CLKDIV; // Clock divide ratio
    ...
    typedef bit_field_t<24, 0xf> BTR4_DATLAT; // Data latency
    typedef bit_field_t<20, 0xf> BTR4_CLKDIV; // Clock divide ratio
