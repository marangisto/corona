...
template<>
struct peripheral_t<STM32F405, HASH>
{
    typedef stm32f405_hash_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32F407, HASH>
{
    typedef stm32f405_hash_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F427, HASH>
{
    typedef stm32f405_hash_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F429, HASH>
{
    typedef stm32f405_hash_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32F469, HASH>
{
    typedef stm32f405_hash_t T;
    static T& V;
};
