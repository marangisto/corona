...
struct stm32f446_hdmi_cec_t
{
    ...
    volatile uint32_t CEC_CFGR; // [read-write] CEC configuration register
    ...
    template<uint32_t X>
    static constexpr uint32_t CEC_CFGR_OAR =              // Own addresses configuration
    ...
    template<uint32_t X>
    static constexpr uint32_t CEC_CFGR_SFT =              // Signal Free Time
        bit_field_t<0, 0x7>::value<X>();

    static constexpr uint32_t CEC_TXDR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CEC_TXDR_TXD =   // Tx Data register
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t CEC_RXDR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CEC_RXDR_RXD =   // Rx Data register
        bit_field_t<0, 0xff>::value<X>();
...
{
    typedef stm32f446_hdmi_cec_t T;
    static T& V;
};
