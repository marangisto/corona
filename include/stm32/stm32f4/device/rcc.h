...
struct stm32f401_rcc_t
{
    ...
    static constexpr uint32_t PLLCFGR_RESET_VALUE = 0x24003010;
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCO2 =             // Microcontroller clock output 2
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCO1 =             // Microcontroller clock output 1
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_PPRE1 =            // APB Low speed prescaler (APB1)
    ...
    static constexpr uint32_t AHB1ENR_RESET_VALUE = 0x100000;
    ...
    static constexpr uint32_t AHB1LPENR_RESET_VALUE = 0x7e6791ff;
    ...
    static constexpr uint32_t AHB2LPENR_RESET_VALUE = 0xf1;
    static constexpr uint32_t AHB2LPENR_OTGFSLPEN = 0x80; // USB OTG FS clock enable during Sleep mode

    static constexpr uint32_t APB1LPENR_RESET_VALUE = 0x36fec9ff;
    ...
    static constexpr uint32_t APB2LPENR_RESET_VALUE = 0x75f33;
    ...
    static constexpr uint32_t CSR_RESET_VALUE = 0xe000000;
    ...
    static constexpr uint32_t SSCGR_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t SSCGR_INCSTEP =               // Incrementation step
        bit_field_t<13, 0x7fff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SSCGR_MODPER =                // Modulation period
        bit_field_t<0, 0x1fff>::value<X>();

    static constexpr uint32_t PLLI2SCFGR_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SRx =   // PLLI2S division factor for I2S clocks
        bit_field_t<28, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SNx =   // PLLI2S multiplication factor for VCO
...
struct stm32f405_rcc_t
{
    ...
    static constexpr uint32_t AHB3LPENR_RESET_VALUE = 0x1;
...
struct stm32f410_rcc_t
{
    ...
    reserved_t<0x2> _0x80;
    volatile uint32_t SSCGR;     // [read-write] spread spectrum clock generation register
    reserved_t<0x2> _0x8c;
    volatile uint32_t DCKCFGR;   // [read-write] DCKCFGR register
    reserved_t<0x1> _0x94;
    volatile uint32_t DCKCFGR2;  // [read-write] DCKCFGR2 register
    ...
    static constexpr uint32_t PLLCFGR_RESET_VALUE = 0x7f003010;
    static constexpr uint32_t PLLCFGR_PLLM0 = 0x1;        // Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
    static constexpr uint32_t PLLCFGR_PLLM1 = 0x2;        // Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
    static constexpr uint32_t PLLCFGR_PLLM2 = 0x4;        // Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
    static constexpr uint32_t PLLCFGR_PLLM3 = 0x8;        // Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
    ...
    static constexpr uint32_t DCKCFGR_RESET_VALUE = 0x0;
    static constexpr uint32_t DCKCFGR_TIMPRE = 0x1000000; // TIMPRE
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_I2SSRC =            // I2SSRC
        bit_field_t<25, 0x3>::value<X>();

    static constexpr uint32_t DCKCFGR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_I2C4SEL =     // I2C4SEL
        bit_field_t<22, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_LPTIM1SEL =   // LPTIM1SEL
        bit_field_t<30, 0x3>::value<X>();
};
...
struct stm32f412_rcc_t
{
    ...
    volatile uint32_t DCKCFGR;    // [read-write] Dedicated Clocks Configuration Register
    volatile uint32_t CKGATENR;   // [read-write] clocks gated enable register
    volatile uint32_t DCKCFGR2;   // [read-write] Dedicated Clocks Configuration Register
    ...
    static constexpr uint32_t PLLCFGR_RESET_VALUE = 0x24003010;
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLM =             // Division factor for the main PLL (PLL) input clock
        bit_field_t<0, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLN =             // Main PLL (PLL) multiplication factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLP =             // Main PLL (PLL) division factor for main system clock
        bit_field_t<16, 0x3>::value<X>();
    static constexpr uint32_t PLLCFGR_PLLSRC = 0x400000; // Main PLL(PLL) and audio PLL (PLLI2S) entry clock source
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLQ =             // Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLR =             // Main PLL (PLL) division factor for I2S, DFSDM clocks
        bit_field_t<28, 0x7>::value<X>();
    ...
    static constexpr uint32_t AHB3LPENR_RESET_VALUE = 0x3;
    ...
    static constexpr uint32_t PLLI2SCFGR_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SR =             // PLLI2S division factor for I2S clocks
        bit_field_t<28, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SQ =             // PLLI2S division factor for USB OTG FS/SDIO/RNG clock
        bit_field_t<24, 0xf>::value<X>();
    static constexpr uint32_t PLLI2SCFGR_PLLI2SSRC = 0x400000; // PLLI2S entry clock source
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SN =             // PLLI2S multiplication factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SM =             // Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        bit_field_t<0, 0x3f>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_I2S1SRC =                 // I2S APB1 clocks source selection (I2S2/3)
        bit_field_t<25, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_I2S2SRC =                 // I2S APB2 clocks source selection (I2S1/4/5)
        bit_field_t<27, 0x3>::value<X>();
    static constexpr uint32_t DCKCFGR_CKDFSDM1SEL = 0x80000000; // DFSDM1 kernel clock selection

    static constexpr uint32_t CKGATENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t DCKCFGR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_I2CFMP1SEL =            // I2CFMP1 kernel clock source selection
        bit_field_t<22, 0x3>::value<X>();
...
struct stm32f413_rcc_t
{
    ...
    volatile uint32_t AHB1RSTR;   // [read-write] AHB1 peripheral reset register
    volatile uint32_t AHB2RSTR;   // [read-write] AHB2 peripheral reset register
    volatile uint32_t AHB3RSTR;   // [read-write] peripheral reset register
    reserved_t<0x1> _0x20;
    volatile uint32_t APB1RSTR;   // [read-write] APB1 peripheral reset register
    volatile uint32_t APB2RSTR;   // [read-write] APB2 peripheral reset register
    reserved_t<0x2> _0x30;
    ...
    reserved_t<0x1> _0x8c;
    volatile uint32_t DCKCFGR;    // [read-write] Dedicated Clocks Configuration Register
    volatile uint32_t CKGATENR;   // [read-write] RCC clocks gated enable register
    volatile uint32_t DCKCFGR2;   // [read-write] Dedicated Clocks Configuration Register
    ...
    static constexpr uint32_t DCKCFGR_I2S2SRC =              // I2S APB2 clocks source selection (I2S1/4/5)
        bit_field_t<27, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_LPTIMER1SEL =          // LPTIMER1 kernel clock selection.
        bit_field_t<30, 0x3>::value<X>();
...
struct stm32f429_rcc_t
{
    ...
    volatile uint32_t SSCGR;      // [read-write] spread spectrum clock generation register
    volatile uint32_t PLLI2SCFGR; // [read-write] PLLI2S configuration register
    volatile uint32_t PLLSAICFGR; // [read-write] RCC PLL configuration register
    volatile uint32_t DCKCFGR;    // [read-write] RCC Dedicated Clock Configuration Register
    ...
    static constexpr uint32_t PLLI2SCFGR_PLLI2SR =   // PLLI2S division factor for I2S clocks
        bit_field_t<28, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SQ =   // PLLI2S division factor for SAI1 clock
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SN =   // PLLI2S multiplication factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    ...
    static constexpr uint32_t DCKCFGR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLI2SDIVQ =        // PLLI2S division factor for SAI1 clock
        bit_field_t<0, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLSAIDIVQ =        // PLLSAI division factor for SAI1 clock
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLSAIDIVR =        // division factor for LCD_CLK
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_SAI1ASRC =          // SAI1-A clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_SAI1BSRC =          // SAI1-B clock source selection
        bit_field_t<22, 0x3>::value<X>();
    static constexpr uint32_t DCKCFGR_TIMPRE = 0x1000000; // Timers clocks prescalers selection

    static constexpr uint32_t PLLSAICFGR_RESET_VALUE = 0x24003000;
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIR =   // PLLSAI division factor for LCD clock
        bit_field_t<28, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIQ =   // PLLSAI division factor for SAI1 clock
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIN =   // PLLSAI division factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
};
...
struct stm32f446_rcc_t
{
    ...
    volatile uint32_t DCKCFGR;    // [read-write] Dedicated Clock Configuration Register
    volatile uint32_t CKGATENR;   // [read-write] clocks gated enable register
    volatile uint32_t DCKCFGR2;   // [read-write] dedicated clocks configuration register 2
    ...
    static constexpr uint32_t PLLI2SCFGR_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SM =   // Division factor for audio PLL (PLLI2S) input clock
        bit_field_t<0, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SN =   // PLLI2S multiplication factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SP =   // PLLI2S division factor for SPDIF-IN clock
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLI2SCFGR_PLLI2SQ =   // PLLI2S division factor for SAI1 clock
        bit_field_t<24, 0xf>::value<X>();
    ...
    static constexpr uint32_t PLLSAICFGR_RESET_VALUE = 0x24003000;
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIM =   // Division factor for audio PLLSAI input clock
        bit_field_t<0, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIN =   // PLLSAI division factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIP =   // PLLSAI division factor for 48 MHz clock
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIQ =   // PLLSAI division factor for SAIs clock
        bit_field_t<24, 0xf>::value<X>();

    static constexpr uint32_t DCKCFGR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLI2SDIVQ =        // PLLI2S division factor for SAIs clock
        bit_field_t<0, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLSAIDIVQ =        // PLLSAI division factor for SAIs clock
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_SAI1SRC =           // SAI1 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_SAI2SRC =           // SAI2 clock source selection
        bit_field_t<22, 0x3>::value<X>();
    static constexpr uint32_t DCKCFGR_TIMPRE = 0x1000000; // Timers clocks prescalers selection
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_I2S1SRC =           // I2S APB1 clock source selection
        bit_field_t<25, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_I2S2SRC =           // I2S APB2 clock source selection
        bit_field_t<27, 0x3>::value<X>();
    ...
    static constexpr uint32_t DCKCFGR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_FMPI2C1SEL =           // I2C4 kernel clock source selection
        bit_field_t<22, 0x3>::value<X>();
...
struct stm32f469_rcc_t
{
    ...
    static constexpr uint32_t PLLCFGR_RESET_VALUE = 0x24003010;
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLM =             // Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        bit_field_t<0, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLN =             // Main PLL (PLL) multiplication factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    ...
    static constexpr uint32_t PLLCFGR_PLLQ =             // Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLR =             // Main PLL division factor for DSI clock
        bit_field_t<28, 0x7>::value<X>();
    ...
    static constexpr uint32_t DCKCFGR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLIS2DIVQ =           // PLLI2S division factor for SAIs clock
        bit_field_t<0, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLSAIDIVQ =           // PLLSAI division factor for SAIs clock
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_PLLSAIDIVR =           // PLLSAIDIVR
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_SAI1ASRC =             // SAI1 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR_SAI1BSRC =             // SAI1-B clock source selection
        bit_field_t<22, 0x3>::value<X>();
