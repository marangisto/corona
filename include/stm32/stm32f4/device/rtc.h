...
struct stm32f405_rtc_t
{
    ...
    static constexpr uint32_t TSTR_RESET_VALUE = 0x0;
    static constexpr uint32_t TSTR_ALARMOUTTYPE = 0x40000; // AFO_ALARM output type
    static constexpr uint32_t TSTR_TSINSEL = 0x20000;      // TIMESTAMP mapping
    static constexpr uint32_t TSTR_TAMP1INSEL = 0x10000;   // TAMPER1 mapping
    static constexpr uint32_t TSTR_TAMPIE = 0x4;           // Tamper interrupt enable
    static constexpr uint32_t TSTR_TAMP1TRG = 0x2;         // Active level for tamper 1
    static constexpr uint32_t TSTR_TAMP1E = 0x1;           // Tamper 1 detection enable
