...
struct stm32f413_otg_fs_device_t
{
    ...
    static constexpr uint32_t FS_DSTS_FNSOF =        // Frame number of the received SOF
        bit_field_t<8, 0x3fff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FS_DSTS_DEVLNSTS =     // Device line status
...
{
    typedef stm32f401_otg_fs_device_t T;
    static T& V;
};
...
{
    typedef stm32f401_otg_fs_global_t T;
    static T& V;
};
...
{
    typedef stm32f401_otg_fs_host_t T;
    static T& V;
};
...
{
    typedef stm32f401_otg_fs_pwrclk_t T;
    static T& V;
};
...
{
    typedef stm32f412_otg_fs_global_t T;
    static T& V;
};
...
{
    typedef stm32f413_otg_fs_device_t T;
    static T& V;
};
...
{
    typedef stm32f446_otg_fs_device_t T;
    static T& V;
};
