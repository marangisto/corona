...
struct stm32f722_cryp_t
{
    ...
    volatile uint32_t KEYR0;  // [read-write] key register
    volatile uint32_t KEYR1;  // [read-write] key register
    volatile uint32_t KEYR2;  // [read-only] key register
    volatile uint32_t KEYR3;  // [read-only] key register
    volatile uint32_t IVR0;   // [read-write] initialization vector register
    volatile uint32_t IVR1;   // [read-write] initialization vector register
    volatile uint32_t IVR2;   // [read-write] initialization vector register
    volatile uint32_t IVR3;   // [read-write] initialization vector register
    volatile uint32_t KEYR4;  // [read-write] key registers
    volatile uint32_t KEYR5;  // [read-write] key registers
    volatile uint32_t KEYR6;  // [read-write] key registers
    volatile uint32_t KEYR7;  // [read-write] key registers
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_GCMPH =            // Used only for GCM, GMAC and CMAC algorithms and has no effect when other
    ...
    template<uint32_t X>
    static constexpr uint32_t KEYR0_KEYR0 =   // Data output register
    ...
    template<uint32_t X>
    static constexpr uint32_t KEYR2_KEYR2 =   // Data output register
        bit_field_t<0, 0x7fffffff>::value<X>();
