...
struct stm32f722_dma2_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t S0CR_CHSEL =          // Channel selection
    ...
    template<uint32_t X>
    static constexpr uint32_t S1CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t S2CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t S3CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t S4CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t S5CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t S6CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t S7CR_CHSEL =          // Channel selection
        bit_field_t<25, 0x7>::value<X>();
    template<uint32_t X>
