...
////
//
//      STM32F7 DMA peripherals
//
///

// DMA2: DMA controller

struct stm32f722_dma2_t
{
...
struct stm32f745_dma2_t
{
    ...
    static constexpr uint32_t S0CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S0CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S0CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S0CR_PBURST; // Peripheral burst transfer configuration
    static constexpr uint32_t S0CR_CT = 0x80000; // Current target (only in double buffer mode)
    static constexpr uint32_t S0CR_DBM = 0x40000; // Double buffer mode
    ...
    static constexpr uint32_t S1CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S1CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S1CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S1CR_PBURST; // Peripheral burst transfer configuration
    ...
    static constexpr uint32_t S2CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S2CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S2CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S2CR_PBURST; // Peripheral burst transfer configuration
    ...
    static constexpr uint32_t S3CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S3CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S3CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S3CR_PBURST; // Peripheral burst transfer configuration
    ...
    static constexpr uint32_t S4CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S4CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S4CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S4CR_PBURST; // Peripheral burst transfer configuration
    ...
    static constexpr uint32_t S5CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S5CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S5CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S5CR_PBURST; // Peripheral burst transfer configuration
    ...
    static constexpr uint32_t S6CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S6CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S6CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S6CR_PBURST; // Peripheral burst transfer configuration
    ...
    static constexpr uint32_t S7CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> S7CR_CHSEL; // Channel selection
    typedef bit_field_t<23, 0x3> S7CR_MBURST; // Memory burst transfer configuration
    typedef bit_field_t<21, 0x3> S7CR_PBURST; // Peripheral burst transfer configuration
...
template<>
struct peripheral_t<STM32F722, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f722_dma2_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F722, DMA2>
{
...
template<>
struct peripheral_t<STM32F723, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F723, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F730, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F730, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F732, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F732, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F733, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F733, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f722_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F745, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f745_dma2_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F745, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F765, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F765, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F768, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F768, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F769, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F769, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F778, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F778, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F779, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F779, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f745_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F746, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f746_dma2_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F746, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f746_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F750x, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f746_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F750x, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f746_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F756, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f746_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F756, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f746_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F767, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f767_dma2_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F767, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f767_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F777, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32f767_dma2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F777, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32f767_dma2_t;
    static T& V;
