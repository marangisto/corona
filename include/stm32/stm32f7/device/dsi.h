...
////
//
//      STM32F7 DSI peripherals
//
///

// DSI: DSI Host

struct stm32f767_dsi_t
{
    ...
    static constexpr uint32_t DSI_MCR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t DSI_PCONFR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t DSI_PSR_RESET_VALUE = 0x0; // Reset value
...
template<>
struct peripheral_t<STM32F767, DSI>
{
    static constexpr periph_t P = DSI;
    using T = stm32f767_dsi_t;
    static T& V;
};

template<>
struct peripheral_t<STM32F768, DSI>
{
    static constexpr periph_t P = DSI;
    using T = stm32f767_dsi_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F769, DSI>
{
    static constexpr periph_t P = DSI;
    using T = stm32f767_dsi_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F777, DSI>
{
    static constexpr periph_t P = DSI;
    using T = stm32f767_dsi_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F778, DSI>
{
    static constexpr periph_t P = DSI;
    using T = stm32f767_dsi_t;
    static T& V;
...
template<>
struct peripheral_t<STM32F779, DSI>
{
    static constexpr periph_t P = DSI;
    using T = stm32f767_dsi_t;
    static T& V;
