...
struct stm32f767_dsi_t
{
    ...
    static constexpr uint32_t DSI_MCR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t DSI_PCONFR_RESET_VALUE = 0x0;
    template<uint32_t X>
    ...
    static constexpr uint32_t DSI_PSR_RESET_VALUE = 0x0;
