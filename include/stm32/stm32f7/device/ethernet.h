...
////
//
//      STM32F7 ETHERNET peripherals
//
///

// ETHERNET_DMA: Ethernet: DMA controller operation

struct stm32f745_ethernet_dma_t
{
...
struct stm32f745_ethernet_mac_t
{
...
struct stm32f745_ethernet_ptp_t
{
    ...
    static constexpr uint32_t PTPTSSR_TSTTR = 0x2; // TSSO
...
struct peripheral_t<STM32F745, ETHERNET_DMA>
{
    ...
    using T = stm32f745_ethernet_dma_t;
    static T& V;
};
...
struct peripheral_t<STM32F745, ETHERNET_MMC>
{
    ...
    using T = stm32f745_ethernet_mmc_t;
    static T& V;
};
...
struct peripheral_t<STM32F745, ETHERNET_PTP>
{
    ...
    using T = stm32f745_ethernet_ptp_t;
    static T& V;
};
