...
struct stm32f722_exti_t
{
    ...
    static constexpr uint32_t IMR_MI9 = 0x200;     // Interrupt Mask on line 9
    ...
    static constexpr uint32_t RTSR_TR23 = 0x800000; // Rising trigger event configuration of line 23
    ...
    static constexpr uint32_t FTSR_TR23 = 0x800000; // Falling trigger event configuration of line 23
    ...
    static constexpr uint32_t SWIER_SWIER23 = 0x800000; // Software Interrupt on line 22
    ...
    static constexpr uint32_t PR_PR23 = 0x800000; // Pending bit 23
};
