...
struct stm32f722_rcc_t
{
    ...
    volatile uint32_t DCKCFGR1;   // [read-write] dedicated clocks configuration register
    ...
    static constexpr uint32_t PLLSAICFGR_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIN =   // PLLSAI division factor for VCO
        bit_field_t<6, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIP =   // PLLSAI division factor for 48MHz clock
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAICFGR_PLLSAIQ =   // PLLSAI division factor for SAI clock
        bit_field_t<24, 0xf>::value<X>();

    static constexpr uint32_t DCKCFGR1_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR1_PLLI2SDIV =         // PLLI2S division factor for SAI1 clock
        bit_field_t<0, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR1_PLLSAIDIVQ =        // PLLSAI division factor for SAI1 clock
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR1_SAI1SEL =           // SAI1 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR1_SAI2SEL =           // SAI2 clock source selection
        bit_field_t<22, 0x3>::value<X>();
    static constexpr uint32_t DCKCFGR1_TIMPRE = 0x1000000; // Timers clocks prescalers selection

    static constexpr uint32_t DCKCFGR2_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART1SEL =              // USART 1 clock source selection
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART2SEL =              // USART 2 clock source selection
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART3SEL =              // USART 3 clock source selection
        bit_field_t<4, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART4SEL =              // UART 4 clock source selection
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART5SEL =              // UART 5 clock source selection
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART6SEL =              // USART 6 clock source selection
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART7SEL =              // UART 7 clock source selection
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_UART8SEL =              // UART 8 clock source selection
        bit_field_t<14, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_I2C1SEL =               // I2C1 clock source selection
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_I2C2SEL =               // I2C2 clock source selection
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_I2C3SEL =               // I2C3 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DCKCFGR2_LPTIM1SEL =             // Low power timer 1 clock source selection
...
struct stm32f745_rcc_t
{
    ...
    static constexpr uint32_t DKCFGR1_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t DKCFGR1_PLLI2SDIV =         // PLLI2S division factor for SAI1 clock
        bit_field_t<0, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR1_PLLSAIDIVQ =        // PLLSAI division factor for SAI1 clock
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR1_PLLSAIDIVR =        // division factor for LCD_CLK
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR1_SAI1SEL =           // SAI1 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR1_SAI2SEL =           // SAI2 clock source selection
        bit_field_t<22, 0x3>::value<X>();
    static constexpr uint32_t DKCFGR1_TIMPRE = 0x1000000; // Timers clocks prescalers selection

    static constexpr uint32_t DKCFGR2_RESET_VALUE = 0x20003000;
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_USART1SEL =            // USART 1 clock source selection
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_USART2SEL =            // USART 2 clock source selection
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_USART3SEL =            // USART 3 clock source selection
        bit_field_t<4, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_UART4SEL =             // UART 4 clock source selection
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_UART5SEL =             // UART 5 clock source selection
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_USART6SEL =            // USART 6 clock source selection
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_UART7SEL =             // UART 7 clock source selection
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_UART8SEL =             // UART 8 clock source selection
        bit_field_t<14, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_I2C1SEL =              // I2C1 clock source selection
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_I2C2SEL =              // I2C2 clock source selection
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_I2C3SEL =              // I2C3 clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_I2C4SEL =              // I2C4 clock source selection
        bit_field_t<22, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DKCFGR2_LPTIM1SEL =            // Low power timer 1 clock source selection
        bit_field_t<24, 0x3>::value<X>();
