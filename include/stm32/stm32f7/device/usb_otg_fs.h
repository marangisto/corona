...
struct stm32f722_otg_fs_device_t
{
    ...
    volatile uint32_t OTG_FS_DIEPTSIZ5;  // [read-write] device endpoint-5 transfer size register
    reserved_t<0x1> _0x1b8;
    volatile uint32_t OTG_FS_DTXFSTS5;   // [read-write] OTG_FS device IN endpoint transmit FIFO status register
    reserved_t<0x51> _0x300;
    ...
    static constexpr uint32_t OTG_FS_DCFG_RESET_VALUE = 0x2200000;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DCFG_DSPD =          // Device speed
        bit_field_t<0, 0x3>::value<X>();
    static constexpr uint32_t OTG_FS_DCFG_NZLSOHSK = 0x4; // Non-zero-length status OUT handshake
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DCFG_DAD =           // Device address
        bit_field_t<4, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DCFG_PFIVL =         // Periodic frame interval
        bit_field_t<11, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_DCTL_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DCTL_TCTL =            // Test control
    ...
    static constexpr uint32_t OTG_FS_DSTS_RESET_VALUE = 0x10;
    static constexpr uint32_t OTG_FS_DSTS_SUSPSTS = 0x1; // Suspend status
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DSTS_ENUMSPD =      // Enumerated speed
        bit_field_t<1, 0x3>::value<X>();
    static constexpr uint32_t OTG_FS_DSTS_EERR = 0x8;    // Erratic error
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DSTS_FNSOF =        // Frame number of the received SOF
        bit_field_t<8, 0x3fff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPMSK_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_DOEPMSK_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_DAINT_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DAINT_IEPINT =   // IN endpoint interrupt bits
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DAINT_OEPINT =   // OUT endpoint interrupt bits
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DAINTMSK_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DAINTMSK_IEPM =     // IN EP interrupt mask bits
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DAINTMSK_OEPINT =   // OUT endpoint interrupt bits
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DVBUSDIS_RESET_VALUE = 0x17d7;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DVBUSDIS_VBUSDT =   // Device VBUS discharge time
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DVBUSPULSE_RESET_VALUE = 0x5b8;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DVBUSPULSE_DVBUSP =   // Device VBUS pulsing time
        bit_field_t<0, 0xfff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPEMPMSK_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPEMPMSK_INEPTXFEM =   // IN EP Tx FIFO empty interrupt mask bits
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPCTL0_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL0_MPSIZ =             // Maximum packet size
        bit_field_t<0, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL0_EPTYP =             // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    static constexpr uint32_t OTG_FS_DIEPCTL0_STALL = 0x200000;   // STALL handshake
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL0_TXFNUM =            // TxFIFO number
    ...
    static constexpr uint32_t OTG_FS_DIEPCTL1_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL1_TXFNUM =                     // TXFNUM
        bit_field_t<22, 0xf>::value<X>();
    static constexpr uint32_t OTG_FS_DIEPCTL1_Stall = 0x200000;            // Stall
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL1_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL1_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPCTL2_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL2_TXFNUM =                     // TXFNUM
        bit_field_t<22, 0xf>::value<X>();
    static constexpr uint32_t OTG_FS_DIEPCTL2_Stall = 0x200000;            // Stall
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL2_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL2_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPCTL3_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL3_TXFNUM =                     // TXFNUM
        bit_field_t<22, 0xf>::value<X>();
    static constexpr uint32_t OTG_FS_DIEPCTL3_Stall = 0x200000;            // Stall
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL3_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL3_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPCTL0_RESET_VALUE = 0x8000;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL0_EPTYP =             // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL0_MPSIZ =             // MPSIZ
        bit_field_t<0, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPCTL1_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL1_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL1_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPCTL2_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL2_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL2_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPCTL3_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL3_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL3_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPINT0_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DIEPINT1_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DIEPINT2_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DIEPINT3_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DOEPINT0_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DOEPINT1_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DOEPINT2_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DOEPINT3_RESET_VALUE = 0x80;
    ...
    static constexpr uint32_t OTG_FS_DIEPTSIZ0_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ0_PKTCNT =   // Packet count
        bit_field_t<19, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ0_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPTSIZ0_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ0_STUPCNT =         // SETUP packet count
        bit_field_t<29, 0x3>::value<X>();
    static constexpr uint32_t OTG_FS_DOEPTSIZ0_PKTCNT = 0x80000; // Packet count
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ0_XFRSIZ =          // Transfer size
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTSIZ1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ1_MCNT =     // Multi count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ1_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ1_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTSIZ2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ2_MCNT =     // Multi count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ2_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ2_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTSIZ3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ3_MCNT =     // Multi count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ3_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ3_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS0_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS0_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS1_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS2_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS3_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPTSIZ1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ1_RXDPID_STUPCNT =   // Received data PID/SETUP packet count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ1_PKTCNT =           // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ1_XFRSIZ =           // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPTSIZ2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ2_RXDPID_STUPCNT =   // Received data PID/SETUP packet count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ2_PKTCNT =           // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ2_XFRSIZ =           // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPTSIZ3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ3_RXDPID_STUPCNT =   // Received data PID/SETUP packet count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ3_PKTCNT =           // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ3_XFRSIZ =           // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPCTL4_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL4_TXFNUM =                     // TXFNUM
        bit_field_t<22, 0xf>::value<X>();
    static constexpr uint32_t OTG_FS_DIEPCTL4_Stall = 0x200000;            // Stall
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL4_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL4_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPINT4_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_DIEPTSIZ4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ4_MCNT =     // Multi count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ4_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ4_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS4_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPCTL5_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL5_TXFNUM =                     // TXFNUM
        bit_field_t<22, 0xf>::value<X>();
    static constexpr uint32_t OTG_FS_DIEPCTL5_Stall = 0x200000;            // Stall
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL5_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPCTL5_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPINT5_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_DIEPTSIZ5_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ5_MCNT =     // Multi count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ5_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ5_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS5_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS5_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPCTL4_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL4_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL4_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPINT4_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_DOEPTSIZ4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ4_RXDPID_STUPCNT =   // Received data PID/SETUP packet count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ4_PKTCNT =           // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ4_XFRSIZ =           // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPCTL5_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL5_EPTYP =                      // EPTYP
        bit_field_t<18, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPCTL5_MPSIZ =                      // MPSIZ
        bit_field_t<0, 0x7ff>::value<X>();

    static constexpr uint32_t OTG_FS_DOEPINT5_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_DOEPTSIZ5_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ5_RXDPID_STUPCNT =   // Received data PID/SETUP packet count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ5_PKTCNT =           // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DOEPTSIZ5_XFRSIZ =           // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
};
...
struct stm32f745_otg_fs_device_t
{
    ...
    reserved_t<0x1> _0x370;
    volatile uint32_t OTG_FS_DOEPTSIZ3;  // [read-write] device OUT endpoint-3 transfer size register
    reserved_t<0x1> _0x378;
    volatile uint32_t OTG_FS_DOEPCTL4;   // device endpoint-4 control register
    reserved_t<0x1> _0x380;
    volatile uint32_t OTG_FS_DOEPINT4;   // [read-write] device endpoint-4 interrupt register
    reserved_t<0x1> _0x388;
    volatile uint32_t OTG_FS_DOEPTSIZ4;  // [read-write] device OUT endpoint-4 transfer size register
    reserved_t<0x1> _0x390;
    volatile uint32_t OTG_FS_DOEPCTL5;   // device endpoint-5 control register
    reserved_t<0x1> _0x398;
    volatile uint32_t OTG_FS_DOEPINT5;   // [read-write] device endpoint-5 interrupt register
    reserved_t<0x1> _0x3a0;
    volatile uint32_t OTG_FS_DOEPTSIZ5;  // [read-write] device OUT endpoint-5 transfer size register
    ...
    static constexpr uint32_t OTG_FS_DIEPTSIZ55_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ55_MCNT =     // Multi count
        bit_field_t<29, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ55_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTSIZ55_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();

    static constexpr uint32_t OTG_FS_DTXFSTS55_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DTXFSTS55_INEPTFSAV =   // IN endpoint TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();
...
struct stm32f722_otg_fs_global_t
{
    ...
    static constexpr uint32_t OTG_FS_GOTGCTL_RESET_VALUE = 0x800;
    ...
    static constexpr uint32_t OTG_FS_GOTGINT_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_GAHBCFG_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_GUSBCFG_RESET_VALUE = 0xa00;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GUSBCFG_TOCAL =             // FS timeout calibration
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GUSBCFG_TRDT =              // USB turnaround time
    ...
    static constexpr uint32_t OTG_FS_GRSTCTL_RESET_VALUE = 0x20000000;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRSTCTL_TXFNUM =             // TxFIFO number
        bit_field_t<6, 0x1f>::value<X>();
    static constexpr uint32_t OTG_FS_GRSTCTL_AHBIDL = 0x80000000; // AHB master idle

    static constexpr uint32_t OTG_FS_GINTSTS_RESET_VALUE = 0x4000020;
    ...
    static constexpr uint32_t OTG_FS_GINTMSK_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_GRXSTSR_Device_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Device_EPNUM =    // Endpoint number
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Device_BCNT =     // Byte count
        bit_field_t<4, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Device_DPID =     // Data PID
        bit_field_t<15, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Device_PKTSTS =   // Packet status
        bit_field_t<17, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Device_FRMNUM =   // Frame number
        bit_field_t<21, 0xf>::value<X>();

    static constexpr uint32_t OTG_FS_GRXSTSR_Host_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Host_CHNUM =    // Endpoint number
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Host_BCNT =     // Byte count
        bit_field_t<4, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Host_DPID =     // Data PID
        bit_field_t<15, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSR_Host_PKTSTS =   // Packet status
        bit_field_t<17, 0xf>::value<X>();

    static constexpr uint32_t OTG_FS_GRXFSIZ_RESET_VALUE = 0x200;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXFSIZ_RXFD =   // RxFIFO depth
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTXF0_Device_RESET_VALUE = 0x200;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF0_Device_TX0FSA =   // Endpoint 0 transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF0_Device_TX0FD =    // Endpoint 0 TxFIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_HNPTXFSIZ_Host_RESET_VALUE = 0x200;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HNPTXFSIZ_Host_NPTXFSA =   // Non-periodic transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HNPTXFSIZ_Host_NPTXFD =    // Non-periodic TxFIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_HNPTXSTS_RESET_VALUE = 0x80200;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HNPTXSTS_NPTXFSAV =   // Non-periodic TxFIFO space available
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HNPTXSTS_NPTQXSAV =   // Non-periodic transmit request queue space available
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HNPTXSTS_NPTXQTOP =   // Top of the non-periodic transmit request queue
        bit_field_t<24, 0x7f>::value<X>();

    static constexpr uint32_t OTG_FS_GCCFG_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_CID_RESET_VALUE = 0x1000;

    static constexpr uint32_t OTG_FS_HPTXFSIZ_RESET_VALUE = 0x2000600;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPTXFSIZ_PTXSA =     // Host periodic TxFIFO start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPTXFSIZ_PTXFSIZ =   // Host periodic TxFIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTXF1_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF1_INEPTXSA =   // IN endpoint FIFO2 transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF1_INEPTXFD =   // IN endpoint TxFIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTXF2_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF2_INEPTXSA =   // IN endpoint FIFO3 transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF2_INEPTXFD =   // IN endpoint TxFIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTXF3_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF3_INEPTXSA =   // IN endpoint FIFO4 transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF3_INEPTXFD =   // IN endpoint TxFIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_GRXSTSP_Device_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Device_EPNUM =    // Endpoint number
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Device_BCNT =     // Byte count
        bit_field_t<4, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Device_DPID =     // Data PID
        bit_field_t<15, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Device_PKTSTS =   // Packet status
        bit_field_t<17, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Device_FRMNUM =   // Frame number
        bit_field_t<21, 0xf>::value<X>();

    static constexpr uint32_t OTG_FS_GRXSTSP_Host_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Host_CHNUM =    // Channel number
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Host_BCNT =     // Byte count
        bit_field_t<4, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Host_DPID =     // Data PID
        bit_field_t<15, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GRXSTSP_Host_PKTSTS =   // Packet status
        bit_field_t<17, 0xf>::value<X>();

    static constexpr uint32_t OTG_FS_GI2CCTL_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GI2CCTL_RWDATA =                // I2C Read/Write Data
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GI2CCTL_REGADDR =               // I2C Register Address
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GI2CCTL_ADDR =                  // I2C Address
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GI2CCTL_I2CDEVADR =             // I2C Device Address
    ...
    static constexpr uint32_t OTG_FS_DIEPTXF4_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF4_INEPTXSA =   // IN endpoint FIFOx transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF4_INEPTXFD =   // IN endpoint Tx FIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_DIEPTXF5_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF5_INEPTXSA =   // IN endpoint FIFOx transmit RAM start address
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_DIEPTXF5_INEPTXFD =   // IN endpoint Tx FIFO depth
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_GLPMCFG_RESET_VALUE = 0x2000400;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GLPMCFG_BESL =               // Best effort service latency
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GLPMCFG_BESLTHRS =           // BESL threshold
        bit_field_t<8, 0xf>::value<X>();
    static constexpr uint32_t OTG_FS_GLPMCFG_L1DSEN = 0x1000;     // L1 deep sleep enable
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GLPMCFG_LPMRST =             // LPM response
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GLPMCFG_LPMCHIDX =           // LPM Channel Index
        bit_field_t<17, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GLPMCFG_LPMRCNT =            // LPM retry count
        bit_field_t<21, 0x7>::value<X>();
    static constexpr uint32_t OTG_FS_GLPMCFG_SNDLPM = 0x1000000;  // Send LPM transaction
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GLPMCFG_LPMRCNTSTS =         // LPM retry count status
...
struct stm32f745_otg_fs_global_t
{
    ...
    static constexpr uint32_t OTG_FS_GPWRDN_RESET_VALUE = 0x2000400;
    ...
    static constexpr uint32_t OTG_FS_GADPCTL_RESET_VALUE = 0x2000400;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GADPCTL_PRBDSCHG =            // Probe discharge
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GADPCTL_PRBDELTA =            // Probe delta
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GADPCTL_PRBPER =              // Probe period
        bit_field_t<4, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GADPCTL_RTIM =                // Ramp time
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_GADPCTL_AR =                  // Access request
...
struct stm32f722_otg_fs_host_t
{
    ...
    static constexpr uint32_t OTG_FS_HCFG_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCFG_FSLSPCS =    // FS/LS PHY clock select
        bit_field_t<0, 0x3>::value<X>();
    static constexpr uint32_t OTG_FS_HCFG_FSLSS = 0x4; // FS- and LS-only support

    static constexpr uint32_t OTG_FS_HFIR_RESET_VALUE = 0xea60;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HFIR_FRIVL =   // Frame interval
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_HFNUM_RESET_VALUE = 0x3fff;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HFNUM_FRNUM =   // Frame number
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HFNUM_FTREM =   // Frame time remaining
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_HPTXSTS_RESET_VALUE = 0x80100;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPTXSTS_PTXFSAVL =   // Periodic transmit data FIFO space available
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPTXSTS_PTXQSAV =    // Periodic transmit request queue space available
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPTXSTS_PTXQTOP =    // Top of the periodic transmit request queue
        bit_field_t<24, 0xff>::value<X>();

    static constexpr uint32_t OTG_FS_HAINT_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HAINT_HAINT =   // Channel interrupts
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_HAINTMSK_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HAINTMSK_HAINTM =   // Channel interrupt mask
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OTG_FS_HPRT_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPRT_PLSTS =         // Port line status
        bit_field_t<10, 0x3>::value<X>();
    static constexpr uint32_t OTG_FS_HPRT_PPWR = 0x1000;  // Port power
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPRT_PTCTL =         // Port test control
        bit_field_t<13, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HPRT_PSPD =          // Port speed
        bit_field_t<17, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCCHAR0_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR0_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR0_EPNUM =              // Endpoint number
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR0_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR0_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR0_DAD =                // Device address
    ...
    static constexpr uint32_t OTG_FS_HCCHAR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR1_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR1_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR1_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR1_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR1_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCCHAR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR2_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR2_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR2_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR2_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR2_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCCHAR3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR3_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR3_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR3_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR3_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR3_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCCHAR4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR4_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR4_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR4_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR4_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR4_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCCHAR5_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR5_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR5_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR5_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR5_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR5_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCCHAR6_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR6_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR6_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR6_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR6_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR6_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCCHAR7_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR7_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR7_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR7_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR7_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR7_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCINT0_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT3_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT4_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT5_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT6_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINT7_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK0_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK3_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK4_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK5_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK6_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK7_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCTSIZ0_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ0_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ0_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ0_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ1_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ1_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ1_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ2_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ2_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ2_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ3_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ3_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ3_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ4_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ4_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ4_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ5_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ5_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ5_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ5_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ6_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ6_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ6_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ6_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCTSIZ7_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ7_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ7_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ7_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCCHAR8_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR8_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR8_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR8_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR8_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR8_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCINT8_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK8_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCTSIZ8_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ8_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ8_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ8_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCCHAR9_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR9_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR9_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR9_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR9_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR9_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCINT9_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK9_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCTSIZ9_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ9_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ9_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ9_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCCHAR10_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR10_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR10_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR10_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR10_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR10_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCINT10_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK10_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCTSIZ10_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ10_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ10_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ10_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();

    static constexpr uint32_t OTG_FS_HCCHAR11_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR11_MPSIZ =              // Maximum packet size
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR11_EPNUM =              // Endpoint number
        bit_field_t<11, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR11_EPTYP =              // Endpoint type
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR11_MCNT =               // Multicount
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCCHAR11_DAD =                // Device address
        bit_field_t<22, 0x7f>::value<X>();
    ...
    static constexpr uint32_t OTG_FS_HCINT11_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCINTMSK11_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t OTG_FS_HCTSIZ11_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ11_XFRSIZ =   // Transfer size
        bit_field_t<0, 0x7ffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ11_PKTCNT =   // Packet count
        bit_field_t<19, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OTG_FS_HCTSIZ11_DPID =     // Data PID
        bit_field_t<29, 0x3>::value<X>();
};
...
struct stm32f722_otg_fs_pwrclk_t
{
    ...
    static constexpr uint32_t OTG_FS_PCGCCTL_RESET_VALUE = 0x0;
...
{
    typedef stm32f722_otg_fs_global_t T;
    static T& V;
};
...
{
    typedef stm32f722_otg_fs_host_t T;
    static T& V;
};
...
{
    typedef stm32f722_otg_fs_device_t T;
    static T& V;
};
...
{
    typedef stm32f722_otg_fs_pwrclk_t T;
    static T& V;
};
...
{
    typedef stm32f745_otg_fs_global_t T;
    static T& V;
};
...
{
    typedef stm32f745_otg_fs_host_t T;
    static T& V;
};
...
{
    typedef stm32f745_otg_fs_device_t T;
    static T& V;
};
