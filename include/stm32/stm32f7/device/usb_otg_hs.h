...
struct stm32f722_otg_hs_device_t
{
    ...
    volatile uint32_t OTG_HS_DIEPDMA0; // OTG_HS device endpoint-1 DMA address register
    ...
    volatile uint32_t OTG_HS_DIEPDMA1; // OTG_HS device endpoint-2 DMA address register
    ...
    volatile uint32_t OTG_HS_DIEPDMA2; // OTG_HS device endpoint-3 DMA address register
    ...
    volatile uint32_t OTG_HS_DIEPDMA3; // OTG_HS device endpoint-4 DMA address register
    ...
    volatile uint32_t OTG_HS_DIEPDMA4; // OTG_HS device endpoint-5 DMA address register
    ...
    static constexpr uint32_t OTG_HS_DIEPDMA0_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> OTG_HS_DIEPDMA0_DMAADDR; // DMA address
    ...
    static constexpr uint32_t OTG_HS_DIEPTSIZ6_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x7ffff> OTG_HS_DIEPTSIZ6_XFRSIZ; // Transfer size
    typedef bit_field_t<19, 0x3ff> OTG_HS_DIEPTSIZ6_PKTCNT; // Packet count
    typedef bit_field_t<29, 0x3> OTG_HS_DIEPTSIZ6_MCNT; // Multi count
    ...
    static constexpr uint32_t OTG_HS_DIEPTSIZ7_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x7ffff> OTG_HS_DIEPTSIZ7_XFRSIZ; // Transfer size
    typedef bit_field_t<19, 0x3ff> OTG_HS_DIEPTSIZ7_PKTCNT; // Packet count
    typedef bit_field_t<29, 0x3> OTG_HS_DIEPTSIZ7_MCNT; // Multi count
...
struct stm32f722_otg_hs_global_t
{
    ...
    volatile uint32_t OTG_HS_GI2CCTL; // OTG I2C access register
    ...
    static constexpr uint32_t OTG_HS_GI2CCTL_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<26, 0x3> OTG_HS_GI2CCTL_I2CDEVADR; // I2C Device Address
    ...
    typedef bit_field_t<16, 0x7f> OTG_HS_GI2CCTL_ADDR; // I2C Address
    typedef bit_field_t<8, 0xff> OTG_HS_GI2CCTL_REGADDR; // I2C Register Address
    typedef bit_field_t<0, 0xff> OTG_HS_GI2CCTL_RWDATA; // I2C Read/Write Data
...
{
    static constexpr periph_t P = OTG_HS_DEVICE;
    using T = stm32f722_otg_hs_device_t;
    static T& V;
};
...
{
    static constexpr periph_t P = OTG_HS_DEVICE;
    using T = stm32f745_otg_hs_device_t;
    static T& V;
};
...
{
    static constexpr periph_t P = OTG_HS_GLOBAL;
    using T = stm32f722_otg_hs_global_t;
    static T& V;
};
...
{
    static constexpr periph_t P = OTG_HS_GLOBAL;
    using T = stm32f745_otg_hs_global_t;
    static T& V;
};
...
{
    static constexpr periph_t P = OTG_HS_HOST;
    using T = stm32f722_otg_hs_host_t;
    static T& V;
};
...
{
    static constexpr periph_t P = OTG_HS_HOST;
    using T = stm32f745_otg_hs_host_t;
    static T& V;
};
...
{
    static constexpr periph_t P = OTG_HS_PWRCLK;
    using T = stm32f722_otg_hs_pwrclk_t;
    static T& V;
};
...
using otg_hs_device_t = peripheral_t<svd, OTG_HS_DEVICE>;
using otg_hs_global_t = peripheral_t<svd, OTG_HS_GLOBAL>;
using otg_hs_host_t = peripheral_t<svd, OTG_HS_HOST>;
using otg_hs_pwrclk_t = peripheral_t<svd, OTG_HS_PWRCLK>;
