...
struct stm32g030_pwr_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CR2_PVDFT =     // Power voltage detector falling threshold selection
        bit_field_t<1, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR2_PVDRT =     // Power voltage detector rising threshold selection
