...
struct stm32g030_rcc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_HSIDIV =            // HSI16 clock division factor
    ...
    template<uint32_t X>
    static constexpr uint32_t ICSCR_HSICAL =    // HSI16 clock calibration
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICSCR_HSITRIM =   // HSI16 clock trimming
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_PPRE =     // APB prescaler
    ...
    template<uint32_t X>
    static constexpr uint32_t PLLSYSCFGR_PLLSRC =             // PLL input clock source
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSYSCFGR_PLLM =               // Division factor M of the PLL input clock divider
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSYSCFGR_PLLN =               // PLL frequency multiplication factor N
        bit_field_t<8, 0x7f>::value<X>();
    static constexpr uint32_t PLLSYSCFGR_PLLPEN = 0x10000;    // PLLPCLK clock output enable
    template<uint32_t X>
    static constexpr uint32_t PLLSYSCFGR_PLLP =               // PLL VCO division factor P for PLLPCLK clock output
        bit_field_t<17, 0x1f>::value<X>();
    static constexpr uint32_t PLLSYSCFGR_PLLQEN = 0x1000000;  // PLLQCLK clock output enable
    template<uint32_t X>
    static constexpr uint32_t PLLSYSCFGR_PLLQ =               // PLL VCO division factor Q for PLLQCLK clock output
        bit_field_t<25, 0x7>::value<X>();
    static constexpr uint32_t PLLSYSCFGR_PLLREN = 0x10000000; // PLLRCLK clock output enable
    template<uint32_t X>
    static constexpr uint32_t PLLSYSCFGR_PLLR =               // PLL VCO division factor R for PLLRCLK clock output
    ...
    static constexpr uint32_t APBRSTR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APBRSTR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHBENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APBENR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APBENR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t IOPSMENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHBSMENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APBSMENR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APBSMENR2_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CCIPR_I2S2SEL =           // I2S1 clock source selection
    ...
    template<uint32_t X>
    static constexpr uint32_t CCIPR_RNGDIV =            // Division factor of RNG clock divider
...
struct stm32g031_rcc_t
{
    ...
    static constexpr uint32_t CCIPR_I2S2SEL =           // I2S1 clock source selection
        bit_field_t<14, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR_LPTIM1SEL =         // LPTIM1 clock source selection
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR_LPTIM2SEL =         // LPTIM2 clock source selection
