...
struct stm32g070_rtc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t HWCFGR_ALARMB =          // ALARMB
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR_WAKEUP =          // WAKEUP
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR_SMOOTH_CALIB =    // SMOOTH_CALIB
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR_TIMESTAMP =       // TIMESTAMP
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR_OPTIONREG_OUT =   // OPTIONREG_OUT
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR_TRUST_ZONE =      // TRUST_ZONE
        bit_field_t<24, 0xf>::value<X>();
    ...
    static constexpr uint32_t IPIDR_RESET_VALUE = 0x120033;
