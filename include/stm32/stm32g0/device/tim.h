...
struct stm32g030_tim1_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t SMCR_TS_4 =           // Trigger selection
        bit_field_t<4, 0x7>::value<X>();
    ...
    static constexpr uint32_t CCMR1_Input_CC1S =          // Capture/Compare 1 selection
        bit_field_t<0, 0x3>::value<X>();
    static constexpr uint32_t CCMR1_Input_OC1FE = 0x4;    // Output Compare 1 fast enable
    static constexpr uint32_t CCMR1_Input_OC1PE = 0x8;    // Output Compare 1 preload enable
    template<uint32_t X>
    static constexpr uint32_t CCMR1_Input_OC1M =          // Output Compare 1 mode
        bit_field_t<4, 0x7>::value<X>();
    static constexpr uint32_t CCMR1_Input_OC1CE = 0x80;   // Output Compare 1 clear enable
    template<uint32_t X>
    static constexpr uint32_t CCMR1_Input_CC2S =          // Capture/Compare 2 selection
        bit_field_t<8, 0x3>::value<X>();
    static constexpr uint32_t CCMR1_Input_OC2FE = 0x400;  // Output Compare 2 fast enable
    static constexpr uint32_t CCMR1_Input_OC2PE = 0x800;  // Output Compare 2 preload enable
    template<uint32_t X>
    static constexpr uint32_t CCMR1_Input_OC2M =          // Output Compare 2 mode
        bit_field_t<12, 0x7>::value<X>();
    static constexpr uint32_t CCMR1_Input_OC2CE = 0x8000; // Output Compare 2 clear enable
    ...
    static constexpr uint32_t CCMR2_Input_CC3S =          // Capture/Compare 3 selection
        bit_field_t<0, 0x3>::value<X>();
    static constexpr uint32_t CCMR2_Input_OC3FE = 0x4;    // Output compare 3 fast enable
    static constexpr uint32_t CCMR2_Input_OC3PE = 0x8;    // Output compare 3 preload enable
    template<uint32_t X>
    static constexpr uint32_t CCMR2_Input_OC3M =          // Output compare 3 mode
        bit_field_t<4, 0x7>::value<X>();
    static constexpr uint32_t CCMR2_Input_OC3CE = 0x80;   // Output compare 3 clear enable
    template<uint32_t X>
    static constexpr uint32_t CCMR2_Input_CC4S =          // Capture/Compare 4 selection
        bit_field_t<8, 0x3>::value<X>();
    static constexpr uint32_t CCMR2_Input_OC4FE = 0x400;  // Output compare 4 fast enable
    static constexpr uint32_t CCMR2_Input_OC4PE = 0x800;  // Output compare 4 preload enable
    template<uint32_t X>
    static constexpr uint32_t CCMR2_Input_OC4M =          // Output compare 4 mode
        bit_field_t<12, 0x7>::value<X>();
    static constexpr uint32_t CCMR2_Input_OC4CE = 0x8000; // Output compare 4 clear enable
    ...
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI1SEL3_0 =   // selects TI1[0] to TI1[15] input
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI2SEL3_0 =   // selects TI2[0] to TI2[15] input
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI3SEL3_0 =   // selects TI3[0] to TI3[15] input
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI4SEL3_0 =   // selects TI4[0] to TI4[15] input
...
struct stm32g030_tim14_t
{
    ...
    static constexpr uint32_t CCR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CCR1_CCR1 =   // Low Capture/Compare 1 value
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t TISEL_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t TISEL_TISEL =   // TI1[0] to TI1[15] input selection
        bit_field_t<0, 0xf>::value<X>();
};
...
struct stm32g071_tim15_t
{
    ...
    static constexpr uint32_t CCMR1_Output_RESET_VALUE = 0x0;
    static constexpr uint32_t CCMR1_Output_OC2M_3 = 0x1000000; // Output Compare 2 mode
    ...
    static constexpr uint32_t BDTR_MOE = 0x8000;       // Main output enable
    template<uint32_t X>
    static constexpr uint32_t BDTR_BKF =               // BKF
        bit_field_t<16, 0xf>::value<X>();
    ...
    static constexpr uint32_t TISEL_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI1SEL =   // selects input
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI2SEL =   // selects input
        bit_field_t<8, 0xf>::value<X>();
};
...
struct stm32g030_tim2_t
{
    ...
    static constexpr uint32_t AF1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t AF1_ETRSEL =   // External trigger source selection
        bit_field_t<14, 0xf>::value<X>();

    static constexpr uint32_t TISEL_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI1SEL =   // TI1SEL
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t TISEL_TI2SEL =   // TI2SEL
        bit_field_t<8, 0xf>::value<X>();
};
...
{
    using tim = tim1_t;
    static constexpr alternate_function_t BK = TIM1_BK;
    static constexpr alternate_function_t BK2 = TIM1_BK2;
...
{
    using tim = tim15_t;
    static constexpr alternate_function_t BK = TIM15_BK;
...
{
    using tim = tim16_t;
    static constexpr alternate_function_t BK = TIM16_BK;
...
{
    using tim = tim17_t;
    static constexpr alternate_function_t BK = TIM17_BK;
