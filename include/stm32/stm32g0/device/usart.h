...
struct stm32g031_lpuart1_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CR1_DEAT =               // DEAT0
        bit_field_t<21, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR1_DEDT0 =              // DEDT0
...
struct stm32g070_lpuart1_t
{
    ...
    static constexpr uint32_t HWCFGR2_RESET_VALUE = 0x13;
    template<uint32_t X>
    static constexpr uint32_t HWCFGR2_CFG1 =   // LUART hardware configuration 1
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR2_CFG2 =   // LUART hardware configuration 2
        bit_field_t<4, 0xf>::value<X>();

    static constexpr uint32_t HWCFGR1_RESET_VALUE = 0x31100000;
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG1 =   // LUART hardware configuration 1
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG2 =   // LUART hardware configuration 2
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG3 =   // LUART hardware configuration 1
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG4 =   // LUART hardware configuration 2
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG5 =   // LUART hardware configuration 2
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG6 =   // LUART hardware configuration 2
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG7 =   // LUART hardware configuration 2
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HWCFGR1_CFG8 =   // LUART hardware configuration 2
        bit_field_t<28, 0xf>::value<X>();
...
template<> struct usart_traits<4>
{
    ...
    static constexpr alternate_function_t NSS = USART4_NSS;
