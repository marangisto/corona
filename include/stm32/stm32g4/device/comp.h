...
struct stm32g431xx_comp_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t COMP_C1CSR_HYST =                  // HYST
        bit_field_t<16, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP_C1CSR_BLANKSEL =              // BLANKSEL
