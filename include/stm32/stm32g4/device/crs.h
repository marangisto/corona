...
struct stm32g431xx_crs_t
{
    ...
    typedef bit_field_t<8, 0x7f> CR_TRIM; // HSI48 oscillator smooth trimming These bits provide a user-programmable trimming value to the HSI48 oscillator. They can be programmed to adjust to variations in voltage and temperature that influence the frequency of the HSI48. The default value is 32, which corresponds to the middle of the trimming interval. The trimming step is around 67 kHz between two consecutive TRIM steps. A higher TRIM value corresponds to a higher output frequency. When the AUTOTRIMEN bit is set, this field is controlled by hardware and is read-only.
    ...
    typedef bit_field_t<16, 0xffff> ISR_FECAP; // Frequency error capture FECAP is the frequency error counter value latched in the time ofthe last SYNC event. Refer to Section7.3.4: Frequency error evaluation and automatic trimming for more details about FECAP usage.
...
template<>
struct peripheral_t<STM32G491xx, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32g431xx_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G4A1xx, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32g431xx_crs_t;
    static T& V;
