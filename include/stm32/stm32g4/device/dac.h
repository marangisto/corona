...
struct stm32g431xx_dac1_t
{
    ...
    volatile uint32_t DAC_STR1; // Sawtooth register
    volatile uint32_t DAC_STR2; // Sawtooth register
    volatile uint32_t DAC_STMODR; // Sawtooth Mode register
    ...
    typedef bit_field_t<2, 0xf> DAC_CR_TSEL1; // DAC channel1 trigger selection These bits select the external event used to trigger DAC channel1. Note: Only used if bit TEN1 = 1 (DAC channel1 trigger enabled).
    ...
    typedef bit_field_t<18, 0xf> DAC_CR_TSEL2; // DAC channel2 trigger selection These bits select the external event used to trigger DAC channel2 Note: Only used if bit TEN2 = 1 (DAC channel2 trigger enabled).
    ...
    typedef bit_field_t<8, 0xff> DAC_DHR8R1_DACC1DHRB; // DAC channel1 8-bit right-aligned data
    ...
    static constexpr uint32_t DAC_STR1_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xfff> DAC_STR1_STRSTDATA1; // DAC Channel 1 Sawtooth reset value
    static constexpr uint32_t DAC_STR1_STDIR1 = 0x1000; // DAC Channel1 Sawtooth direction setting
    typedef bit_field_t<16, 0xffff> DAC_STR1_STINCDATA1; // DAC CH1 Sawtooth increment value (12.4 bit format)

    static constexpr uint32_t DAC_STR2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xfff> DAC_STR2_STRSTDATA2; // DAC Channel 2 Sawtooth reset value
    static constexpr uint32_t DAC_STR2_STDIR2 = 0x1000; // DAC Channel2 Sawtooth direction setting
    typedef bit_field_t<16, 0xffff> DAC_STR2_STINCDATA2; // DAC CH2 Sawtooth increment value (12.4 bit format)

    static constexpr uint32_t DAC_STMODR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xf> DAC_STMODR_STRSTTRIGSEL1; // DAC Channel 1 Sawtooth Reset trigger selection
    typedef bit_field_t<8, 0xf> DAC_STMODR_STINCTRIGSEL1; // DAC Channel 1 Sawtooth Increment trigger selection
    typedef bit_field_t<16, 0xf> DAC_STMODR_STRSTTRIGSEL2; // DAC Channel 1 Sawtooth Reset trigger selection
    typedef bit_field_t<24, 0xf> DAC_STMODR_STINCTRIGSEL2; // DAC Channel 2 Sawtooth Increment trigger selection
};
