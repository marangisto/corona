...
////
//
//      STM32G4 FMC peripherals
//
///

// FMC: Flexible memory controller

struct stm32g473xx_fmc_t
{
    ...
    static constexpr uint32_t BCR1_WFDIS = 0x200000; // WFDIS
    typedef bit_field_t<22, 0x3> BCR1_NBLSET; // NBLSET

    static constexpr uint32_t BTR1_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<30, 0x3> BTR1_DATAHLD; // DATAHLD
    ...
    static constexpr uint32_t BCR2_CCLKEN = 0x100000; // CCLKEN
    static constexpr uint32_t BCR2_WFDIS = 0x200000; // WFDIS
    typedef bit_field_t<22, 0x3> BCR2_NBLSET; // NBLSET

    static constexpr uint32_t BTR2_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<30, 0x3> BTR2_DATAHLD; // DATAHLD
    ...
    static constexpr uint32_t BCR3_CCLKEN = 0x100000; // CCLKEN
    static constexpr uint32_t BCR3_WFDIS = 0x200000; // WFDIS
    typedef bit_field_t<22, 0x3> BCR3_NBLSET; // NBLSET

    static constexpr uint32_t BTR3_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<30, 0x3> BTR3_DATAHLD; // DATAHLD
    ...
    static constexpr uint32_t BCR4_CCLKEN = 0x100000; // CCLKEN
    static constexpr uint32_t BCR4_WFDIS = 0x200000; // WFDIS
    typedef bit_field_t<22, 0x3> BCR4_NBLSET; // NBLSET

    static constexpr uint32_t BTR4_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<30, 0x3> BTR4_DATAHLD; // DATAHLD
    ...
    typedef bit_field_t<0, 0xffff> PCSCNTR_CSCOUNT; // CSCOUNT
    static constexpr uint32_t PCSCNTR_CNTB1EN = 0x10000; // CNTB1EN
    static constexpr uint32_t PCSCNTR_CNTB2EN = 0x20000; // CNTB2EN
    static constexpr uint32_t PCSCNTR_CNTB3EN = 0x40000; // CNTB3EN
    static constexpr uint32_t PCSCNTR_CNTB4EN = 0x80000; // CNTB4EN
    ...
    typedef bit_field_t<30, 0x3> BWTR1_DATAHLD; // DATAHLD
    ...
    typedef bit_field_t<30, 0x3> BWTR2_DATAHLD; // DATAHLD
    ...
    typedef bit_field_t<30, 0x3> BWTR3_DATAHLD; // DATAHLD
    typedef bit_field_t<28, 0x3> BWTR3_ACCMOD; // ACCMOD
    typedef bit_field_t<16, 0xf> BWTR3_BUSTURN; // BUSTURN
    ...
    typedef bit_field_t<30, 0x3> BWTR4_DATAHLD; // DATAHLD
    typedef bit_field_t<28, 0x3> BWTR4_ACCMOD; // ACCMOD
    typedef bit_field_t<16, 0xf> BWTR4_BUSTURN; // BUSTURN
...
template<>
struct peripheral_t<STM32G473xx, FMC>
{
    static constexpr periph_t P = FMC;
    using T = stm32g473xx_fmc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32G474xx, FMC>
{
    static constexpr periph_t P = FMC;
    using T = stm32g473xx_fmc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G483xx, FMC>
{
    static constexpr periph_t P = FMC;
    using T = stm32g473xx_fmc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G484xx, FMC>
{
    static constexpr periph_t P = FMC;
    using T = stm32g473xx_fmc_t;
    static T& V;
