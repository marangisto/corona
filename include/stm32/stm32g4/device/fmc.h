...
struct stm32g473xx_fmc_t
{
    ...
    volatile uint32_t PCSCNTR; // [read-write] PSRAM chip select counter register
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR1_NBLSET =            // NBLSET
        bit_field_t<22, 0x3>::value<X>();

    static constexpr uint32_t BTR1_RESET_VALUE = 0xffffffff;
    template<uint32_t X>
    static constexpr uint32_t BTR1_DATAHLD =   // DATAHLD
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR2_NBLSET =            // NBLSET
        bit_field_t<22, 0x3>::value<X>();

    static constexpr uint32_t BTR2_RESET_VALUE = 0xffffffff;
    template<uint32_t X>
    static constexpr uint32_t BTR2_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR3_NBLSET =            // NBLSET
        bit_field_t<22, 0x3>::value<X>();

    static constexpr uint32_t BTR3_RESET_VALUE = 0xffffffff;
    template<uint32_t X>
    static constexpr uint32_t BTR3_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR4_NBLSET =            // NBLSET
        bit_field_t<22, 0x3>::value<X>();

    static constexpr uint32_t BTR4_RESET_VALUE = 0xffffffff;
    template<uint32_t X>
    static constexpr uint32_t BTR4_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t PCSCNTR_CSCOUNT =          // CSCOUNT
    ...
    template<uint32_t X>
    static constexpr uint32_t BWTR1_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t BWTR2_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t BWTR3_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t BWTR4_DATAHLD =   // DATAHLD
        bit_field_t<30, 0x3>::value<X>();
    template<uint32_t X>
