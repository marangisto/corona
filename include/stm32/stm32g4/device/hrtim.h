...
struct stm32g474xx_hrtim_common_t
{
    ...
    volatile uint32_t BMCMPR; // BMCMPR
    ...
    volatile uint32_t BDTAUPR; // Burst DMA Timerx update Register
    volatile uint32_t BDTBUPR; // Burst DMA Timerx update Register
    volatile uint32_t BDTCUPR; // Burst DMA Timerx update Register
    volatile uint32_t BDTDUPR; // Burst DMA Timerx update Register
    volatile uint32_t BDTEUPR; // Burst DMA Timerx update Register
    volatile uint32_t BDMADR; // Burst DMA Data Register
    volatile uint32_t BDTFUPR; // Burst DMA Timerx update Register
    volatile uint32_t ADCER; // HRTIM ADC Extended Trigger Register
    volatile uint32_t ADCUR; // HRTIM ADC Trigger Update Register
    volatile uint32_t ADCPS1; // HRTIM ADC Post Scaler Register 1
    volatile uint32_t ADCPS2; // HRTIM ADC Post Scaler Register 2
    volatile uint32_t FLTINR3; // HRTIM Fault Input Register 3
    volatile uint32_t FLTINR4; // HRTIM Fault Input Register 4
    ...
    static constexpr uint32_t ODISR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t BMCMPR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> BMCMPR_BMCMP; // BMCMP
    ...
    typedef bit_field_t<0, 0x3> EECR2_EE6SRC; // EE6SRC
    static constexpr uint32_t EECR2_EE6POL = 0x4; // EE6POL
    typedef bit_field_t<3, 0x3> EECR2_EE6SNS; // EE6SNS
    typedef bit_field_t<6, 0x3> EECR2_EE7SRC; // EE7SRC
    static constexpr uint32_t EECR2_EE7POL = 0x100; // EE7POL
    typedef bit_field_t<9, 0x3> EECR2_EE7SNS; // EE7SNS
    typedef bit_field_t<12, 0x3> EECR2_EE8SRC; // EE8SRC
    static constexpr uint32_t EECR2_EE8POL = 0x4000; // EE8POL
    typedef bit_field_t<15, 0x3> EECR2_EE8SNS; // EE8SNS
    typedef bit_field_t<18, 0x3> EECR2_EE9SRC; // EE9SRC
    static constexpr uint32_t EECR2_EE9POL = 0x100000; // EE9POL
    typedef bit_field_t<21, 0x3> EECR2_EE9SNS; // EE9SNS
    typedef bit_field_t<24, 0x3> EECR2_EE10SRC; // EE10SRC
    static constexpr uint32_t EECR2_EE10POL = 0x4000000; // EE10POL
    typedef bit_field_t<27, 0x3> EECR2_EE10SNS; // EE10SNS

    static constexpr uint32_t EECR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xf> EECR3_EE6F; // EE6F
    typedef bit_field_t<6, 0xf> EECR3_EE7F; // EE7F
    typedef bit_field_t<12, 0xf> EECR3_EE8F; // EE8F
    typedef bit_field_t<18, 0xf> EECR3_EE9F; // EE9F
    typedef bit_field_t<24, 0xf> EECR3_EE10F; // EE10F
    typedef bit_field_t<30, 0x3> EECR3_EEVSD; // EEVSD
    ...
    typedef bit_field_t<11, 0xf> FLTINR2_FLT6F; // FLT6F
    ...
    static constexpr uint32_t BDTAUPR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t BDTBUPR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t BDTCUPR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t BDTDUPR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t BDTEUPR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t BDTFUPR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t ADCER_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<26, 0x1f> ADCER_ADC10TRG; // ADC10TRG
    typedef bit_field_t<21, 0x1f> ADCER_ADC9TRG; // ADC9TRG
    typedef bit_field_t<16, 0x1f> ADCER_ADC8TRG; // ADC8TRG
    typedef bit_field_t<10, 0x1f> ADCER_ADC7TRG; // ADC7TRG
    typedef bit_field_t<5, 0x1f> ADCER_ADC6TRG; // ADC6TRG
    typedef bit_field_t<0, 0x1f> ADCER_ADC5TRG; // ADC5TRG

    static constexpr uint32_t ADCUR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<20, 0x7> ADCUR_AD10USRC; // AD10USRC
    typedef bit_field_t<16, 0x7> ADCUR_AD9USRC; // AD9USRC
    typedef bit_field_t<12, 0x7> ADCUR_AD8USRC; // AD8USRC
    typedef bit_field_t<8, 0x7> ADCUR_AD7USRC; // AD7USRC
    typedef bit_field_t<4, 0x7> ADCUR_AD6USRC; // AD6USRC
    typedef bit_field_t<0, 0x7> ADCUR_AD5USRC; // AD5USRC

    static constexpr uint32_t ADCPS1_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0x1f> ADCPS1_ADC5PSC; // ADC5PSC
    typedef bit_field_t<18, 0x1f> ADCPS1_ADC4PSC; // ADC4PSC
    typedef bit_field_t<12, 0x1f> ADCPS1_ADC3PSC; // ADC3PSC
    typedef bit_field_t<6, 0x1f> ADCPS1_ADC2PSC; // ADC2PSC
    typedef bit_field_t<0, 0x1f> ADCPS1_ADC1PSC; // ADC1PSC

    static constexpr uint32_t ADCPS2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0x1f> ADCPS2_ADC10PSC; // ADC10PSC
    typedef bit_field_t<18, 0x1f> ADCPS2_ADC9PSC; // ADC9PSC
    typedef bit_field_t<12, 0x1f> ADCPS2_ADC8PSC; // ADC8PSC
    typedef bit_field_t<6, 0x1f> ADCPS2_ADC7PSC; // ADC7PSC
    typedef bit_field_t<0, 0x1f> ADCPS2_ADC6PSC; // ADC6PSC

    static constexpr uint32_t FLTINR3_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<26, 0xf> FLTINR3_FLT4CNT; // FLT4CNT
    ...
    typedef bit_field_t<18, 0xf> FLTINR3_FLT3CNT; // FLT3CNT
    ...
    typedef bit_field_t<10, 0xf> FLTINR3_FLT2CNT; // FLT2CNT
    ...
    typedef bit_field_t<2, 0xf> FLTINR4_FLT5CNT; // FLT5CNT
...
struct stm32g474xx_hrtim_master_t
{
    ...
    volatile uint32_t MDIER; // HRTIM Master Timer DMA / Interrupt Enable Register
    ...
    typedef bit_field_t<8, 0x3> MCR_SYNC_IN; // synchronization input
    typedef bit_field_t<6, 0x3> MCR_INTLVD; // Interleaved mode
    ...
    static constexpr uint32_t MDIER_RESET_VALUE = 0x0; // Reset value
...
struct stm32g474xx_hrtim_tima_t
{
    ...
    volatile uint32_t TIMADIER; // TIMxDIER
    ...
    volatile uint32_t TIMACR2; // HRTIM Timerx Control Register 2
    volatile uint32_t AEEFR3; // HRTIM Timerx External Event Filtering Register 3
    ...
    typedef bit_field_t<7, 0x3> TIMACR_INTLVD; // Interleaved mode
    ...
    static constexpr uint32_t TIMADIER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMACR2_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<14, 0x3> TIMACR2_FEROM; // Fault and Event Roll-Over Mode
    typedef bit_field_t<12, 0x3> TIMACR2_BMROM; // Burst Mode Roll-Over Mode
    typedef bit_field_t<10, 0x3> TIMACR2_ADROM; // ADC Roll-Over Mode
    typedef bit_field_t<8, 0x3> TIMACR2_OUTROM; // Output Roll-Over Mode
    typedef bit_field_t<6, 0x3> TIMACR2_ROM; // Roll-Over Mode
    ...
    static constexpr uint32_t AEEFR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> AEEFR3_EEVACNT; // External Event A counter
    typedef bit_field_t<4, 0xf> AEEFR3_EEVASEL; // External Event A Selection
...
struct stm32g474xx_hrtim_timb_t
{
    ...
    volatile uint32_t TIMBDIER; // TIMxDIER
    ...
    volatile uint32_t TIMBCR2; // HRTIM Timerx Control Register 2
    volatile uint32_t BEEFR3; // HRTIM Timerx External Event Filtering Register 3
    ...
    typedef bit_field_t<7, 0x3> TIMBCR_INTLVD; // Interleaved mode
    ...
    static constexpr uint32_t TIMBDIER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMBCR2_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<14, 0x3> TIMBCR2_FEROM; // Fault and Event Roll-Over Mode
    typedef bit_field_t<12, 0x3> TIMBCR2_BMROM; // Burst Mode Roll-Over Mode
    typedef bit_field_t<10, 0x3> TIMBCR2_ADROM; // ADC Roll-Over Mode
    typedef bit_field_t<8, 0x3> TIMBCR2_OUTROM; // Output Roll-Over Mode
    typedef bit_field_t<6, 0x3> TIMBCR2_ROM; // Roll-Over Mode
    ...
    static constexpr uint32_t BEEFR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> BEEFR3_EEVACNT; // External Event A counter
    typedef bit_field_t<4, 0xf> BEEFR3_EEVASEL; // External Event A Selection
...
struct stm32g474xx_hrtim_timc_t
{
    ...
    volatile uint32_t TIMCDIER; // TIMxDIER
    ...
    volatile uint32_t TIMCCR2; // HRTIM Timerx Control Register 2
    volatile uint32_t CEEFR3; // HRTIM Timerx External Event Filtering Register 3
    ...
    typedef bit_field_t<7, 0x3> TIMCCR_INTLVD; // Interleaved mode
    ...
    static constexpr uint32_t TIMCDIER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMCCR2_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<14, 0x3> TIMCCR2_FEROM; // Fault and Event Roll-Over Mode
    typedef bit_field_t<12, 0x3> TIMCCR2_BMROM; // Burst Mode Roll-Over Mode
    typedef bit_field_t<10, 0x3> TIMCCR2_ADROM; // ADC Roll-Over Mode
    typedef bit_field_t<8, 0x3> TIMCCR2_OUTROM; // Output Roll-Over Mode
    typedef bit_field_t<6, 0x3> TIMCCR2_ROM; // Roll-Over Mode
    ...
    static constexpr uint32_t CEEFR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> CEEFR3_EEVACNT; // External Event A counter
    typedef bit_field_t<4, 0xf> CEEFR3_EEVASEL; // External Event A Selection
...
struct stm32g474xx_hrtim_timd_t
{
    ...
    volatile uint32_t TIMDDIER; // TIMxDIER
    ...
    volatile uint32_t TIMDCR2; // HRTIM Timerx Control Register 2
    volatile uint32_t DEEFR3; // HRTIM Timerx External Event Filtering Register 3
    ...
    typedef bit_field_t<7, 0x3> TIMDCR_INTLVD; // Interleaved mode
    ...
    static constexpr uint32_t TIMDDIER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMDCR2_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<14, 0x3> TIMDCR2_FEROM; // Fault and Event Roll-Over Mode
    typedef bit_field_t<12, 0x3> TIMDCR2_BMROM; // Burst Mode Roll-Over Mode
    typedef bit_field_t<10, 0x3> TIMDCR2_ADROM; // ADC Roll-Over Mode
    typedef bit_field_t<8, 0x3> TIMDCR2_OUTROM; // Output Roll-Over Mode
    typedef bit_field_t<6, 0x3> TIMDCR2_ROM; // Roll-Over Mode
    ...
    static constexpr uint32_t DEEFR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> DEEFR3_EEVACNT; // External Event A counter
    typedef bit_field_t<4, 0xf> DEEFR3_EEVASEL; // External Event A Selection
...
struct stm32g474xx_hrtim_time_t
{
    ...
    volatile uint32_t TIMEDIER; // TIMxDIER
    ...
    volatile uint32_t TIMECR2; // HRTIM Timerx Control Register 2
    volatile uint32_t EEEFR3; // HRTIM Timerx External Event Filtering Register 3
    ...
    typedef bit_field_t<7, 0x3> TIMECR_INTLVD; // Interleaved mode
    ...
    static constexpr uint32_t TIMEDIER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMECR2_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<14, 0x3> TIMECR2_FEROM; // Fault and Event Roll-Over Mode
    typedef bit_field_t<12, 0x3> TIMECR2_BMROM; // Burst Mode Roll-Over Mode
    typedef bit_field_t<10, 0x3> TIMECR2_ADROM; // ADC Roll-Over Mode
    typedef bit_field_t<8, 0x3> TIMECR2_OUTROM; // Output Roll-Over Mode
    typedef bit_field_t<6, 0x3> TIMECR2_ROM; // Roll-Over Mode
    ...
    static constexpr uint32_t EEEFR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> EEEFR3_EEVACNT; // External Event A counter
    typedef bit_field_t<4, 0xf> EEEFR3_EEVASEL; // External Event A Selection
...
{
    volatile uint32_t TIMFCR; // Timerx Control Register
    volatile uint32_t TIMFISR; // Timerx Interrupt Status Register
    volatile uint32_t TIMFICR; // Timerx Interrupt Clear Register
    volatile uint32_t TIMFDIER; // TIMxDIER
    volatile uint32_t CNTFR; // Timerx Counter Register
    volatile uint32_t PERFR; // Timerx Period Register
    volatile uint32_t REPFR; // Timerx Repetition Register
    volatile uint32_t CMP1FR; // Timerx Compare 1 Register
    volatile uint32_t CMP1CFR; // Timerx Compare 1 Compound Register
    volatile uint32_t CMP2FR; // Timerx Compare 2 Register
    volatile uint32_t CMP3FR; // Timerx Compare 3 Register
    volatile uint32_t CMP4FR; // Timerx Compare 4 Register
    volatile uint32_t CPT1FR; // Timerx Capture 1 Register
    volatile uint32_t CPT2FR; // Timerx Capture 2 Register
    volatile uint32_t DTFR; // Timerx Deadtime Register
    volatile uint32_t SETF1R; // Timerx Output1 Set Register
    volatile uint32_t RSTE1R; // Timerx Output1 Reset Register
    volatile uint32_t SETF2R; // Timerx Output2 Set Register
    volatile uint32_t RSTF2R; // Timerx Output2 Reset Register
    volatile uint32_t EEFFR1; // Timerx External Event Filtering Register 1
    volatile uint32_t EEFFR2; // Timerx External Event Filtering Register 2
    volatile uint32_t RSTFR; // TimerA Reset Register
    volatile uint32_t CHPFR; // Timerx Chopper Register
    volatile uint32_t CPT1FCR; // Timerx Capture 2 Control Register
    volatile uint32_t CPT2FCR; // CPT2xCR
    volatile uint32_t OUTFR; // Timerx Output Register
    volatile uint32_t FLTFR; // Timerx Fault Register
    volatile uint32_t TIMFCR2; // HRTIM Timerx Control Register 2
    volatile uint32_t FEEFR3; // HRTIM Timerx External Event Filtering Register 3

    static constexpr uint32_t TIMFCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<28, 0xf> TIMFCR_UPDGAT; // Update Gating
    static constexpr uint32_t TIMFCR_PREEN = 0x8000000; // Preload enable
    typedef bit_field_t<25, 0x3> TIMFCR_DACSYNC; // AC Synchronization
    ...
    typedef bit_field_t<14, 0x3> TIMFCR_DELCMP4; // Delayed CMP4 mode
    typedef bit_field_t<12, 0x3> TIMFCR_DELCMP2; // Delayed CMP2 mode
    ...
    typedef bit_field_t<7, 0x3> TIMFCR_INTLVD; // Interleaved mode
    ...
    typedef bit_field_t<0, 0x7> TIMFCR_CK_PSCX; // HRTIM Timer x Clock prescaler

    static constexpr uint32_t TIMFISR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMFICR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMFDIER_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CNTFR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CNTFR_CNTX; // Timerx Counter value

    static constexpr uint32_t PERFR_RESET_VALUE = 0xffff; // Reset value
    typedef bit_field_t<0, 0xffff> PERFR_PERX; // Timerx Period value

    static constexpr uint32_t REPFR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xff> REPFR_REPX; // Timerx Repetition counter value

    static constexpr uint32_t CMP1FR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CMP1FR_CMP1X; // Timerx Compare 1 value

    static constexpr uint32_t CMP1CFR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<16, 0xff> CMP1CFR_REPX; // Timerx Repetition value (aliased from HRTIM_REPx register)
    typedef bit_field_t<0, 0xffff> CMP1CFR_CMP1X; // Timerx Compare 1 value

    static constexpr uint32_t CMP2FR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CMP2FR_CMP2X; // Timerx Compare 2 value

    static constexpr uint32_t CMP3FR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CMP3FR_CMP3X; // Timerx Compare 3 value

    static constexpr uint32_t CMP4FR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CMP4FR_CMP4X; // Timerx Compare 4 value

    static constexpr uint32_t CPT1FR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CPT1FR_CPT1X; // Timerx Capture 1 value
    static constexpr uint32_t CPT1FR_DIR = 0x10000; // Timerx Capture 1 Direction status

    static constexpr uint32_t CPT2FR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CPT2FR_CPT2X; // Timerx Capture 2 value
    static constexpr uint32_t CPT2FR_DIR = 0x10000; // Timerx Capture 1 Direction status

    static constexpr uint32_t DTFR_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<16, 0x1ff> DTFR_DTFX; // Deadtime Falling value
    ...
    typedef bit_field_t<10, 0x7> DTFR_DTPRSC; // Deadtime Prescaler
    static constexpr uint32_t DTFR_SDTRX = 0x200; // Sign Deadtime Rising value
    typedef bit_field_t<0, 0x1ff> DTFR_DTRX; // Deadtime Rising value

    static constexpr uint32_t SETF1R_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t SETF2R_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t RSTF2R_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t EEFFR1_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> EEFFR1_EE5FLTR; // External Event 5 filter
    static constexpr uint32_t EEFFR1_EE5LTCH = 0x1000000; // External Event 5 latch
    typedef bit_field_t<19, 0xf> EEFFR1_EE4FLTR; // External Event 4 filter
    static constexpr uint32_t EEFFR1_EE4LTCH = 0x40000; // External Event 4 latch
    typedef bit_field_t<13, 0xf> EEFFR1_EE3FLTR; // External Event 3 filter
    static constexpr uint32_t EEFFR1_EE3LTCH = 0x1000; // External Event 3 latch
    typedef bit_field_t<7, 0xf> EEFFR1_EE2FLTR; // External Event 2 filter
    static constexpr uint32_t EEFFR1_EE2LTCH = 0x40; // External Event 2 latch
    typedef bit_field_t<1, 0xf> EEFFR1_EE1FLTR; // External Event 1 filter
    static constexpr uint32_t EEFFR1_EE1LTCH = 0x1; // External Event 1 latch

    static constexpr uint32_t EEFFR2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<25, 0xf> EEFFR2_EE10FLTR; // External Event 10 filter
    static constexpr uint32_t EEFFR2_EE10LTCH = 0x1000000; // External Event 10 latch
    typedef bit_field_t<19, 0xf> EEFFR2_EE9FLTR; // External Event 9 filter
    static constexpr uint32_t EEFFR2_EE9LTCH = 0x40000; // External Event 9 latch
    typedef bit_field_t<13, 0xf> EEFFR2_EE8FLTR; // External Event 8 filter
    static constexpr uint32_t EEFFR2_EE8LTCH = 0x1000; // External Event 8 latch
    typedef bit_field_t<7, 0xf> EEFFR2_EE7FLTR; // External Event 7 filter
    static constexpr uint32_t EEFFR2_EE7LTCH = 0x40; // External Event 7 latch
    typedef bit_field_t<1, 0xf> EEFFR2_EE6FLTR; // External Event 6 filter
    static constexpr uint32_t EEFFR2_EE6LTCH = 0x1; // External Event 6 latch

    static constexpr uint32_t RSTFR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CHPFR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<7, 0xf> CHPFR_STRTPW; // STRTPW
    typedef bit_field_t<4, 0x7> CHPFR_CHPDTY; // Timerx chopper duty cycle value
    typedef bit_field_t<0, 0xf> CHPFR_CHPFRQ; // Timerx carrier frequency value

    static constexpr uint32_t CPT1FCR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t CPT2FCR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t OUTFR_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<20, 0x3> OUTFR_FAULT2; // Output 2 Fault state
    ...
    typedef bit_field_t<10, 0x7> OUTFR_DLYPRT; // Delayed Protection
    ...
    typedef bit_field_t<4, 0x3> OUTFR_FAULT1; // Output 1 Fault state
    ...
    static constexpr uint32_t FLTFR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t TIMFCR2_RESET_VALUE = 0x0; // Reset value
    ...
    typedef bit_field_t<14, 0x3> TIMFCR2_FEROM; // Fault and Event Roll-Over Mode
    typedef bit_field_t<12, 0x3> TIMFCR2_BMROM; // Burst Mode Roll-Over Mode
    typedef bit_field_t<10, 0x3> TIMFCR2_ADROM; // ADC Roll-Over Mode
    typedef bit_field_t<8, 0x3> TIMFCR2_OUTROM; // Output Roll-Over Mode
    typedef bit_field_t<6, 0x3> TIMFCR2_ROM; // Roll-Over Mode
    ...
    static constexpr uint32_t FEEFR3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<8, 0x3f> FEEFR3_EEVACNT; // External Event A counter
    typedef bit_field_t<4, 0xf> FEEFR3_EEVASEL; // External Event A Selection
...
{
    static constexpr periph_t P = HRTIM_COMMON;
    using T = stm32g474xx_hrtim_common_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_MASTER;
    using T = stm32g474xx_hrtim_master_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_TIMA;
    using T = stm32g474xx_hrtim_tima_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_TIMB;
    using T = stm32g474xx_hrtim_timb_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_TIMC;
    using T = stm32g474xx_hrtim_timc_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_TIMD;
    using T = stm32g474xx_hrtim_timd_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_TIME;
    using T = stm32g474xx_hrtim_time_t;
    static T& V;
};
...
{
    static constexpr periph_t P = HRTIM_TIMF;
    using T = stm32g474xx_hrtim_timf_t;
    static T& V;
};
...
template<> struct hrtim_traits<10>
{
    ...
    static void enable()
    {
        RCC::V.APB2ENR |= RCC::T::APB2ENR_HRTIM_MASTEREN;
    }
    ...
    {
        RCC::V.APB2SMENR |= RCC::T::APB2SMENR_HRTIM_MASTERSMEN;
    }
