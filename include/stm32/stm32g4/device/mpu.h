...
struct stm32g431xx_mpu_t
{
    ...
    volatile uint32_t CTRL;  // [read-write] MPU control register
    ...
    static constexpr uint32_t TYPER_RESET_VALUE = 0x800;
    static constexpr uint32_t TYPER_SEPARATE = 0x1; // Separate flag
    template<uint32_t X>
    static constexpr uint32_t TYPER_DREGION =       // Number of MPU data regions
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t TYPER_IREGION =       // Number of MPU instruction regions
    ...
    static constexpr uint32_t RNR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t RNR_REGION =   // MPU region
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t RBAR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t RBAR_REGION =      // MPU region field
        bit_field_t<0, 0xf>::value<X>();
    static constexpr uint32_t RBAR_VALID = 0x10; // MPU region number valid
    template<uint32_t X>
    static constexpr uint32_t RBAR_ADDR =        // Region base address field
        bit_field_t<5, 0x7ffffff>::value<X>();

    static constexpr uint32_t RASR_RESET_VALUE = 0x0;
    static constexpr uint32_t RASR_ENABLE = 0x1;    // Region enable bit.
    template<uint32_t X>
    static constexpr uint32_t RASR_SIZE =           // Size of the MPU protection region
        bit_field_t<1, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t RASR_SRD =            // Subregion disable bits
        bit_field_t<8, 0xff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t RASR_TEX =            // memory attribute
        bit_field_t<19, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t RASR_AP =             // Access permission
