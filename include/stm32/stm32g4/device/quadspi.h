...
struct stm32g473xx_quadspi_t
{
    ...
    static constexpr uint32_t CR_FSEL = 0x80; // FSEL
    static constexpr uint32_t CR_DFM = 0x40; // DFM
...
template<> struct quadspi_traits<1>
{
    ...
    static constexpr signal_t BK1_IO0 = QUADSPI1_BK1_IO0;
    static constexpr signal_t BK1_IO1 = QUADSPI1_BK1_IO1;
    static constexpr signal_t BK1_IO2 = QUADSPI1_BK1_IO2;
    static constexpr signal_t BK1_IO3 = QUADSPI1_BK1_IO3;
    static constexpr signal_t BK1_NCS = QUADSPI1_BK1_NCS;
    static constexpr signal_t BK2_IO0 = QUADSPI1_BK2_IO0;
    static constexpr signal_t BK2_IO1 = QUADSPI1_BK2_IO1;
    static constexpr signal_t BK2_IO2 = QUADSPI1_BK2_IO2;
    ...
    static void enable()
    {
        RCC::V.AHB3ENR |= RCC::T::AHB3ENR_QUADSPI1EN;
    }
    ...
    {
        RCC::V.AHB3SMENR |= RCC::T::AHB3SMENR_QUADSPI1SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.AHB3RSTR |= RCC::T::AHB3RSTR_QUADSPI1RST;
    }
};
