...
struct stm32g431xx_rcc_t
{
    ...
    volatile uint32_t CCIPR1; // CCIPR
    ...
    typedef bit_field_t<16, 0xff> ICSCR_HSICAL0; // Internal High Speed clock Calibration
    typedef bit_field_t<24, 0x7f> ICSCR_HSITRIM; // Internal High Speed clock trimming

    static constexpr uint32_t CFGR_RESET_VALUE = 0x5; // Reset value
    ...
    typedef bit_field_t<27, 0x1f> PLLSYSCFGR_PLLSYSPDIV; // Main PLL division factor for PLLSAI2CLK
    typedef bit_field_t<25, 0x3> PLLSYSCFGR_PLLSYSR; // Main PLL division factor for PLLCLK (system clock)
    static constexpr uint32_t PLLSYSCFGR_PLLSYSREN = 0x1000000; // Main PLL PLLCLK output enable
    typedef bit_field_t<21, 0x3> PLLSYSCFGR_PLLSYSQ; // Main PLL division factor for PLLUSB1CLK(48 MHz clock)
    ...
    typedef bit_field_t<8, 0x7f> PLLSYSCFGR_PLLSYSN; // Main PLL multiplication factor for VCO
    typedef bit_field_t<4, 0xf> PLLSYSCFGR_PLLSYSM; // Division factor for the main PLL and audio PLL (PLLSAI1 and PLLSAI2) input clock
    typedef bit_field_t<0, 0x3> PLLSYSCFGR_PLLSRC; // Main PLL, PLLSAI1 and PLLSAI2 entry clock source
    ...
    static constexpr uint32_t AHB1RSTR_FLASHRST = 0x100; // FLITF reset
    ...
    static constexpr uint32_t AHB2RSTR_ADC12_COMMONRST = 0x2000; // ADC reset
    static constexpr uint32_t AHB2RSTR_ADC345_COMMONRST = 0x4000; // SAR ADC345 interface reset
    static constexpr uint32_t AHB2RSTR_DAC1RST = 0x10000; // DAC1 interface reset
    ...
    static constexpr uint32_t AHB2RSTR_AESRST = 0x1000000; // Cryptography module reset
    ...
    static constexpr uint32_t APB1RSTR1_USBRST = 0x800000; // USBD reset
    ...
    static constexpr uint32_t APB1RSTR2_UCPD1RST = 0x100; // USBPD reset
    ...
    static constexpr uint32_t APB2RSTR_HRTIM_MASTERRST = 0x4000000; // HRTIMER reset
    ...
    static constexpr uint32_t AHB1ENR_FLASHEN = 0x100; // FLITF clock enable
    ...
    static constexpr uint32_t APB1ENR1_USBEN = 0x800000; // USBDclock enable
    ...
    static constexpr uint32_t APB1ENR2_UCPD1EN = 0x100; // USBPD clock enable
    ...
    static constexpr uint32_t APB2ENR_HRTIM_MASTEREN = 0x4000000; // HRTIMER clock enable


    static constexpr uint32_t AHB1SMENR_RESET_VALUE = 0x130f; // Reset value
    ...
    static constexpr uint32_t AHB2SMENR_RESET_VALUE = 0x50f667f; // Reset value
    ...
    static constexpr uint32_t AHB2SMENR_ADC12_COMMONSMEN = 0x2000; // ADC clocks enable during Sleep and Stop modes
    static constexpr uint32_t AHB2SMENR_ADC345_COMMONSMEN = 0x4000; // DCMI clock enable during Sleep and Stop modes
    ...
    static constexpr uint32_t AHB2SMENR_AESSMEN = 0x1000000; // Cryptography clock enable during sleep mode
    ...
    static constexpr uint32_t APB1SMENR1_RESET_VALUE = 0xd2fecd3f; // Reset value
    ...
    static constexpr uint32_t APB1SMENR2_RESET_VALUE = 0x103; // Reset value
    ...
    static constexpr uint32_t APB1SMENR2_UCPD1SMEN = 0x100; // USB PD clock enable during sleep mode

    static constexpr uint32_t APB2SMENR_RESET_VALUE = 0x437f801; // Reset value
    ...
    static constexpr uint32_t APB2SMENR_HRTIM_MASTERSMEN = 0x4000000; // HRTIMER clock enable during sleep mode


    static constexpr uint32_t CCIPR1_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<30, 0x3> CCIPR1_ADC345SEL; // ADC3/4/5 clock source selection
    typedef bit_field_t<28, 0x3> CCIPR1_ADCSEL; // ADCs clock source selection
    typedef bit_field_t<26, 0x3> CCIPR1_CLK48SEL; // 48 MHz clock source selection
    typedef bit_field_t<24, 0x3> CCIPR1_FDCANSEL; // SAI2 clock source selection
    typedef bit_field_t<22, 0x3> CCIPR1_SPISEL_; // SAI1 clock source selection
    typedef bit_field_t<20, 0x3> CCIPR1_SAISEL; // Low power timer 2 clock source selection
    ...
    typedef bit_field_t<7, 0x1ff> CRRCR_RC48CAL; // HSI48 clock calibration
    ...
    typedef bit_field_t<20, 0x3> CCIPR2_QUADSPISEL; // Octospi clock source selection
};
...
template<>
struct peripheral_t<STM32G491xx, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32g431xx_rcc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G4A1xx, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32g431xx_rcc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32g431xx_rcc_t;
    static T& V;
