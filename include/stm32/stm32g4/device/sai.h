...
struct stm32g431xx_sai_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM1L =   // DLYM1L
        bit_field_t<0, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM1R =   // DLYM1R
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM2L =   // DLYM2L
        bit_field_t<8, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM2R =   // DLYM2R
