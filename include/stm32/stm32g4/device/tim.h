...
struct stm32g431xx_tim1_t
{
    ...
    volatile uint32_t ECR; // DMA control register
    ...
    volatile uint32_t DCR; // control register
    ...
    typedef bit_field_t<3, 0x3> ECR_IBLK; // Index Blanking
...
struct stm32g431xx_tim15_t
{
    ...
    static constexpr uint32_t CCR2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CCR2_CCR2; // Capture/Compare 1 value
    ...
    static constexpr uint32_t DTR2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xff> DTR2_DTGF; // Dead-time generator setup
    static constexpr uint32_t DTR2_DTAE = 0x10000; // Deadtime Asymmetric Enable
    static constexpr uint32_t DTR2_DTPE = 0x20000; // Deadtime Preload Enable
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM8>
{
    static constexpr periph_t P = TIM8;
    using T = stm32g431xx_tim1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM3>
{
    static constexpr periph_t P = TIM3;
    using T = stm32g431xx_tim2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM4>
{
    static constexpr periph_t P = TIM4;
    using T = stm32g431xx_tim2_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM7>
{
    static constexpr periph_t P = TIM7;
    using T = stm32g431xx_tim6_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM15>
{
    static constexpr periph_t P = TIM15;
    using T = stm32g431xx_tim15_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM16>
{
    static constexpr periph_t P = TIM16;
    using T = stm32g431xx_tim16_t;
    static T& V;
...
template<>
struct peripheral_t<STM32GBK1CBT6, TIM17>
{
    static constexpr periph_t P = TIM17;
    using T = stm32g431xx_tim16_t;
    static T& V;
...
template<> struct tim_traits<20>
{
    ...
    static constexpr signal_t CH4N = TIM20_CH4N;
    ...
    static void enable()
    {
        RCC::V.APB2ENR |= RCC::T::APB2ENR_TIM20EN;
    }
    ...
    static void enable_sleep_mode()
    {
        RCC::V.APB2SMENR |= RCC::T::APB2SMENR_TIM20SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB2RSTR |= RCC::T::APB2RSTR_TIM20RST;
    }
};
...
template<> struct dma_request_t<TIM20, TIM_CH1>
{
    static constexpr unsigned ID = 86;
};

template<> struct dma_request_t<TIM20, TIM_CH2>
{
    static constexpr unsigned ID = 87;
};

template<> struct dma_request_t<TIM20, TIM_CH3>
{
    static constexpr unsigned ID = 88;
};

template<> struct dma_request_t<TIM20, TIM_CH4>
{
    static constexpr unsigned ID = 89;
};

template<> struct dma_request_t<TIM20, TIM_UP>
{
    static constexpr unsigned ID = 90;
};

template<> struct dma_request_t<TIM20, TIM_TRIG>
{
    static constexpr unsigned ID = 93;
};

template<> struct dma_request_t<TIM20, TIM_COM>
{
    static constexpr unsigned ID = 94;
};
