...
template<> struct tim_traits<1>
{
    ...
    static constexpr alternate_function_t CH4N = TIM1_CH4N;
...
template<> struct tim_traits<20>
{
    ...
    static constexpr alternate_function_t CH4N = TIM20_CH4N;
...
template<> struct tim_traits<8>
{
    ...
    static constexpr alternate_function_t CH4N = TIM8_CH4N;
