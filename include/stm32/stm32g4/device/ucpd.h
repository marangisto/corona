...
////
//
//      STM32G4 UCPD peripherals
//
///

// UCPD1: UCPD1

struct stm32g431xx_ucpd1_t
{
    volatile uint32_t CFG1; // UCPD configuration register 1
    volatile uint32_t CFG2; // UCPD configuration register 2
    reserved_t<0x1> _0x8;
    volatile uint32_t CR; // UCPD configuration register 2
    ...
    volatile uint32_t RXDR; // UCPD Rx Data Register
    volatile uint32_t RX_ORDEXT1; // UCPD Rx Ordered Set Extension Register 1
    volatile uint32_t RX_ORDEXT2; // UCPD Rx Ordered Set Extension Register 2
...
template<>
struct peripheral_t<STM32G431xx, UCPD1>
{
...
template<>
struct peripheral_t<STM32G441xx, UCPD1>
{
    static constexpr periph_t P = UCPD1;
    using T = stm32g431xx_ucpd1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G471xx, UCPD1>
{
    static constexpr periph_t P = UCPD1;
    using T = stm32g431xx_ucpd1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G473xx, UCPD1>
{
    static constexpr periph_t P = UCPD1;
    using T = stm32g431xx_ucpd1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G474xx, UCPD1>
{
    static constexpr periph_t P = UCPD1;
    using T = stm32g431xx_ucpd1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G483xx, UCPD1>
{
    static constexpr periph_t P = UCPD1;
    using T = stm32g431xx_ucpd1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32G484xx, UCPD1>
{
    static constexpr periph_t P = UCPD1;
    using T = stm32g431xx_ucpd1_t;
    static T& V;
