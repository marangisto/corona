...
struct stm32h742x_dac_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_TSEL1 =                 // DAC channel1 trigger selection These bits select the external event used to trigger DAC channel1. Note: Only used if bit TEN1 = 1 (DAC channel1 trigger enabled).
        bit_field_t<2, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR_WAVE1 =                 // DAC channel1 noise/triangle wave generation enable These bits are set and cleared by software. Note: Only used if bit TEN1 = 1 (DAC channel1 trigger enabled).
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR_MAMP1 =                 // DAC channel1 mask/amplitude selector These bits are written by software to select mask in wave generation mode or amplitude in triangle generation mode. = 1011: Unmask bits[11:0] of LFSR/ triangle amplitude equal to 4095
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_TSEL2 =                 // DAC channel2 trigger selection These bits select the external event used to trigger DAC channel2 Note: Only used if bit TEN2 = 1 (DAC channel2 trigger enabled).
        bit_field_t<18, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR_WAVE2 =                 // DAC channel2 noise/triangle wave generation enable These bits are set/reset by software. 1x: Triangle wave generation enabled Note: Only used if bit TEN2 = 1 (DAC channel2 trigger enabled)
        bit_field_t<22, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR_MAMP2 =                 // DAC channel2 mask/amplitude selector These bits are written by software to select mask in wave generation mode or amplitude in triangle generation mode. = 1011: Unmask bits[11:0] of LFSR/ triangle amplitude equal to 4095
    ...
    static constexpr uint32_t SWTRGR_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t DHR12R1_DACC1DHR =   // DAC channel1 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
        bit_field_t<0, 0xfff>::value<X>();

    static constexpr uint32_t DHR12L1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR12L1_DACC1DHR =   // DAC channel1 12-bit left-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
        bit_field_t<4, 0xfff>::value<X>();

    static constexpr uint32_t DHR8R1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR8R1_DACC1DHR =   // DAC channel1 8-bit right-aligned data These bits are written by software which specifies 8-bit data for DAC channel1.
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t DHR12R2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR12R2_DACC2DHR =   // DAC channel2 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel2.
        bit_field_t<0, 0xfff>::value<X>();

    static constexpr uint32_t DHR12L2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR12L2_DACC2DHR =   // DAC channel2 12-bit left-aligned data These bits are written by software which specify 12-bit data for DAC channel2.
        bit_field_t<4, 0xfff>::value<X>();

    static constexpr uint32_t DHR8R2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR8R2_DACC2DHR =   // DAC channel2 8-bit right-aligned data These bits are written by software which specifies 8-bit data for DAC channel2.
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t DHR12RD_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR12RD_DACC1DHR =   // DAC channel1 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
        bit_field_t<0, 0xfff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DHR12RD_DACC2DHR =   // DAC channel2 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel2.
        bit_field_t<16, 0xfff>::value<X>();

    static constexpr uint32_t DHR12LD_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR12LD_DACC1DHR =   // DAC channel1 12-bit left-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
        bit_field_t<4, 0xfff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DHR12LD_DACC2DHR =   // DAC channel2 12-bit left-aligned data These bits are written by software which specifies 12-bit data for DAC channel2.
        bit_field_t<20, 0xfff>::value<X>();

    static constexpr uint32_t DHR8RD_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DHR8RD_DACC1DHR =   // DAC channel1 8-bit right-aligned data These bits are written by software which specifies 8-bit data for DAC channel1.
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DHR8RD_DACC2DHR =   // DAC channel2 8-bit right-aligned data These bits are written by software which specifies 8-bit data for DAC channel2.
        bit_field_t<8, 0xff>::value<X>();

    static constexpr uint32_t DOR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DOR1_DACC1DOR =   // DAC channel1 data output These bits are read-only, they contain data output for DAC channel1.
        bit_field_t<0, 0xfff>::value<X>();

    static constexpr uint32_t DOR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DOR2_DACC2DOR =   // DAC channel2 data output These bits are read-only, they contain data output for DAC channel2.
        bit_field_t<0, 0xfff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t SHHR_THOLD1 =   // DAC Channel 1 hold Time (only valid in sample &amp; hold mode) Hold time= (THOLD[9:0]) x T LSI
        bit_field_t<0, 0x3ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SHHR_THOLD2 =   // DAC Channel 2 hold time (only valid in sample &amp; hold mode). Hold time= (THOLD[9:0]) x T LSI
        bit_field_t<16, 0x3ff>::value<X>();

    static constexpr uint32_t SHRR_RESET_VALUE = 0x10001;
    template<uint32_t X>
    static constexpr uint32_t SHRR_TREFRESH1 =   // DAC Channel 1 refresh Time (only valid in sample &amp; hold mode) Refresh time= (TREFRESH[7:0]) x T LSI
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SHRR_TREFRESH2 =   // DAC Channel 2 refresh Time (only valid in sample &amp; hold mode) Refresh time= (TREFRESH[7:0]) x T LSI
...
template<>
struct peripheral_t<STM32H742x, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32H743, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H745_CM4, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H745_CM7, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H747_CM4, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H747_CM7, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H753, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H755_CM4, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H755_CM7, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H757_CM4, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H757_CM7, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H7A3x, DAC>
{
    typedef stm32h742x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H750x, DAC>
{
    typedef stm32h750x_dac_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32H7B0x, DAC>
{
    typedef stm32h750x_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32H7B3x, DAC>
{
    typedef stm32h750x_dac_t T;
    static T& V;
};
