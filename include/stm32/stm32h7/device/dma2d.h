...
struct stm32h742x_dma2d_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_MODE =          // DMA2D mode This bit is set and cleared by software. It cannot be modified while a transfer is ongoing.
    ...
    template<uint32_t X>
    static constexpr uint32_t FGPFCCR_CM =            // Color mode These bits defines the color format of the foreground image. They can only be written when data transfers are disabled. Once the transfer has started, they are read-only. others: meaningless
    ...
    template<uint32_t X>
    static constexpr uint32_t FGPFCCR_CS =            // CLUT size These bits define the size of the CLUT used for the foreground image. Once the CLUT transfer has started, this field is read-only. The number of CLUT entries is equal to CS[7:0] + 1.
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FGPFCCR_AM =            // Alpha mode These bits select the alpha channel value to be used for the foreground image. They can only be written data the transfer are disabled. Once the transfer has started, they become read-only. other configurations are meaningless
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FGPFCCR_CSS =           // Chroma Sub-Sampling These bits define the chroma sub-sampling mode for YCbCr color mode. Once the transfer has started, these bits are read-only. others: meaningless
    ...
    template<uint32_t X>
    static constexpr uint32_t FGCOLR_BLUE =    // Blue Value These bits defines the blue value for the A4 or A8 mode of the foreground image. They can only be written when data transfers are disabled. Once the transfer has started, They are read-only.
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FGCOLR_GREEN =   // Green Value These bits defines the green value for the A4 or A8 mode of the foreground image. They can only be written when data transfers are disabled. Once the transfer has started, They are read-only.
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FGCOLR_RED =     // Red Value These bits defines the red value for the A4 or A8 mode of the foreground image. They can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<16, 0xff>::value<X>();

    static constexpr uint32_t BGPFCCR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t BGPFCCR_CM =            // Color mode These bits define the color format of the foreground image. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only. others: meaningless
        bit_field_t<0, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BGPFCCR_CS =            // CLUT size These bits define the size of the CLUT used for the BG. Once the CLUT transfer has started, this field is read-only. The number of CLUT entries is equal to CS[7:0] + 1.
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BGPFCCR_AM =            // Alpha mode These bits define which alpha channel value to be used for the background image. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only. others: meaningless
        bit_field_t<16, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BGCOLR_BLUE =    // Blue Value These bits define the blue value for the A4 or A8 mode of the background. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BGCOLR_GREEN =   // Green Value These bits define the green value for the A4 or A8 mode of the background. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BGCOLR_RED =     // Red Value These bits define the red value for the A4 or A8 mode of the background. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<16, 0xff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t OPFCCR_CM =            // Color mode These bits define the color format of the output image. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only. others: meaningless
    ...
    template<uint32_t X>
    static constexpr uint32_t OCOLR_BLUE =    // Blue Value These bits define the blue value of the output image. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OCOLR_GREEN =   // Green Value These bits define the green value of the output image. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OCOLR_RED =     // Red Value These bits define the red value of the output image. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t OCOLR_ALPHA =   // Alpha Channel Value These bits define the alpha channel of the output color. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<24, 0xff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t NLR_NL =   // Number of lines Number of lines of the area to be transferred. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only.
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t NLR_PL =   // Pixel per lines Number of pixels per lines of the area to be transferred. These bits can only be written when data transfers are disabled. Once the transfer has started, they are read-only. If any of the input image format is 4-bit per pixel, pixel per lines must be even.
    ...
    template<uint32_t X>
    static constexpr uint32_t AMTCR_DT =      // Dead Time Dead time value in the AXI clock cycle inserted between two consecutive accesses on the AXI master port. These bits represent the minimum guaranteed number of cycles between two consecutive AXI accesses.
        bit_field_t<8, 0xff>::value<X>();
};
...
struct stm32h7a3x_dma2d_t
{
    ...
    volatile uint32_t BGPFCCR; // [read-write] DMA2D background PFC control register
    volatile uint32_t BGCOLR;  // [read-write] DMA2D background color register
    volatile uint32_t DFGCMAR; // [read-write] DMA2D foreground CLUT memory address register
    volatile uint32_t BGCMAR;  // [read-write] DMA2D background CLUT memory address register
    volatile uint32_t OPFCCR;  // [read-write] DMA2D output PFC control register
    volatile uint32_t OCOLR;   // [read-write] DMA2D output color register
    volatile uint32_t OMAR;    // [read-write] DMA2D output memory address register
    ...
    static constexpr uint32_t DFGCMAR_RESET_VALUE = 0x0;
