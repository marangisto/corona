...
template<>
struct peripheral_t<STM32H723, CAN_CCU>
{
    static constexpr periph_t P = CAN_CCU;
    using T = stm32h723_can_ccu_t;
    static T& V;
};

template<>
struct peripheral_t<STM32H725, CAN_CCU>
{
    static constexpr periph_t P = CAN_CCU;
    using T = stm32h723_can_ccu_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H73x, CAN_CCU>
{
    static constexpr periph_t P = CAN_CCU;
    using T = stm32h723_can_ccu_t;
    static T& V;
...
{
    static constexpr periph_t P = FDCAN;
    using T = stm32h7b0x_fdcan_t;
    static T& V;
};

template<>
struct peripheral_t<STM32H723, FDCAN1>
{
    static constexpr periph_t P = FDCAN1;
    using T = stm32h723_fdcan1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32H723, FDCAN2>
{
...
template<>
struct peripheral_t<STM32H723, FDCAN3>
{
...
template<>
struct peripheral_t<STM32H725, FDCAN1>
{
    static constexpr periph_t P = FDCAN1;
    using T = stm32h723_fdcan1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H725, FDCAN2>
{
    static constexpr periph_t P = FDCAN2;
    using T = stm32h723_fdcan1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H725, FDCAN3>
{
    static constexpr periph_t P = FDCAN3;
    using T = stm32h723_fdcan1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H73x, FDCAN1>
{
    static constexpr periph_t P = FDCAN1;
    using T = stm32h723_fdcan1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H73x, FDCAN2>
{
    static constexpr periph_t P = FDCAN2;
    using T = stm32h723_fdcan1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H73x, FDCAN3>
{
    static constexpr periph_t P = FDCAN3;
    using T = stm32h723_fdcan1_t;
    static T& V;
