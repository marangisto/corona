...
struct stm32h742x_fmc_t
{
    ...
    static constexpr uint32_t BCR1_RESET_VALUE = 0x30db;
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR1_MTYP =              // Memory type These bits define the type of external memory attached to the corresponding memory bank:
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BCR1_MWID =              // Memory data bus width Defines the external memory device width, valid for all type of memories.
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR1_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
    ...
    static constexpr uint32_t BTR1_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t BTR1_DATLAT =    // Data latency for synchronous memory For synchronous access with read write burst mode enabled these bits define the number of memory clock cycles
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR1_ACCMOD =    // Access mode These bits specify the asynchronous access modes as shown in the timing diagrams. They are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();

    static constexpr uint32_t BCR2_RESET_VALUE = 0x30d2;
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR2_MTYP =              // Memory type These bits define the type of external memory attached to the corresponding memory bank:
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BCR2_MWID =              // Memory data bus width Defines the external memory device width, valid for all type of memories.
        bit_field_t<4, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR2_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    static constexpr uint32_t BTR2_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    ...
    static constexpr uint32_t BTR2_CLKDIV =    // Clock divide ratio (for FMC_CLK signal) These bits define the period of FMC_CLK clock output signal, expressed in number of KCK_FMC cycles: In asynchronous NOR Flash, SRAM or PSRAM accesses, this value is dont care. Note: Refer to Section20.6.5: Synchronous transactions for FMC_CLK divider ratio formula)
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR2_DATLAT =    // Data latency for synchronous memory For synchronous access with read write burst mode enabled these bits define the number of memory clock cycles
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR2_ACCMOD =    // Access mode These bits specify the asynchronous access modes as shown in the timing diagrams. They are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();

    static constexpr uint32_t BCR3_RESET_VALUE = 0x30d2;
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR3_MTYP =              // Memory type These bits define the type of external memory attached to the corresponding memory bank:
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BCR3_MWID =              // Memory data bus width Defines the external memory device width, valid for all type of memories.
        bit_field_t<4, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR3_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    static constexpr uint32_t BTR3_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    ...
    static constexpr uint32_t BTR3_CLKDIV =    // Clock divide ratio (for FMC_CLK signal) These bits define the period of FMC_CLK clock output signal, expressed in number of KCK_FMC cycles: In asynchronous NOR Flash, SRAM or PSRAM accesses, this value is dont care. Note: Refer to Section20.6.5: Synchronous transactions for FMC_CLK divider ratio formula)
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR3_DATLAT =    // Data latency for synchronous memory For synchronous access with read write burst mode enabled these bits define the number of memory clock cycles
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR3_ACCMOD =    // Access mode These bits specify the asynchronous access modes as shown in the timing diagrams. They are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();

    static constexpr uint32_t BCR4_RESET_VALUE = 0x30d2;
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR4_MTYP =              // Memory type These bits define the type of external memory attached to the corresponding memory bank:
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BCR4_MWID =              // Memory data bus width Defines the external memory device width, valid for all type of memories.
        bit_field_t<4, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BCR4_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    static constexpr uint32_t BTR4_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    ...
    static constexpr uint32_t BTR4_CLKDIV =    // Clock divide ratio (for FMC_CLK signal) These bits define the period of FMC_CLK clock output signal, expressed in number of KCK_FMC cycles: In asynchronous NOR Flash, SRAM or PSRAM accesses, this value is dont care. Note: Refer to Section20.6.5: Synchronous transactions for FMC_CLK divider ratio formula)
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR4_DATLAT =    // Data latency for synchronous memory For synchronous access with read write burst mode enabled these bits define the number of memory clock cycles
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BTR4_ACCMOD =    // Access mode These bits specify the asynchronous access modes as shown in the timing diagrams. They are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t PCR_PWID =         // Data bus width. These bits define the external memory device width.
        bit_field_t<4, 0x3>::value<X>();
    static constexpr uint32_t PCR_ECCEN = 0x40;  // ECC computation logic enable bit
    template<uint32_t X>
    static constexpr uint32_t PCR_TCLR =         // CLE to RE delay. These bits set time from CLE low to RE low in number of KCK_FMC clock cycles. The time is give by the following formula: t_clr = (TCLR + SET + 2) TKCK_FMC where TKCK_FMC is the KCK_FMC clock period Note: Set is MEMSET or ATTSET according to the addressed space.
        bit_field_t<9, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PCR_TAR =          // ALE to RE delay. These bits set time from ALE low to RE low in number of KCK_FMC clock cycles. Time is: t_ar = (TAR + SET + 2) TKCK_FMC where TKCK_FMC is the FMC clock period Note: Set is MEMSET or ATTSET according to the addressed space.
        bit_field_t<13, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PCR_ECCPS =        // ECC page size. These bits define the page size for the extended ECC:
    ...
    template<uint32_t X>
    static constexpr uint32_t PMEM_MEMSET =    // Common memory x setup time These bits define the number of KCK_FMC (+1) clock cycles to set up the address before the command assertion (NWE, NOE), for NAND Flash read or write access to common memory space:
    ...
    template<uint32_t X>
    static constexpr uint32_t PMEM_MEMHIZ =    // Common memory x data bus Hi-Z time These bits define the number of KCK_FMC clock cycles during which the data bus is kept Hi-Z after the start of a NAND Flash write access to common memory space. This is only valid for write transactions:
        bit_field_t<24, 0xff>::value<X>();

    static constexpr uint32_t PATT_RESET_VALUE = 0xfcfcfcfc;
    template<uint32_t X>
    static constexpr uint32_t PATT_ATTSET =    // Attribute memory setup time These bits define the number of KCK_FMC (+1) clock cycles to set up address before the command assertion (NWE, NOE), for NAND Flash read or write access to attribute memory space:
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PATT_ATTWAIT =   // Attribute memory wait time These bits define the minimum number of x KCK_FMC (+1) clock cycles to assert the command (NWE, NOE), for NAND Flash read or write access to attribute memory space. The duration for command assertion is extended if the wait signal (NWAIT) is active (low) at the end of the programmed value of KCK_FMC:
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PATT_ATTHOLD =   // Attribute memory hold time These bits define the number of KCK_FMC clock cycles during which the address is held (and data for write access) after the command de-assertion (NWE, NOE), for NAND Flash read or write access to attribute memory space:
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PATT_ATTHIZ =    // Attribute memory data bus Hi-Z time These bits define the number of KCK_FMC clock cycles during which the data bus is kept in Hi-Z after the start of a NAND Flash write access to attribute memory space on socket. Only valid for writ transaction:
        bit_field_t<24, 0xff>::value<X>();
    ...
    static constexpr uint32_t BWTR1_ADDHLD =    // Address-hold phase duration. These bits are written by software to define the duration of the address hold phase (refer to Figure81 to Figure93), used in asynchronous multiplexed accesses: ... Note: In synchronous NOR Flash accesses, this value is not used, the address hold phase is always 1 Flash clock period duration.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR1_DATAST =    // Data-phase duration. These bits are written by software to define the duration of the data phase (refer to Figure81 to Figure93), used in asynchronous SRAM, PSRAM and NOR Flash memory accesses:
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR1_BUSTURN =   // Bus turnaround phase duration These bits are written by software to add a delay at the end of a write transaction to match the minimum time between consecutive transactions (tEHEL from ENx high to ENx low): (BUSTRUN + 1) KCK_FMC period &#8805; tEHELmin. The programmed bus turnaround delay is inserted between a an asynchronous write transfer and any other asynchronous /synchronous read or write transfer to or from a static bank. If a read operation is performed, the bank can be the same or a different one, whereas it must be different in case of write operation to the bank, except in muxed mode or mode D. In some cases, whatever the programmed BUSTRUN values, the bus turnaround delay is fixed as follows: The bus turnaround delay is not inserted between two consecutive asynchronous write transfers to the same static memory bank except for muxed mode and mode D. There is a bus turnaround delay of 2 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to the same bank A synchronous write transfer ((in Burst or Single mode) and an asynchronous write or read transfer to or from static memory bank. There is a bus turnaround delay of 3 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to different static banks. A synchronous write transfer (in Burst or Single mode) and a synchronous read from the same or a different bank. ...
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR1_ACCMOD =    // Access mode. These bits specify the asynchronous access modes as shown in the next timing diagrams.These bits are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();
    ...
    static constexpr uint32_t BWTR2_ADDHLD =    // Address-hold phase duration. These bits are written by software to define the duration of the address hold phase (refer to Figure81 to Figure93), used in asynchronous multiplexed accesses: ... Note: In synchronous NOR Flash accesses, this value is not used, the address hold phase is always 1 Flash clock period duration.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR2_DATAST =    // Data-phase duration. These bits are written by software to define the duration of the data phase (refer to Figure81 to Figure93), used in asynchronous SRAM, PSRAM and NOR Flash memory accesses:
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR2_BUSTURN =   // Bus turnaround phase duration These bits are written by software to add a delay at the end of a write transaction to match the minimum time between consecutive transactions (tEHEL from ENx high to ENx low): (BUSTRUN + 1) KCK_FMC period &#8805; tEHELmin. The programmed bus turnaround delay is inserted between a an asynchronous write transfer and any other asynchronous /synchronous read or write transfer to or from a static bank. If a read operation is performed, the bank can be the same or a different one, whereas it must be different in case of write operation to the bank, except in muxed mode or mode D. In some cases, whatever the programmed BUSTRUN values, the bus turnaround delay is fixed as follows: The bus turnaround delay is not inserted between two consecutive asynchronous write transfers to the same static memory bank except for muxed mode and mode D. There is a bus turnaround delay of 2 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to the same bank A synchronous write transfer ((in Burst or Single mode) and an asynchronous write or read transfer to or from static memory bank. There is a bus turnaround delay of 3 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to different static banks. A synchronous write transfer (in Burst or Single mode) and a synchronous read from the same or a different bank. ...
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR2_ACCMOD =    // Access mode. These bits specify the asynchronous access modes as shown in the next timing diagrams.These bits are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();
    ...
    static constexpr uint32_t BWTR3_ADDHLD =    // Address-hold phase duration. These bits are written by software to define the duration of the address hold phase (refer to Figure81 to Figure93), used in asynchronous multiplexed accesses: ... Note: In synchronous NOR Flash accesses, this value is not used, the address hold phase is always 1 Flash clock period duration.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR3_DATAST =    // Data-phase duration. These bits are written by software to define the duration of the data phase (refer to Figure81 to Figure93), used in asynchronous SRAM, PSRAM and NOR Flash memory accesses:
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR3_BUSTURN =   // Bus turnaround phase duration These bits are written by software to add a delay at the end of a write transaction to match the minimum time between consecutive transactions (tEHEL from ENx high to ENx low): (BUSTRUN + 1) KCK_FMC period &#8805; tEHELmin. The programmed bus turnaround delay is inserted between a an asynchronous write transfer and any other asynchronous /synchronous read or write transfer to or from a static bank. If a read operation is performed, the bank can be the same or a different one, whereas it must be different in case of write operation to the bank, except in muxed mode or mode D. In some cases, whatever the programmed BUSTRUN values, the bus turnaround delay is fixed as follows: The bus turnaround delay is not inserted between two consecutive asynchronous write transfers to the same static memory bank except for muxed mode and mode D. There is a bus turnaround delay of 2 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to the same bank A synchronous write transfer ((in Burst or Single mode) and an asynchronous write or read transfer to or from static memory bank. There is a bus turnaround delay of 3 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to different static banks. A synchronous write transfer (in Burst or Single mode) and a synchronous read from the same or a different bank. ...
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR3_ACCMOD =    // Access mode. These bits specify the asynchronous access modes as shown in the next timing diagrams.These bits are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();
    ...
    static constexpr uint32_t BWTR4_ADDHLD =    // Address-hold phase duration. These bits are written by software to define the duration of the address hold phase (refer to Figure81 to Figure93), used in asynchronous multiplexed accesses: ... Note: In synchronous NOR Flash accesses, this value is not used, the address hold phase is always 1 Flash clock period duration.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR4_DATAST =    // Data-phase duration. These bits are written by software to define the duration of the data phase (refer to Figure81 to Figure93), used in asynchronous SRAM, PSRAM and NOR Flash memory accesses:
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR4_BUSTURN =   // Bus turnaround phase duration These bits are written by software to add a delay at the end of a write transaction to match the minimum time between consecutive transactions (tEHEL from ENx high to ENx low): (BUSTRUN + 1) KCK_FMC period &#8805; tEHELmin. The programmed bus turnaround delay is inserted between a an asynchronous write transfer and any other asynchronous /synchronous read or write transfer to or from a static bank. If a read operation is performed, the bank can be the same or a different one, whereas it must be different in case of write operation to the bank, except in muxed mode or mode D. In some cases, whatever the programmed BUSTRUN values, the bus turnaround delay is fixed as follows: The bus turnaround delay is not inserted between two consecutive asynchronous write transfers to the same static memory bank except for muxed mode and mode D. There is a bus turnaround delay of 2 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to the same bank A synchronous write transfer ((in Burst or Single mode) and an asynchronous write or read transfer to or from static memory bank. There is a bus turnaround delay of 3 FMC clock cycle between: Two consecutive synchronous write operations (in Burst or Single mode) to different static banks. A synchronous write transfer (in Burst or Single mode) and a synchronous read from the same or a different bank. ...
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BWTR4_ACCMOD =    // Access mode. These bits specify the asynchronous access modes as shown in the next timing diagrams.These bits are taken into account only when the EXTMOD bit in the FMC_BCRx register is 1.
        bit_field_t<28, 0x3>::value<X>();

    static constexpr uint32_t SDCR1_RESET_VALUE = 0x2d0;
    template<uint32_t X>
    static constexpr uint32_t SDCR1_NC =             // Number of column address bits These bits define the number of bits of a column address.
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDCR1_NR =             // Number of row address bits These bits define the number of bits of a row address.
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDCR1_MWID =           // Memory data bus width. These bits define the memory device width.
        bit_field_t<4, 0x3>::value<X>();
    static constexpr uint32_t SDCR1_NB = 0x40;       // Number of internal banks This bit sets the number of internal banks.
    template<uint32_t X>
    static constexpr uint32_t SDCR1_CAS =            // CAS Latency This bits sets the SDRAM CAS latency in number of memory clock cycles
    ...
    template<uint32_t X>
    static constexpr uint32_t SDCR1_SDCLK =          // SDRAM clock configuration These bits define the SDRAM clock period for both SDRAM banks and allow disabling the clock before changing the frequency. In this case the SDRAM must be re-initialized. Note: The corresponding bits in the FMC_SDCR2 register is read only.
    ...
    template<uint32_t X>
    static constexpr uint32_t SDCR1_RPIPE =          // Read pipe These bits define the delay, in KCK_FMC clock cycles, for reading data after CAS latency. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<13, 0x3>::value<X>();

    static constexpr uint32_t SDCR2_RESET_VALUE = 0x2d0;
    template<uint32_t X>
    static constexpr uint32_t SDCR2_NC =             // Number of column address bits These bits define the number of bits of a column address.
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDCR2_NR =             // Number of row address bits These bits define the number of bits of a row address.
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDCR2_MWID =           // Memory data bus width. These bits define the memory device width.
        bit_field_t<4, 0x3>::value<X>();
    static constexpr uint32_t SDCR2_NB = 0x40;       // Number of internal banks This bit sets the number of internal banks.
    template<uint32_t X>
    static constexpr uint32_t SDCR2_CAS =            // CAS Latency This bits sets the SDRAM CAS latency in number of memory clock cycles
        bit_field_t<7, 0x3>::value<X>();
    static constexpr uint32_t SDCR2_WP = 0x200;      // Write protection This bit enables write mode access to the SDRAM bank.
    template<uint32_t X>
    static constexpr uint32_t SDCR2_SDCLK =          // SDRAM clock configuration These bits define the SDRAM clock period for both SDRAM banks and allow disabling the clock before changing the frequency. In this case the SDRAM must be re-initialized. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<10, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t SDCR2_RPIPE =          // Read pipe These bits define the delay, in KCK_FMC clock cycles, for reading data after CAS latency. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<13, 0x3>::value<X>();

    static constexpr uint32_t SDTR1_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    static constexpr uint32_t SDTR1_TMRD =   // Load Mode Register to Active These bits define the delay between a Load Mode Register command and an Active or Refresh command in number of memory clock cycles. ....
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR1_TXSR =   // Exit Self-refresh delay These bits define the delay from releasing the Self-refresh command to issuing the Activate command in number of memory clock cycles. .... Note: If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TXSR timing corresponding to the slowest SDRAM device.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR1_TRAS =   // Self refresh time These bits define the minimum Self-refresh period in number of memory clock cycles. ....
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR1_TRC =    // Row cycle delay These bits define the delay between the Refresh command and the Activate command, as well as the delay between two consecutive Refresh commands. It is expressed in number of memory clock cycles. The TRC timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRC must be programmed with the timings of the slowest device. .... Note: TRC must match the TRC and TRFC (Auto Refresh period) timings defined in the SDRAM device datasheet. Note: The corresponding bits in the FMC_SDTR2 register are dont care.
    ...
    static constexpr uint32_t SDTR1_TWR =    // Recovery delay These bits define the delay between a Write and a Precharge command in number of memory clock cycles. .... Note: TWR must be programmed to match the write recovery time (tWR) defined in the SDRAM datasheet, and to guarantee that: TWR &#8805; TRAS - TRCD and TWR &#8805;TRC - TRCD - TRP Example: TRAS= 4 cycles, TRCD= 2 cycles. So, TWR &gt;= 2 cycles. TWR must be programmed to 0x1. If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TWR timing corresponding to the slowest SDRAM device.
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR1_TRP =    // Row precharge delay These bits define the delay between a Precharge command and another command in number of memory clock cycles. The TRP timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRP must be programmed with the timing of the slowest device. .... Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR1_TRCD =   // Row to column delay These bits define the delay between the Activate command and a Read/Write command in number of memory clock cycles. ....
        bit_field_t<24, 0xf>::value<X>();

    static constexpr uint32_t SDTR2_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TMRD =   // Load Mode Register to Active These bits define the delay between a Load Mode Register command and an Active or Refresh command in number of memory clock cycles. ....
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TXSR =   // Exit Self-refresh delay These bits define the delay from releasing the Self-refresh command to issuing the Activate command in number of memory clock cycles. .... Note: If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TXSR timing corresponding to the slowest SDRAM device.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TRAS =   // Self refresh time These bits define the minimum Self-refresh period in number of memory clock cycles. ....
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TRC =    // Row cycle delay These bits define the delay between the Refresh command and the Activate command, as well as the delay between two consecutive Refresh commands. It is expressed in number of memory clock cycles. The TRC timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRC must be programmed with the timings of the slowest device. .... Note: TRC must match the TRC and TRFC (Auto Refresh period) timings defined in the SDRAM device datasheet. Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TWR =    // Recovery delay These bits define the delay between a Write and a Precharge command in number of memory clock cycles. .... Note: TWR must be programmed to match the write recovery time (tWR) defined in the SDRAM datasheet, and to guarantee that: TWR &#8805; TRAS - TRCD and TWR &#8805;TRC - TRCD - TRP Example: TRAS= 4 cycles, TRCD= 2 cycles. So, TWR &gt;= 2 cycles. TWR must be programmed to 0x1. If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TWR timing corresponding to the slowest SDRAM device.
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TRP =    // Row precharge delay These bits define the delay between a Precharge command and another command in number of memory clock cycles. The TRP timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRP must be programmed with the timing of the slowest device. .... Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDTR2_TRCD =   // Row to column delay These bits define the delay between the Activate command and a Read/Write command in number of memory clock cycles. ....
        bit_field_t<24, 0xf>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t SDCMR_NRFS =       // Number of Auto-refresh These bits define the number of consecutive Auto-refresh commands issued when MODE = 011. ....
        bit_field_t<5, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDCMR_MRD =        // Mode Register definition This 14-bit field defines the SDRAM Mode Register content. The Mode Register is programmed using the Load Mode Register command. The MRD[13:0] bits are also used to program the extended mode register for mobile SDRAM.
    ...
    template<uint32_t X>
    static constexpr uint32_t SDSR_MODES1 =   // Status Mode for Bank 1 These bits define the Status Mode of SDRAM Bank 1.
        bit_field_t<1, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SDSR_MODES2 =   // Status Mode for Bank 2 These bits define the Status Mode of SDRAM Bank 2.
...
{
    volatile uint32_t FMC_BCR1;  // [read-write] This register contains the control information of each memory bank, used for SRAMs, PSRAM and NOR Flash memories.
    ...
    volatile uint32_t FMC_BCR2;  // [read-write] This register contains the control information of each memory bank, used for SRAMs, PSRAM and NOR Flash memories.
    ...
    volatile uint32_t FMC_BCR3;  // [read-write] This register contains the control information of each memory bank, used for SRAMs, PSRAM and NOR Flash memories.
    ...
    volatile uint32_t FMC_BCR4;  // [read-write] This register contains the control information of each memory bank, used for SRAMs, PSRAM and NOR Flash memories.
    ...
    reserved_t<0x8> _0x140;
    volatile uint32_t FMC_SDCR1; // [read-write] This register contains the control parameters for each SDRAM memory bank
    volatile uint32_t FMC_SDCR2; // [read-write] This register contains the control parameters for each SDRAM memory bank
    volatile uint32_t FMC_SDTR1; // [read-write] This register contains the timing parameters of each SDRAM bank
    volatile uint32_t FMC_SDTR2; // [read-write] This register contains the timing parameters of each SDRAM bank
    volatile uint32_t FMC_SDCMR; // [read-write] This register contains the command issued when the SDRAM device is accessed. This register is used to initialize the SDRAM device, and to activate the Self-refresh and the Power-down modes. As soon as the MODE field is written, the command will be issued only to one or to both SDRAM banks according to CTB1 and CTB2 command bits. This register is the same for both SDRAM banks.
    volatile uint32_t FMC_SDRTR; // This register sets the refresh rate in number of SDCLK clock cycles between the refresh cycles by configuring the Refresh Timer Count value.Examplewhere 64 ms is the SDRAM refresh period.The refresh rate must be increased by 20 SDRAM clock cycles (as in the above example) to obtain a safe margin if an internal refresh request occurs when a read request has been accepted. It corresponds to a COUNT value of 0000111000000 (448). This 13-bit field is loaded into a timer which is decremented using the SDRAM clock. This timer generates a refresh pulse when zero is reached. The COUNT value must be set at least to 41 SDRAM clock cycles.As soon as the FMC_SDRTR register is programmed, the timer starts counting. If the value programmed in the register is 0, no refresh is carried out. This register must not be reprogrammed after the initialization procedure to avoid modifying the refresh rate.Each time a refresh pulse is generated, this 13-bit COUNT field is reloaded into the counter.If a memory access is in progress, the Auto-refresh request is delayed. However, if the memory access and Auto-refresh requests are generated simultaneously, the Auto-refresh takes precedence. If the memory access occurs during a refresh operation, the request is buffered to be processed when the refresh is complete.This register is common to SDRAM bank 1 and bank 2.
    volatile uint32_t FMC_SDSR;  // [read-only] SDRAM Status register
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_BCR1_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_BCR2_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_BCR3_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_BCR4_BMAP =              // FMC bank mapping These bits allows different to remap SDRAM bank2 or swap the FMC NOR/PSRAM and SDRAM banks.Refer to Table 10 for Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register.
        bit_field_t<24, 0x3>::value<X>();
    ...
    static constexpr uint32_t FMC_SDCR1_RESET_VALUE = 0x2d0;
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR1_NC =             // Number of column address bits These bits define the number of bits of a column address.
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR1_NR =             // Number of row address bits These bits define the number of bits of a row address.
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR1_MWID =           // Memory data bus width. These bits define the memory device width.
        bit_field_t<4, 0x3>::value<X>();
    static constexpr uint32_t FMC_SDCR1_NB = 0x40;       // Number of internal banks This bit sets the number of internal banks.
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR1_CAS =            // CAS Latency This bits sets the SDRAM CAS latency in number of memory clock cycles
        bit_field_t<7, 0x3>::value<X>();
    static constexpr uint32_t FMC_SDCR1_WP = 0x200;      // Write protection This bit enables write mode access to the SDRAM bank.
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR1_SDCLK =          // SDRAM clock configuration These bits define the SDRAM clock period for both SDRAM banks and allow disabling the clock before changing the frequency. In this case the SDRAM must be re-initialized. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<10, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR1_RPIPE =          // Read pipe These bits define the delay, in KCK_FMC clock cycles, for reading data after CAS latency. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<13, 0x3>::value<X>();

    static constexpr uint32_t FMC_SDCR2_RESET_VALUE = 0x2d0;
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR2_NC =             // Number of column address bits These bits define the number of bits of a column address.
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR2_NR =             // Number of row address bits These bits define the number of bits of a row address.
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR2_MWID =           // Memory data bus width. These bits define the memory device width.
        bit_field_t<4, 0x3>::value<X>();
    static constexpr uint32_t FMC_SDCR2_NB = 0x40;       // Number of internal banks This bit sets the number of internal banks.
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR2_CAS =            // CAS Latency This bits sets the SDRAM CAS latency in number of memory clock cycles
        bit_field_t<7, 0x3>::value<X>();
    static constexpr uint32_t FMC_SDCR2_WP = 0x200;      // Write protection This bit enables write mode access to the SDRAM bank.
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR2_SDCLK =          // SDRAM clock configuration These bits define the SDRAM clock period for both SDRAM banks and allow disabling the clock before changing the frequency. In this case the SDRAM must be re-initialized. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<10, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCR2_RPIPE =          // Read pipe These bits define the delay, in KCK_FMC clock cycles, for reading data after CAS latency. Note: The corresponding bits in the FMC_SDCR2 register is read only.
        bit_field_t<13, 0x3>::value<X>();

    static constexpr uint32_t FMC_SDTR1_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TMRD =   // Load Mode Register to Active These bits define the delay between a Load Mode Register command and an Active or Refresh command in number of memory clock cycles. ....
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TXSR =   // Exit Self-refresh delay These bits define the delay from releasing the Self-refresh command to issuing the Activate command in number of memory clock cycles. .... Note: If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TXSR timing corresponding to the slowest SDRAM device.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TRAS =   // Self refresh time These bits define the minimum Self-refresh period in number of memory clock cycles. ....
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TRC =    // Row cycle delay These bits define the delay between the Refresh command and the Activate command, as well as the delay between two consecutive Refresh commands. It is expressed in number of memory clock cycles. The TRC timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRC must be programmed with the timings of the slowest device. .... Note: TRC must match the TRC and TRFC (Auto Refresh period) timings defined in the SDRAM device datasheet. Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TWR =    // Recovery delay These bits define the delay between a Write and a Precharge command in number of memory clock cycles. .... Note: TWR must be programmed to match the write recovery time (tWR) defined in the SDRAM datasheet, and to guarantee that: TWR &#8805; TRAS - TRCD and TWR &#8805;TRC - TRCD - TRP Example: TRAS= 4 cycles, TRCD= 2 cycles. So, TWR &gt;= 2 cycles. TWR must be programmed to 0x1. If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TWR timing corresponding to the slowest SDRAM device.
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TRP =    // Row precharge delay These bits define the delay between a Precharge command and another command in number of memory clock cycles. The TRP timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRP must be programmed with the timing of the slowest device. .... Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR1_TRCD =   // Row to column delay These bits define the delay between the Activate command and a Read/Write command in number of memory clock cycles. ....
        bit_field_t<24, 0xf>::value<X>();

    static constexpr uint32_t FMC_SDTR2_RESET_VALUE = 0xfffffff;
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TMRD =   // Load Mode Register to Active These bits define the delay between a Load Mode Register command and an Active or Refresh command in number of memory clock cycles. ....
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TXSR =   // Exit Self-refresh delay These bits define the delay from releasing the Self-refresh command to issuing the Activate command in number of memory clock cycles. .... Note: If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TXSR timing corresponding to the slowest SDRAM device.
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TRAS =   // Self refresh time These bits define the minimum Self-refresh period in number of memory clock cycles. ....
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TRC =    // Row cycle delay These bits define the delay between the Refresh command and the Activate command, as well as the delay between two consecutive Refresh commands. It is expressed in number of memory clock cycles. The TRC timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRC must be programmed with the timings of the slowest device. .... Note: TRC must match the TRC and TRFC (Auto Refresh period) timings defined in the SDRAM device datasheet. Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TWR =    // Recovery delay These bits define the delay between a Write and a Precharge command in number of memory clock cycles. .... Note: TWR must be programmed to match the write recovery time (tWR) defined in the SDRAM datasheet, and to guarantee that: TWR &#8805; TRAS - TRCD and TWR &#8805;TRC - TRCD - TRP Example: TRAS= 4 cycles, TRCD= 2 cycles. So, TWR &gt;= 2 cycles. TWR must be programmed to 0x1. If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TWR timing corresponding to the slowest SDRAM device.
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TRP =    // Row precharge delay These bits define the delay between a Precharge command and another command in number of memory clock cycles. The TRP timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRP must be programmed with the timing of the slowest device. .... Note: The corresponding bits in the FMC_SDTR2 register are dont care.
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDTR2_TRCD =   // Row to column delay These bits define the delay between the Activate command and a Read/Write command in number of memory clock cycles. ....
        bit_field_t<24, 0xf>::value<X>();

    static constexpr uint32_t FMC_SDCMR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCMR_MODE =       // Command mode These bits define the command issued to the SDRAM device. Note: When a command is issued, at least one Command Target Bank bit ( CTB1 or CTB2) must be set otherwise the command will be ignored. Note: If two SDRAM banks are used, the Auto-refresh and PALL command must be issued simultaneously to the two devices with CTB1 and CTB2 bits set otherwise the command will be ignored. Note: If only one SDRAM bank is used and a command is issued with its associated CTB bit set, the other CTB bit of the unused bank must be kept to 0.
        bit_field_t<0, 0x7>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCMR_NRFS =       // Number of Auto-refresh These bits define the number of consecutive Auto-refresh commands issued when MODE = 011. ....
        bit_field_t<5, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDCMR_MRD =        // Mode Register definition This 14-bit field defines the SDRAM Mode Register content. The Mode Register is programmed using the Load Mode Register command. The MRD[13:0] bits are also used to program the extended mode register for mobile SDRAM.
        bit_field_t<9, 0x3fff>::value<X>();

    static constexpr uint32_t FMC_SDRTR_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t FMC_SDRTR_COUNT =        // Refresh Timer Count This 13-bit field defines the refresh rate of the SDRAM device. It is expressed in number of memory clock cycles. It must be set at least to 41 SDRAM clock cycles (0x29). Refresh rate = (COUNT + 1) x SDRAM frequency clock COUNT = (SDRAM refresh period / Number of rows) - 20
        bit_field_t<1, 0x1fff>::value<X>();
    static constexpr uint32_t FMC_SDRTR_REIE = 0x4000; // RES Interrupt Enable

    static constexpr uint32_t FMC_SDSR_RESET_VALUE = 0x0;
    static constexpr uint32_t FMC_SDSR_RE = 0x1;  // Refresh error flag An interrupt is generated if REIE = 1 and RE = 1
    template<uint32_t X>
    static constexpr uint32_t FMC_SDSR_MODES1 =   // Status Mode for Bank 1 These bits define the Status Mode of SDRAM Bank 1.
        bit_field_t<1, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t FMC_SDSR_MODES2 =   // Status Mode for Bank 2 These bits define the Status Mode of SDRAM Bank 2.
        bit_field_t<3, 0x3>::value<X>();
};
