...
struct stm32h742x_hrtim_common_t
{
    ...
    static constexpr uint32_t DISR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t BMCMPR6_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t BMCMPR6_BMCMP =   // BMCMP
    ...
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE10SNS =            // EE10SNS
        bit_field_t<27, 0x3>::value<X>();
    static constexpr uint32_t EECR3_EE10POL = 0x4000000; // EE10POL
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE10SRC =            // EE10SRC
        bit_field_t<24, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE9SNS =             // EE9SNS
        bit_field_t<21, 0x3>::value<X>();
    static constexpr uint32_t EECR3_EE9POL = 0x100000;   // EE9POL
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE9SRC =             // EE9SRC
        bit_field_t<18, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE8SNS =             // EE8SNS
        bit_field_t<15, 0x3>::value<X>();
    static constexpr uint32_t EECR3_EE8POL = 0x4000;     // EE8POL
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE8SRC =             // EE8SRC
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE7SNS =             // EE7SNS
        bit_field_t<9, 0x3>::value<X>();
    static constexpr uint32_t EECR3_EE7POL = 0x100;      // EE7POL
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE7SRC =             // EE7SRC
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE6SNS =             // EE6SNS
        bit_field_t<3, 0x3>::value<X>();
    static constexpr uint32_t EECR3_EE6POL = 0x4;        // EE6POL
    template<uint32_t X>
    static constexpr uint32_t EECR3_EE6SRC =             // EE6SRC
        bit_field_t<0, 0x3>::value<X>();
    ...
    static constexpr uint32_t BDTxUPR_RESET_VALUE = 0x0;
...
{
    typedef stm32h742x_hrtim_tima_t T;
    static T& V;
};
...
{
    typedef stm32h742x_hrtim_timb_t T;
    static T& V;
};
...
{
    typedef stm32h742x_hrtim_timc_t T;
    static T& V;
};
...
{
    typedef stm32h742x_hrtim_timd_t T;
    static T& V;
};
...
{
    typedef stm32h742x_hrtim_time_t T;
    static T& V;
};
