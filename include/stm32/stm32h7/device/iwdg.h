...
template<>
struct peripheral_t<STM32H723, IWDG1>
{
    static constexpr periph_t P = IWDG1;
    using T = stm32h723_iwdg1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32H725, IWDG1>
{
    static constexpr periph_t P = IWDG1;
    using T = stm32h723_iwdg1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32H73x, IWDG1>
{
    static constexpr periph_t P = IWDG1;
    using T = stm32h723_iwdg1_t;
    static T& V;
