...
struct stm32h750x_lptim1_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t LPTIM_CFGR2_IN1SEL =   // LPTIM Input 1 selection
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM_CFGR2_IN2SEL =   // LPTIM Input 2 selection
        bit_field_t<4, 0x3>::value<X>();
};
