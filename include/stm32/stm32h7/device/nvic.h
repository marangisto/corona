...
struct stm32h742x_nvic_t
{
    ...
    static constexpr uint32_t IPR39_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t IPR39_IPR_N0 =   // IPR_N0
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t IPR39_IPR_N1 =   // IPR_N1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t IPR39_IPR_N2 =   // IPR_N2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t IPR39_IPR_N3 =   // IPR_N3
        bit_field_t<24, 0xff>::value<X>();
};
...
struct stm32h7a3x_nvic_t
{
    ...
    volatile uint32_t IABR4; // [read-only] Interrupt Active Bit Register
    volatile uint32_t IPR40; // [read-write] Interrupt Priority Register
    ...
    static constexpr uint32_t ISER4_RESET_VALUE = 0x0;

    static constexpr uint32_t ICER3_RESET_VALUE = 0x0;

    static constexpr uint32_t ICER4_RESET_VALUE = 0x0;

    static constexpr uint32_t ISPR3_RESET_VALUE = 0x0;

    static constexpr uint32_t ISPR4_RESET_VALUE = 0x0;

    static constexpr uint32_t IABR3_RESET_VALUE = 0x0;

    static constexpr uint32_t IABR4_RESET_VALUE = 0x0;

    static constexpr uint32_t IPR40_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t IPR40_IPR_N0 =   // IPR_N0
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t IPR40_IPR_N1 =   // IPR_N1
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t IPR40_IPR_N2 =   // IPR_N2
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t IPR40_IPR_N3 =   // IPR_N3
        bit_field_t<24, 0xff>::value<X>();
};
...
{
    typedef stm32h742x_nvic_stir_t T;
    static T& V;
};
...
{
    typedef stm32h745_cm4_nvic_t T;
    static T& V;
};
