...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PA15 (JTDI), DSIHOST_TE>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF13;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PA15 (JTDI), HRTIM_FLT1>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF2;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB3 (JTDO/TRACESWO), HRTIM_FLT4>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF2;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB3 (JTDO/TRACESWO), I2S1_CK>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF5;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB3 (JTDO/TRACESWO), I2S3_CK>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF6;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB3 (JTDO/TRACESWO), SDMMC2_D2>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF9;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB3 (JTDO/TRACESWO), SPI6_SCK>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF8;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB3 (JTDO/TRACESWO), UART7_RX>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF11;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB4 (NJTRST), HRTIM_EEV6>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF3;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PB4 (NJTRST), SYS_JTRST>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF0;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, DFSDM1_CKIN1>
{
    static constexpr altfun_t AF = AF3;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, DFSDM1_CKOUT>
{
    static constexpr altfun_t AF = AF6;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, ETH_TXD2>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF11;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, EVENTOUT>
{
    static constexpr altfun
        < CFG & STM32H7A2
        > AF = AF15;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, FMC_SDNE0>
{
    static constexpr altfun_t AF = AF12;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, I2S2_SDI>
{
    static constexpr altfun_t AF = AF5;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, OCTOSPIM_P1_IO2>
{
    static constexpr altfun
        < CFG & STM32H7A2
        > AF = AF9;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, OCTOSPIM_P1_IO5>
{
    static constexpr altfun
        < CFG & STM32H7A2
        > AF = AF11;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, SPI2_MISO>
{
    static constexpr altfun_t AF = AF5;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC2_C, USB_OTG_HS_ULPI_DIR>
{
    static constexpr altfun_t AF = AF10;
};
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, DFSDM1_DATIN1>
{
    static constexpr altfun_t AF = AF3;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, ETH_TX_CLK>
{
    static constexpr altfun
        < CFG & STM32H747
        > AF = AF11;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, EVENTOUT>
{
    static constexpr altfun
        < CFG & STM32H7A2
        > AF = AF15;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, FMC_SDCKE0>
{
    static constexpr altfun_t AF = AF12;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, I2S2_SDO>
{
    static constexpr altfun_t AF = AF5;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, OCTOSPIM_P1_IO0>
{
    static constexpr altfun
        < CFG & STM32H7A2
        > AF = AF9;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, OCTOSPIM_P1_IO6>
{
    static constexpr altfun
        < CFG & STM32H7A2
        > AF = AF11;
...
template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, SPI2_MOSI>
{
    static constexpr altfun_t AF = AF5;
};

template<gpio_conf_t CFG>
struct signal_traits<CFG, PC3_C, USB_OTG_HS_ULPI_NXT>
{
    static constexpr altfun_t AF = AF10;
};
