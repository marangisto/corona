...
struct stm32h742x_rcc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_HSIDIV =              // HSI clock divider
    ...
    template<uint32_t X>
    static constexpr uint32_t ICSCR_CSICAL =    // CSI clock calibration
        bit_field_t<18, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICSCR_CSITRIM =   // CSI clock trimming
        bit_field_t<26, 0x1f>::value<X>();

    static constexpr uint32_t CRRCR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CRRCR_RC48CAL =   // Internal RC 48 MHz clock calibration
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_RTCPRE =            // HSE division factor for RTC clock
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCO1PRE =           // MCO1 prescaler
        bit_field_t<18, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCO1SEL =           // Micro-controller clock output 1
        bit_field_t<22, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCO2PRE =           // MCO2 prescaler
        bit_field_t<25, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCO2SEL =           // Micro-controller clock output 2
        bit_field_t<29, 0x7>::value<X>();

    static constexpr uint32_t D1CFGR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D1CFGR_HPRE =     // D1 domain AHB prescaler
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D1CFGR_D1PPRE =   // D1 domain APB3 prescaler
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D1CFGR_D1CPRE =   // D1 domain Core prescaler
        bit_field_t<8, 0xf>::value<X>();

    static constexpr uint32_t D2CFGR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D2CFGR_D2PPRE1 =   // D2 domain APB1 prescaler
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CFGR_D2PPRE2 =   // D2 domain APB2 prescaler
        bit_field_t<8, 0x7>::value<X>();

    static constexpr uint32_t D3CFGR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D3CFGR_D3PPRE =   // D3 domain APB4 prescaler
        bit_field_t<4, 0x7>::value<X>();

    static constexpr uint32_t PLLCKSELR_RESET_VALUE = 0x2020200;
    template<uint32_t X>
    static constexpr uint32_t PLLCKSELR_PLLSRC =   // DIVMx and PLLs clock source selection
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCKSELR_DIVM1 =    // Prescaler for PLL1
        bit_field_t<4, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCKSELR_DIVM2 =    // Prescaler for PLL2
        bit_field_t<12, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCKSELR_DIVM3 =    // Prescaler for PLL3
        bit_field_t<20, 0x3f>::value<X>();

    static constexpr uint32_t PLLCFGR_RESET_VALUE = 0x1ff0000;
    ...
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLL1RGE =            // PLL1 input frequency range
    ...
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLL2RGE =            // PLL2 input frequency range
    ...
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLL3RGE =            // PLL3 input frequency range
    ...
    static constexpr uint32_t PLL1DIVR_RESET_VALUE = 0x1010280;
    template<uint32_t X>
    static constexpr uint32_t PLL1DIVR_DIVN1 =   // Multiplication factor for PLL1 VCO
        bit_field_t<0, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL1DIVR_DIVP1 =   // PLL1 DIVP division factor
        bit_field_t<9, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL1DIVR_DIVQ1 =   // PLL1 DIVQ division factor
        bit_field_t<16, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL1DIVR_DIVR1 =   // PLL1 DIVR division factor
        bit_field_t<24, 0x7f>::value<X>();

    static constexpr uint32_t PLL1FRACR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t PLL1FRACR_FRACN1 =   // Fractional part of the multiplication factor for PLL1 VCO
        bit_field_t<3, 0x1fff>::value<X>();

    static constexpr uint32_t PLL2DIVR_RESET_VALUE = 0x1010280;
    template<uint32_t X>
    static constexpr uint32_t PLL2DIVR_DIVN1 =   // Multiplication factor for PLL1 VCO
        bit_field_t<0, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL2DIVR_DIVP1 =   // PLL1 DIVP division factor
        bit_field_t<9, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL2DIVR_DIVQ1 =   // PLL1 DIVQ division factor
        bit_field_t<16, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL2DIVR_DIVR1 =   // PLL1 DIVR division factor
        bit_field_t<24, 0x7f>::value<X>();

    static constexpr uint32_t PLL2FRACR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t PLL2FRACR_FRACN2 =   // Fractional part of the multiplication factor for PLL VCO
        bit_field_t<3, 0x1fff>::value<X>();

    static constexpr uint32_t PLL3DIVR_RESET_VALUE = 0x1010280;
    template<uint32_t X>
    static constexpr uint32_t PLL3DIVR_DIVN3 =   // Multiplication factor for PLL1 VCO
        bit_field_t<0, 0x1ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL3DIVR_DIVP3 =   // PLL DIVP division factor
        bit_field_t<9, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL3DIVR_DIVQ3 =   // PLL DIVQ division factor
        bit_field_t<16, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLL3DIVR_DIVR3 =   // PLL DIVR division factor
        bit_field_t<24, 0x7f>::value<X>();

    static constexpr uint32_t PLL3FRACR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t PLL3FRACR_FRACN3 =   // Fractional part of the multiplication factor for PLL3 VCO
        bit_field_t<3, 0x1fff>::value<X>();

    static constexpr uint32_t D1CCIPR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D1CCIPR_FMCSRC =            // FMC kernel clock source selection
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D1CCIPR_QSPISRC =           // QUADSPI kernel clock source selection
        bit_field_t<4, 0x3>::value<X>();
    static constexpr uint32_t D1CCIPR_SDMMCSRC = 0x10000; // SDMMC kernel clock source selection
    template<uint32_t X>
    static constexpr uint32_t D1CCIPR_CKPERSRC =          // per_ck clock source selection
        bit_field_t<28, 0x3>::value<X>();

    static constexpr uint32_t D2CCIP1R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D2CCIP1R_SAI1SRC =              // SAI1 and DFSDM1 kernel Aclk clock source selection
        bit_field_t<0, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP1R_SAI23SRC =             // SAI2 and SAI3 kernel clock source selection
        bit_field_t<6, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP1R_SPI123SRC =            // SPI/I2S1,2 and 3 kernel clock source selection
        bit_field_t<12, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP1R_SPI45SRC =             // SPI4 and 5 kernel clock source selection
        bit_field_t<16, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP1R_SPDIFSRC =             // SPDIFRX kernel clock source selection
        bit_field_t<20, 0x3>::value<X>();
    static constexpr uint32_t D2CCIP1R_DFSDM1SRC = 0x1000000; // DFSDM1 kernel Clk clock source selection
    template<uint32_t X>
    static constexpr uint32_t D2CCIP1R_FDCANSRC =             // FDCAN kernel clock source selection
        bit_field_t<28, 0x3>::value<X>();
    static constexpr uint32_t D2CCIP1R_SWPSRC = 0x80000000;   // SWPMI kernel clock source selection

    static constexpr uint32_t D2CCIP2R_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_USART234578SRC =   // USART2/3, UART4,5, 7/8 (APB1) kernel clock source selection
        bit_field_t<0, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_USART16SRC =       // USART1 and 6 kernel clock source selection
        bit_field_t<3, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_RNGSRC =           // RNG kernel clock source selection
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_I2C123SRC =        // I2C1,2,3 kernel clock source selection
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_USBSRC =           // USBOTG 1 and 2 kernel clock source selection
        bit_field_t<20, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_CECSRC =           // HDMI-CEC kernel clock source selection
        bit_field_t<22, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D2CCIP2R_LPTIM1SRC =        // LPTIM1 kernel clock source selection
        bit_field_t<28, 0x7>::value<X>();

    static constexpr uint32_t D3CCIPR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_LPUART1SRC =    // LPUART1 kernel clock source selection
        bit_field_t<0, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_I2C4SRC =       // I2C4 kernel clock source selection
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_LPTIM2SRC =     // LPTIM2 kernel clock source selection
        bit_field_t<10, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_LPTIM345SRC =   // LPTIM3,4,5 kernel clock source selection
        bit_field_t<13, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_ADCSRC =        // SAR ADC kernel clock source selection
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_SAI4ASRC =      // Sub-Block A of SAI4 kernel clock source selection
        bit_field_t<21, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_SAI4BSRC =      // Sub-Block B of SAI4 kernel clock source selection
        bit_field_t<24, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t D3CCIPR_SPI6SRC =       // SPI6 kernel clock source selection
        bit_field_t<28, 0x7>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BDCR_LSEDRV =          // LSE oscillator driving capability
        bit_field_t<3, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BDCR_RTCSRC =          // RTC clock source selection
        bit_field_t<8, 0x3>::value<X>();
    ...
    static constexpr uint32_t AHB4RSTR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB3RSTR_RESET_VALUE = 0x0;
    static constexpr uint32_t APB3RSTR_LTDCRST = 0x8; // LTDC block reset

    static constexpr uint32_t APB1LRSTR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1HRSTR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB4RSTR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t D3AMR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RSR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_RSR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB3ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHB1ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB1ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB2ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHB4ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB4ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB3ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB3ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1LENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB1LENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1HENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB1HENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB2ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB4ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB4ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB3LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHB3LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHB1LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB1LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB2LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHB2LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHB4LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_AHB4LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB3LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB3LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1LLPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB1LLPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB1HLPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1HLPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB2LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB2LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C1_APB4LPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB4LPENR_RESET_VALUE = 0x0;
