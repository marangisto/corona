...
struct stm32h742x_usart1_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t BRR_BRR_4_15 =   // DIV_Mantissa
        bit_field_t<4, 0xfff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BRR_BRR_0_3 =    // DIV_Fraction
...
using usart10_t = peripheral_t<mcu_svd, USART10>;
...
using usart9_t = peripheral_t<mcu_svd, USART9>;
...
template<> struct usart_traits<10>
{
    ...
    static constexpr alternate_function_t CK = USART10_CK;
    static constexpr alternate_function_t CTS = USART10_CTS;
    static constexpr alternate_function_t DE = USART10_DE;
    static constexpr alternate_function_t NSS = USART10_NSS;
    static constexpr alternate_function_t RTS = USART10_RTS;
    static constexpr alternate_function_t RX = USART10_RX;
    static constexpr alternate_function_t TX = USART10_TX;
};
...
template<> struct usart_traits<2>
{
    ...
    static constexpr alternate_function_t CTS_NSS = USART2_CTS_NSS;
...
template<> struct usart_traits<3>
{
    ...
    static constexpr alternate_function_t CTS_NSS = USART3_CTS_NSS;
...
template<> struct usart_traits<6>
{
    ...
    static constexpr alternate_function_t CTS_NSS = USART6_CTS_NSS;
