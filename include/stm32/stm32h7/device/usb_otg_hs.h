...
{
    typedef stm32h742x_otg1_hs_global_t T;
    static T& V;
};
...
{
    typedef stm32h742x_otg1_hs_host_t T;
    static T& V;
};
...
{
    typedef stm32h742x_otg1_hs_device_t T;
    static T& V;
};
...
{
    typedef stm32h742x_otg1_hs_pwrclk_t T;
    static T& V;
};
...
using otg1_hs_device_t = peripheral_t<mcu_svd, OTG1_HS_DEVICE>;
using otg1_hs_global_t = peripheral_t<mcu_svd, OTG1_HS_GLOBAL>;
using otg1_hs_host_t = peripheral_t<mcu_svd, OTG1_HS_HOST>;
using otg1_hs_pwrclk_t = peripheral_t<mcu_svd, OTG1_HS_PWRCLK>;
using otg2_hs_device_t = peripheral_t<mcu_svd, OTG2_HS_DEVICE>;
using otg2_hs_global_t = peripheral_t<mcu_svd, OTG2_HS_GLOBAL>;
