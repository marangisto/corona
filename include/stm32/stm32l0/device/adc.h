...
template<>
struct peripheral_t<STM32L052, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l052_adc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L053, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l052_adc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L062, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l052_adc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L063, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l052_adc_t;
    static T& V;
