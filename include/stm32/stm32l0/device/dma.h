...
template<>
struct peripheral_t<STM32L052, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l052_dma1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L053, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l052_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L062, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l052_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L063, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l052_dma1_t;
    static T& V;
