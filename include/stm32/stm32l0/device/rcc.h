...
template<>
struct peripheral_t<STM32L052, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32l052_rcc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L062, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32l052_rcc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L053, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32l053_rcc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L063, RCC>
{
    static constexpr periph_t P = RCC;
    using T = stm32l053_rcc_t;
    static T& V;
