...
struct stm32l0x0_rcc_t
{
    ...
    volatile uint32_t CIER;      // [read-only] Clock interrupt enable register
    volatile uint32_t CIFR;      // [read-only] Clock interrupt flag register
    volatile uint32_t CICR;      // [read-only] Clock interrupt clear register
    ...
    volatile uint32_t IOPSMEN;   // [read-write] GPIO clock enable in sleep mode register
    volatile uint32_t AHBSMENR;  // [read-write] AHB peripheral clock enable in sleep mode register
    volatile uint32_t APB2SMENR; // [read-write] APB2 peripheral clock enable in sleep mode register
    volatile uint32_t APB1SMENR; // [read-write] APB1 peripheral clock enable in sleep mode register
    volatile uint32_t CCIPR;     // [read-write] Clock configuration register
    volatile uint32_t CSR;       // Control and status register

    static constexpr uint32_t CR_RESET_VALUE = 0x300;
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_RTCPRE =            // TC/LCD prescaler
    ...
    static constexpr uint32_t ICSCR_RESET_VALUE = 0xb000;
    template<uint32_t X>
    ...
    template<uint32_t X>
    static constexpr uint32_t ICSCR_MSIRANGE =    // MSI clock ranges
        bit_field_t<13, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICSCR_HSI16TRIM =   // High speed internal clock trimming
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICSCR_HSI16CAL =    // nternal high speed clock calibration
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_MCOSEL =           // Microcontroller clock output selection
        bit_field_t<24, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CFGR_PLLDIV =           // PLL output division
    ...
    static constexpr uint32_t IOPRSTR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t IOPENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t AHBENR_RESET_VALUE = 0x100;
    ...
    static constexpr uint32_t IOPSMEN_RESET_VALUE = 0x8f;
    ...
    static constexpr uint32_t AHBSMENR_RESET_VALUE = 0x1111301;
    static constexpr uint32_t AHBSMENR_CRYPTSMEN = 0x1000000; // Crypto clock enable during sleep mode bit
    ...
    static constexpr uint32_t APB2SMENR_RESET_VALUE = 0x405225;
    ...
    static constexpr uint32_t APB1SMENR_RESET_VALUE = 0xb8e64a11;
    ...
    template<uint32_t X>
    static constexpr uint32_t CSR_RTCSEL =               // RTC and LCD clock source selection bits
    ...
    template<uint32_t X>
    static constexpr uint32_t CSR_LSEDRV =               // LSEDRV
...
struct stm32l0x2_rcc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CRRCR_HSI48CAL =         // 48 MHz HSI clock calibration
    ...
    static constexpr uint32_t CCIPR_USART1SEL0 = 0x1;      // USART1SEL0
    template<uint32_t X>
    static constexpr uint32_t CCIPR_I2C3SEL =              // I2C3 clock source selection bits
        bit_field_t<16, 0x3>::value<X>();
