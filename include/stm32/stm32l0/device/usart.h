...
template<>
struct peripheral_t<STM32L052, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L052, USART2>
{
...
template<>
struct peripheral_t<STM32L052, USART4>
{
...
template<>
struct peripheral_t<STM32L052, USART5>
{
...
template<>
struct peripheral_t<STM32L053, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L053, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L053, USART4>
{
    static constexpr periph_t P = USART4;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L053, USART5>
{
    static constexpr periph_t P = USART5;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L062, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L062, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L062, USART4>
{
    static constexpr periph_t P = USART4;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L062, USART5>
{
    static constexpr periph_t P = USART5;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L063, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L063, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L063, USART4>
{
    static constexpr periph_t P = USART4;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L063, USART5>
{
    static constexpr periph_t P = USART5;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x0, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x1, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x1, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x1, USART4>
{
    static constexpr periph_t P = USART4;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x1, USART5>
{
    static constexpr periph_t P = USART5;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x2, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x2, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x2, USART4>
{
    static constexpr periph_t P = USART4;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x2, USART5>
{
    static constexpr periph_t P = USART5;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x3, USART1>
{
    static constexpr periph_t P = USART1;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x3, USART2>
{
    static constexpr periph_t P = USART2;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x3, USART4>
{
    static constexpr periph_t P = USART4;
    using T = stm32l052_usart1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L0x3, USART5>
{
    static constexpr periph_t P = USART5;
    using T = stm32l052_usart1_t;
    static T& V;
