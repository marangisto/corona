...
template<> void handler<interrupt::AES_RNG_LPUART1>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
void (*vectors[])(void) __attribute__ ((section(".vectors"))) =
    ...
    , handler<interrupt::ADC_COMP> // 12: ADC and comparator 1 and 2
    ...
    , handler<interrupt::TIM6_DAC> // 17: TIM6 global interrupt and DAC
    ...
    , handler<interrupt::AES_RNG_LPUART1> // 29: AES global interrupt RNG global interrupt and LPUART1 global interrupt through
