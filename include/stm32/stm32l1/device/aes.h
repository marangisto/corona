...
struct stm32l100_aes_t
{
    ...
    volatile uint32_t KEYR0; // [read-write] AES Key register 0
    volatile uint32_t KEYR1; // [read-write] AES Key register 1
    volatile uint32_t KEYR2; // [read-write] AES Key register 2
    volatile uint32_t KEYR3; // [read-write] AES Key register 3
