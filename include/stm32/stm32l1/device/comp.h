...
struct stm32l100_comp_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CSR_OUTSEL =             // Comparator 2 output selection
        bit_field_t<21, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CSR_INSEL =              // Inverted input selection
