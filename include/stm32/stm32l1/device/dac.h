...
template<>
struct peripheral_t<STM32L100, DAC1>
{
    typedef stm32l100_dac1_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L151, DAC1>
{
    typedef stm32l100_dac1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L152, DAC1>
{
    typedef stm32l100_dac1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L162, DAC1>
{
    typedef stm32l100_dac1_t T;
    static T& V;
};
