...
template<>
struct peripheral_t<STM32L100, DAC>
{
    typedef stm32l100_dac_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L151, DAC>
{
    typedef stm32l100_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L152, DAC>
{
    typedef stm32l100_dac_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L162, DAC>
{
    typedef stm32l100_dac_t T;
    static T& V;
};
