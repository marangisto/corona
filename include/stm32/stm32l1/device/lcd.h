...
struct stm32l100_lcd_t
{
    ...
    volatile uint32_t RAM_COM0; // [read-write] display memory
    reserved_t<0x1> _0x1c;
    volatile uint32_t RAM_COM1; // [read-write] display memory
    reserved_t<0x1> _0x24;
    volatile uint32_t RAM_COM2; // [read-write] display memory
    reserved_t<0x1> _0x2c;
    volatile uint32_t RAM_COM3; // [read-write] display memory
    reserved_t<0x1> _0x34;
    volatile uint32_t RAM_COM4; // [read-write] display memory
    reserved_t<0x1> _0x3c;
    volatile uint32_t RAM_COM5; // [read-write] display memory
    reserved_t<0x1> _0x44;
    volatile uint32_t RAM_COM6; // [read-write] display memory
    reserved_t<0x1> _0x4c;
    volatile uint32_t RAM_COM7; // [read-write] display memory
    ...
    static constexpr uint32_t SR_ENS = 0x1;    // LCD enabled status
    ...
    static constexpr uint32_t RAM_COM0_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM3_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM4_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM5_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM6_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RAM_COM7_RESET_VALUE = 0x0;
...
template<>
struct peripheral_t<STM32L100, LCD>
{
    typedef stm32l100_lcd_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L151, LCD>
{
    typedef stm32l100_lcd_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L152, LCD>
{
    typedef stm32l100_lcd_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L162, LCD>
{
    typedef stm32l100_lcd_t T;
    static T& V;
};
