...
template<>
struct peripheral_t<STM32L100, MPU>
{
    typedef stm32l100_mpu_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L151, MPU>
{
    typedef stm32l100_mpu_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L152, MPU>
{
    typedef stm32l100_mpu_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L162, MPU>
{
    typedef stm32l100_mpu_t T;
    static T& V;
};
