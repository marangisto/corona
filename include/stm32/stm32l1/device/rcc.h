...
struct stm32l100_rcc_t
{
    ...
    volatile uint32_t AHBLPENR;  // [read-write] AHB peripheral clock enable in low power mode register
    volatile uint32_t APB2LPENR; // [read-write] APB2 peripheral clock enable in low power mode register
    ...
    template<uint32_t X>
    static constexpr uint32_t ICSCR_HSITRIM =    // High speed internal clock trimming
        bit_field_t<8, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICSCR_HSICAL =     // nternal high speed clock calibration
    ...
    static constexpr uint32_t AHBRSTR_FLITFRST = 0x8000;    // FLITF reset
    ...
    static constexpr uint32_t AHBENR_RESET_VALUE = 0x8000;
    ...
    static constexpr uint32_t AHBENR_FLITFEN = 0x8000;    // FLITF clock enable
    ...
    static constexpr uint32_t AHBLPENR_RESET_VALUE = 0x101903f;
    ...
    static constexpr uint32_t APB1LPENR_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CSR_RTCSEL =               // RTC and LCD clock source selection
