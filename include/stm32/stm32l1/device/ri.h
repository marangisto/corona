...
{
    volatile uint32_t ICR;    // [read-write] RI input capture register
    volatile uint32_t ASCR1;  // [read-write] RI analog switches control register 1
    volatile uint32_t ASCR2;  // [read-write] RI analog switches control register 2
    volatile uint32_t HYSCR1; // [read-write] RI hysteresis control register 1
    volatile uint32_t HYSCR2; // [read-write] RI hysteresis control register 2
    volatile uint32_t HYSCR3; // [read-write] RI hysteresis control register 3
    volatile uint32_t HYSCR4; // [read-write] Hysteresis control register
    ...
    template<uint32_t X>
    static constexpr uint32_t ICR_TIM =           // Timer select bits
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICR_IC4IOS =        // Input capture 4 select bits
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICR_IC3IOS =        // Input capture 3 select bits
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICR_IC2IOS =        // Input capture 2 select bits
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t ICR_IC1IOS =        // Input capture 1 select bits
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t ASCR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t ASCR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t HYSCR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t HYSCR1_PB =   // Port B hysteresis control on/off
        bit_field_t<16, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HYSCR1_PA =   // Port A hysteresis control on/off
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t HYSCR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t HYSCR2_PD =   // Port D hysteresis control on/off
        bit_field_t<16, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HYSCR2_PC =   // Port C hysteresis control on/off
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t HYSCR3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t HYSCR3_PF =   // Port F hysteresis control on/off
        bit_field_t<16, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HYSCR3_PE =   // Port E hysteresis control on/off
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t HYSCR4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t HYSCR4_PG =   // Port G hysteresis control on/off
        bit_field_t<0, 0xffff>::value<X>();
};
...
using ri_t = peripheral_t<mcu_svd, RI>;
