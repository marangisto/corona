...
struct stm32l100_rtc_t
{
    ...
    volatile uint32_t TSTR;     // [read-only] TSTR
    ...
    template<uint32_t X>
    static constexpr uint32_t CR_WCKSEL =         // WCKSEL
    ...
    static constexpr uint32_t CALIBR_RESET_VALUE = 0x0;
    static constexpr uint32_t CALIBR_DCS = 0x80; // Digital calibration sign
    template<uint32_t X>
    static constexpr uint32_t CALIBR_DC =        // Digital calibration
    ...
    template<uint32_t X>
    static constexpr uint32_t TSSSR_SS =   // RTC timestamp subsecond field
        bit_field_t<0, 0xffff>::value<X>();
