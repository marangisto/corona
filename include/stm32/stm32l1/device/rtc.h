...
////
//
//      STM32L1 RTC peripherals
//
///

// RTC: Real-time clock

struct stm32l100_rtc_t
{
    ...
    static constexpr uint32_t CR_SUB1H = 0x20000; // Subtract 1 hour
    static constexpr uint32_t CR_ADD1H = 0x10000; // Add 1 hour
    ...
    static constexpr uint32_t CR_REFCKON = 0x10; // Reference clock detection enable
    static constexpr uint32_t CR_TSEDGE = 0x8; // Time-stamp event active edge
    typedef bit_field_t<0, 0x7> CR_WCKSEL; // WCKSEL
    ...
    static constexpr uint32_t ISR_TAMP3F = 0x8000; // TAMPER3 detection flag
    static constexpr uint32_t ISR_TAMP2F = 0x4000; // TAMPER2 detection flag
    static constexpr uint32_t ISR_TAMP1F = 0x2000; // Tamper detection flag
    static constexpr uint32_t ISR_TSOVF = 0x1000; // Timestamp overflow flag
    static constexpr uint32_t ISR_TSF = 0x800; // Timestamp flag
    ...
    static constexpr uint32_t SHIFTR_ADD1S = 0x80000000; // ADD1S
    ...
    typedef bit_field_t<0, 0xffff> TSSSR_SS; // RTC timestamp subsecond field
    ...
    typedef bit_field_t<13, 0x3> TAFCR_TAMPPRCH; // Tamper precharge duration
    typedef bit_field_t<11, 0x3> TAFCR_TAMPFLT; // Tamper filter count
    ...
    static constexpr uint32_t TAFCR_TAMP3TRG = 0x40; // TAMPER1 mapping
    static constexpr uint32_t TAFCR_TAMP3E = 0x20; // TIMESTAMP mapping
    ...
    static constexpr uint32_t TAFCR_TAMP1ETRG = 0x2; // Active level for tamper 1
...
template<>
struct peripheral_t<STM32L100, RTC>
{
    using T = stm32l100_rtc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L151, RTC>
{
    using T = stm32l100_rtc_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L152, RTC>
{
    using T = stm32l100_rtc_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L162, RTC>
{
    using T = stm32l100_rtc_t;
    static T& V;
};
...
template<> struct rtc_traits<0>
{
    ...
    static constexpr signal_t TAMP1 = RTC_TAMP1;
    static constexpr signal_t TAMP2 = RTC_TAMP2;
    static constexpr signal_t TAMP3 = RTC_TAMP3;
    static constexpr signal_t TS = RTC_TS;
};
