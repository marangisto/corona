...
////
//
//      STM32L1 SDIO peripherals
//
///

// SDIO: Secure digital input/output interface

struct stm32l100_sdio_t
{
    ...
    typedef bit_field_t<0, 0x3> POWER_PWRCTRL; // Power supply control bits.
    ...
    typedef bit_field_t<0, 0xffffffff> RESP1_CARDSTATUS1; // see Table 133.

    static constexpr uint32_t RESP2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> RESP2_CARDSTATUS2; // see Table 133.

    static constexpr uint32_t RESP3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> RESP3_CARDSTATUS3; // see Table 133.

    static constexpr uint32_t RESP4_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> RESP4_CARDSTATUS4; // see Table 133.
    ...
    static constexpr uint32_t DCTRL_DTEN = 0x1; // Data transfer enabled bit
    ...
    typedef bit_field_t<0, 0xffffffff> FIFO_FIF0DATA; // FIF0Data
};
