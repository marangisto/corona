...
////
//
//      STM32L4+ CAN peripherals
//
///

// CAN1: Controller area network

struct stm32l4p5_can1_t
{
    ...
    static constexpr uint32_t FMR_FINIT = 0x1; // Filter initialization mode
    typedef bit_field_t<8, 0x3f> FMR_CANSB; // CAN start bank
    ...
    static constexpr uint32_t FFA1R_FFA14 = 0x4000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA15 = 0x8000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA16 = 0x10000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA17 = 0x20000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA18 = 0x40000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA19 = 0x80000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA20 = 0x100000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA21 = 0x200000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA22 = 0x400000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA23 = 0x800000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA24 = 0x1000000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA25 = 0x2000000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA26 = 0x4000000; // Filter FIFO assignment for filter
    static constexpr uint32_t FFA1R_FFA27 = 0x8000000; // Filter FIFO assignment for filter
...
template<>
struct peripheral_t<STM32L4P5, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L4Q5, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R5, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R7, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R9, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S5, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S7, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S9, CAN1>
{
    static constexpr periph_t P = CAN1;
    using T = stm32l4p5_can1_t;
    static T& V;
...
template<> struct can_traits<1>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_CAN1EN;
    }
    ...
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_CAN1SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_CAN1RST;
    }
};
