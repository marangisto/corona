...
////
//
//      STM32L4+ CRS peripherals
//
///

// CRS: Clock recovery system

struct stm32l4p5_crs_t
{
...
template<>
struct peripheral_t<STM32L4P5, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L4Q5, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R5, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R7, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R9, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S5, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S7, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S9, CRS>
{
    static constexpr periph_t P = CRS;
    using T = stm32l4p5_crs_t;
    static T& V;
...
template<> struct crs_traits<0>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_CRSEN;
    }
    ...
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_CRSSMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_CRSRST;
    }
};
