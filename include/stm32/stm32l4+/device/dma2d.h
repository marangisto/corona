...
////
//
//      STM32L4+ DMA2D peripherals
//
///

// DMA2D: DMA2D controller

struct stm32l4p5_dma2d_t
{
    ...
    typedef bit_field_t<0, 0x3fff> FGOR_LO; // Line offset
    ...
    typedef bit_field_t<0, 0x3fff> BGOR_LO; // Line offset
    ...
    typedef bit_field_t<24, 0xff> OCOLR_APLHA; // Alpha Channel Value
    typedef bit_field_t<16, 0xff> OCOLR_RED; // Red Value
    typedef bit_field_t<8, 0xff> OCOLR_GREEN; // Green Value
    typedef bit_field_t<0, 0xff> OCOLR_BLUE; // Blue Value
    ...
    typedef bit_field_t<0, 0x3fff> OOR_LO; // Line Offset
...
template<>
struct peripheral_t<STM32L4P5, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L4Q5, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4R5, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4R7, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4R9, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4S5, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4S7, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4S9, DMA2D>
{
    using T = stm32l4p5_dma2d_t;
    static T& V;
};
...
template<> struct dma2d_traits<0>
{
    ...
    static void enable()
    {
        RCC::V.AHB1ENR |= RCC::T::AHB1ENR_DMA2DEN;
    }
    ...
    {
        RCC::V.AHB1SMENR |= RCC::T::AHB1SMENR_DMA2DSMEN;
    }
    ...
    static void reset()
    {
        RCC::V.AHB1RSTR |= RCC::T::AHB1RSTR_DMA2DRST;
    }
};
