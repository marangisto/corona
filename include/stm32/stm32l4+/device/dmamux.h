...
{
    volatile uint32_t C0CR;  // [read-write] channel 0 configuration register
    volatile uint32_t C1CR;  // [read-write] channel 1 configuration register
    volatile uint32_t C2CR;  // [read-write] channel 2 configuration register
    volatile uint32_t C3CR;  // [read-write] channel 3 configuration register
    volatile uint32_t C4CR;  // [read-write] channel 4 configuration register
    volatile uint32_t C5CR;  // [read-write] channel 5 configuration register
    volatile uint32_t C6CR;  // [read-write] channel 6 configuration register
    volatile uint32_t C7CR;  // [read-write] channel 7 configuration register
    volatile uint32_t C8CR;  // [read-write] channel 8 configuration register
    volatile uint32_t C9CR;  // [read-write] channel 9 configuration register
    volatile uint32_t C10CR; // [read-write] channel 10 configuration register
    volatile uint32_t C11CR; // [read-write] channel 11 configuration register
    volatile uint32_t C12CR; // [read-write] channel 12 configuration register
    volatile uint32_t C13CR; // [read-write] channel 13 configuration register
    reserved_t<0x12> _0x80;
    volatile uint32_t CSR;   // [read-only] channel status register
    volatile uint32_t CFR;   // [write-only] clear flag register
    reserved_t<0x1e> _0x100;
    volatile uint32_t RG0CR; // [read-write] request generator channel 0 configuration register
    volatile uint32_t RG1CR; // [read-write] request generator channel 1 configuration register
    volatile uint32_t RG2CR; // [read-write] request generator channel 2 configuration register
    volatile uint32_t RG3CR; // [read-write] request generator channel 3 configuration register
    reserved_t<0xc> _0x140;
    volatile uint32_t RGSR;  // [read-only] request generator interrupt status register
    volatile uint32_t RGCFR; // [write-only] request generator interrupt clear flag register

    static constexpr uint32_t C0CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C0CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C0CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C0CR_SPOL =        // Synchronization polarity
    ...
    template<uint32_t X>
    static constexpr uint32_t C0CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C1CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C1CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C1CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C1CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C1CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C2CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C2CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C2CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C2CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C2CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C3CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C3CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C3CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C3CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C3CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C4CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C4CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C4CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C4CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C4CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C5CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C5CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C5CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C5CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C5CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C6CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C6CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C6CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C6CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C6CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C7CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C7CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C7CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C7CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C7CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C8CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C8CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C8CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C8CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C8CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C9CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C9CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C9CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C9CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C9CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C10CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C10CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C10CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C10CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C10CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C11CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C11CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C11CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C11CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C11CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C12CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C12CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C12CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C12CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C12CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();

    static constexpr uint32_t C13CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t C13CR_SYNC_ID =     // Synchronization identification
        bit_field_t<24, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C13CR_NBREQ =       // Number of DMA requests minus 1 to forward
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t C13CR_SPOL =        // Synchronization polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t C13CR_DMAREQ_ID =   // DMA request identification
        bit_field_t<0, 0x7f>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t RG0CR_GNBREQ =      // Number of DMA requests to be generated minus 1
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t RG0CR_GPOL =        // DMA request generator trigger polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t RG0CR_SIG_ID =      // Signal identification
        bit_field_t<0, 0x1f>::value<X>();

    static constexpr uint32_t RG1CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t RG1CR_GNBREQ =      // Number of DMA requests to be generated minus 1
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t RG1CR_GPOL =        // DMA request generator trigger polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t RG1CR_SIG_ID =      // Signal identification
        bit_field_t<0, 0x1f>::value<X>();

    static constexpr uint32_t RG2CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t RG2CR_GNBREQ =      // Number of DMA requests to be generated minus 1
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t RG2CR_GPOL =        // DMA request generator trigger polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t RG2CR_SIG_ID =      // Signal identification
        bit_field_t<0, 0x1f>::value<X>();

    static constexpr uint32_t RG3CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t RG3CR_GNBREQ =      // Number of DMA requests to be generated minus 1
        bit_field_t<19, 0x1f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t RG3CR_GPOL =        // DMA request generator trigger polarity
        bit_field_t<17, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t RG3CR_SIG_ID =      // Signal identification
        bit_field_t<0, 0x1f>::value<X>();
