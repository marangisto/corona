...
struct stm32l4r9_dsi_t
{
    ...
    volatile uint32_t DSI_DLTRC;   // [read-write] DSI Host Data Lane Timer Configuration Register
    ...
    volatile uint32_t DSI_LCVCIDR; // [read-only] DSI Host LTDC Current VCID Register
    ...
    volatile uint32_t DSI_WPCR3;   // [read-write] DSI_WPCR3
    ...
    template<uint32_t X>
    static constexpr uint32_t DSI_CCR_TXECKDIV =   // TX Escape Clock Division
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_CCR_TOCKDIV =    // Timeout Clock Division
    ...
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR0_LPRX_TOCNT =   // Low-power Reception Timeout Counter
        bit_field_t<0, 0xffff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR0_HSTX_TOCNT =   // High-Speed Transmission Timeout Counter
        bit_field_t<16, 0xffff>::value<X>();

    static constexpr uint32_t DSI_TCCR1_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR1_HSRD_TOCNT =   // High-Speed Read Timeout Counter
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t DSI_TCCR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR2_LPRD_TOCNT =   // Low-Power Read Timeout Counter
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t DSI_TCCR3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR3_HSWR_TOCNT =    // High-Speed Write Timeout Counter
        bit_field_t<0, 0xffff>::value<X>();
    static constexpr uint32_t DSI_TCCR3_PM = 0x1000000; // Presp mode

    static constexpr uint32_t DSI_TCCR4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR4_LSWR_TOCNT =   // Low-Power Write Timeout Counter
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t DSI_TCCR5_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_TCCR5_BTA_TOCNT =   // Bus-Turn-Around Timeout Counter
        bit_field_t<0, 0xffff>::value<X>();
    ...
    static constexpr uint32_t DSI_DLTRC_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_DLTRC_MRD_TIME =     // Maximum Read Time
        bit_field_t<0, 0x7fff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_DLTRC_LP2HS_TIME =   // Low-Power To High-Speed Time
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_DLTRC_HS2LP_TIME =   // High-Speed To Low-Power Time
        bit_field_t<24, 0xff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t DSI_PCONFR_NL =        // Number of Lanes
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_PCONFR_SW_TIME =   // Stop Wait Time
        bit_field_t<8, 0xff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR0_UIX4 =                  // Unit Interval multiplied by 4
        bit_field_t<0, 0x3f>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_LPSRDL =             // Low-Power transmission Slew Rate Compensation on Data Lanes
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_LPSRCL =             // Low-Power transmission Slew Rate Compensation on Clock Lane
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_HSTXDLL =            // High-Speed Transmission Delay on Data Lanes
    ...
    static constexpr uint32_t DSI_WPCR2_THSTRAIL =   // tHSTRAIL
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR2_THSPREP =    // tHS-PREPARE
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR2_TCLKZEO =    // tCLK-ZERO
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR2_TCLKPREP =   // tCLK-PREPARE
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t DSI_WPCR3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR3_TLPXC =     // tLPXC for Clock lane
        bit_field_t<24, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR3_THSEXIT =   // tHSEXIT
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR3_TLPXD =     // tLPX for Data lanes
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR3_THSZERO =   // tHS-ZERO
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t DSI_WPCR4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR4_THSZERO =   // tCLK-POST
        bit_field_t<0, 0xff>::value<X>();
...
using dsi_t = peripheral_t<mcu_svd, DSI>;
