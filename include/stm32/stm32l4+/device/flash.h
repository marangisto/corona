...
struct stm32l4r5_flash_t
{
    ...
    reserved_t<0x4> _0x34;
    volatile uint32_t PCROP2SR; // Flash PCROP2 Start address register
    volatile uint32_t PCROP2ER; // Flash PCROP2 End address register
    volatile uint32_t WRP1BR; // Flash WRP1 area B address register
    volatile uint32_t WRP2BR; // Flash Bank 2 WRP area B address register
    reserved_t<0x37> _0x54;
    volatile uint32_t CFGR; // Flash configuration register
    ...
    static constexpr uint32_t SR_OPTVERR = 0x8000; // Option validity error
    static constexpr uint32_t SR_BSY = 0x10000; // Busy
    static constexpr uint32_t SR_PEMPTY = 0x20000; // Program EMPTY
    ...
    static constexpr uint32_t ECCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0x1fffff> ECCR_ADDR_ECC; // ECC fail address
    static constexpr uint32_t ECCR_BK_ECC = 0x200000; // ECC fail bank
    static constexpr uint32_t ECCR_SYSF_ECC = 0x400000; // System Flash ECC fail
    static constexpr uint32_t ECCR_ECCIE = 0x1000000; // ECC correction interrupt enable
    ...
    static constexpr uint32_t OPTR_RESET_VALUE = 0xffeff8aa; // Reset value
    typedef bit_field_t<0, 0xff> OPTR_RDP; // Read protection level
    typedef bit_field_t<8, 0x7> OPTR_BOR_LEV; // BOR reset Level
    static constexpr uint32_t OPTR_NRST_STOP = 0x1000; // nRST_STOP
    static constexpr uint32_t OPTR_NRST_STDBY = 0x2000; // nRST_STDBY
    ...
    static constexpr uint32_t OPTR_WWDG_SW = 0x80000; // Window watchdog selection
    static constexpr uint32_t OPTR_BFB2 = 0x100000; // Dual-bank boot
    static constexpr uint32_t OPTR_DB1M = 0x200000; // Dual-bank on 1 Mbyte Flash memory devices
    ...
    static constexpr uint32_t PCROP1SR_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<0, 0x1ffff> PCROP1SR_PCROP1_STRT; // Bank 1 PCROP area start offset

    static constexpr uint32_t PCROP1ER_RESET_VALUE = 0xff00000; // Reset value
    typedef bit_field_t<0, 0x1ffff> PCROP1ER_PCROP1_END; // Bank 1 PCROP area end offset
    static constexpr uint32_t PCROP1ER_PCROP_RDP = 0x80000000; // PCROP area preserved when RDP level decreased
    ...
    static constexpr uint32_t WRP2AR_RESET_VALUE = 0xff00ff00; // Reset value
    typedef bit_field_t<16, 0xff> WRP2AR_WRP2A_END; // WRP first area A end offset
    typedef bit_field_t<0, 0xff> WRP2AR_WRP2A_STRT; // WRP first area A start offset


    static constexpr uint32_t PCROP2SR_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<0, 0x1ffff> PCROP2SR_PCROP2_STRT; // PCROP area start offset

    static constexpr uint32_t PCROP2ER_RESET_VALUE = 0xff00000; // Reset value
    typedef bit_field_t<0, 0x1ffff> PCROP2ER_PCROP2_END; // Bank 2 PCROP area end offset

    static constexpr uint32_t WRP1BR_RESET_VALUE = 0xff00ff00; // Reset value
    typedef bit_field_t<0, 0xff> WRP1BR_WRP1B_STRT; // Bank 2 WRP first area A start offset
    typedef bit_field_t<16, 0xff> WRP1BR_WRP1B_END; // Bank 2 WRP first area A end offset
    ...
    static constexpr uint32_t CFGR_LVEN = 0x1; // Low voltage enable
};
