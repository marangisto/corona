...
////
//
//      STM32L4+ I2C peripherals
//
///

// I2C1: Inter-integrated circuit

struct stm32l4p5_i2c1_t
{
...
template<>
struct peripheral_t<STM32L4P5, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L4P5, I2C2>
{
...
template<>
struct peripheral_t<STM32L4P5, I2C3>
{
...
template<>
struct peripheral_t<STM32L4P5, I2C4>
{
...
template<>
struct peripheral_t<STM32L4Q5, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4Q5, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4Q5, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4Q5, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R5, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R5, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R5, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R5, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R7, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R7, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R7, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R7, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R9, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R9, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R9, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4R9, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S5, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S5, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S5, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S5, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S7, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S7, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S7, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S7, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S9, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S9, I2C2>
{
    static constexpr periph_t P = I2C2;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S9, I2C3>
{
    static constexpr periph_t P = I2C3;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4S9, I2C4>
{
    static constexpr periph_t P = I2C4;
    using T = stm32l4p5_i2c1_t;
    static T& V;
...
template<> struct i2c_traits<1>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_I2C1EN;
    }
    ...
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_I2C1SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_I2C1RST;
    }
};
...
template<> struct i2c_traits<2>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_I2C2EN;
    }
    ...
    static void enable_sleep_mode()
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_I2C2SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_I2C2RST;
    }
};
...
template<> struct i2c_traits<3>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_I2C3EN;
    }
    ...
    static void enable_sleep_mode()
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_I2C3SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_I2C3RST;
    }
};
...
template<> struct i2c_traits<4>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR2 |= RCC::T::APB1ENR2_I2C4EN;
    }
    ...
    static void enable_sleep_mode()
    {
        RCC::V.APB1SMENR2 |= RCC::T::APB1SMENR2_I2C4SMEN;
    }
