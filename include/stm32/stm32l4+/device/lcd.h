...
{
    volatile uint32_t SSCR;     // [read-write] LTDC Synchronization Size Configuration Register
    volatile uint32_t BPCR;     // [read-write] LTDC Back Porch Configuration Register
    volatile uint32_t AWCR;     // [read-write] LTDC Active Width Configuration Register
    volatile uint32_t TWCR;     // [read-write] LTDC Total Width Configuration Register
    volatile uint32_t GCR;      // LTDC Global Control Register
    reserved_t<0x2> _0x24;
    volatile uint32_t SRCR;     // [read-write] LTDC Shadow Reload Configuration Register
    reserved_t<0x1> _0x2c;
    volatile uint32_t BCCR;     // [read-write] LTDC Background Color Configuration Register
    reserved_t<0x1> _0x34;
    volatile uint32_t IER;      // [read-write] LTDC Interrupt Enable Register
    volatile uint32_t ISR;      // [read-only] LTDC Interrupt Status Register
    volatile uint32_t ICR;      // [write-only] LTDC Interrupt Clear Register
    volatile uint32_t LIPCR;    // [read-write] LTDC Line Interrupt Position Configuration Register
    volatile uint32_t CPSR;     // [read-only] LTDC Current Position Status Register
    volatile uint32_t CDSR;     // [read-only] LTDC Current Display Status Register
    reserved_t<0xe> _0x84;
    volatile uint32_t L1CR;     // [read-write] LTDC Layer Control Register
    volatile uint32_t L1WHPCR;  // [read-write] LTDC Layer Window Horizontal Position Configuration Register
    volatile uint32_t L1WVPCR;  // [read-write] LTDC Layer Window Vertical Position Configuration Register
    volatile uint32_t L1CKCR;   // [read-write] LTDC Layer Color Keying Configuration Register
    volatile uint32_t L1PFCR;   // [read-write] LTDC Layer Pixel Format Configuration Register
    volatile uint32_t L1CACR;   // [read-write] LTDC Layer Constant Alpha Configuration Register
    volatile uint32_t L1DCCR;   // [read-write] LTDC Layer Default Color Configuration Register
    volatile uint32_t L1BFCR;   // [read-write] LTDC Layer Blending Factors Configuration Register
    reserved_t<0x2> _0xac;
    volatile uint32_t L1CFBAR;  // [read-write] LTDC Layer Color Frame Buffer Address Register
    volatile uint32_t L1CFBLR;  // [read-write] LTDC Layer Color Frame Buffer Length Register
    volatile uint32_t L1CFBLNR; // [read-write] LTDC Layer ColorFrame Buffer Line Number Register
    reserved_t<0x3> _0xc4;
    volatile uint32_t L1CLUTWR; // [write-only] LTDC Layerx CLUT Write Register
    reserved_t<0xf> _0x104;
    volatile uint32_t L2CR;     // [read-write] LTDC Layer Control Register
    volatile uint32_t L2WHPCR;  // [read-write] LTDC Layerx Window Horizontal Position Configuration Register
    volatile uint32_t L2WVPCR;  // [read-write] LTDC Layer Window Vertical Position Configuration Register
    volatile uint32_t L2CKCR;   // [read-write] LTDC Layer Color Keying Configuration Register
    volatile uint32_t L2PFCR;   // [read-write] LTDC Layer Pixel Format Configuration Register
    volatile uint32_t L2CACR;   // [read-write] LTDC Layer Constant Alpha Configuration Register
    volatile uint32_t L2DCCR;   // [read-write] LTDC Layer Default Color Configuration Register
    reserved_t<0x1> _0x124;
    volatile uint32_t L2BFCR;   // [read-write] LTDC Layer Blending Factors Configuration Register
    reserved_t<0x1> _0x12c;
    volatile uint32_t L2CFBAR;  // [read-write] LTDC Layer Color Frame Buffer Address Register
    volatile uint32_t L2CFBLR;  // [read-write] LTDC Layer Color Frame Buffer Length Register
    volatile uint32_t L2CFBLNR; // [read-write] LTDC Layer ColorFrame Buffer Line Number Register
    reserved_t<0x3> _0x144;
    volatile uint32_t L2CLUTWR; // [write-only] LTDC Layerx CLUT Write Register
    ...
    static constexpr uint32_t AWCR_AAH =   // Accumulated Active Height (in units of horizontal scan line)
        bit_field_t<0, 0x7ff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t AWCR_AAW =   // Accumulated Active Width (in units of pixel clock period)
        bit_field_t<16, 0xfff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t BCCR_BCBLUE =    // Background Color Blue value
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BCCR_BCGREEN =   // Background Color Green value
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t BCCR_BCRED =     // Background Color Red value
    ...
    static constexpr uint32_t L1BFCR_RESET_VALUE = 0x0;
    template<uint32_t X>
    ...
    static constexpr uint32_t L2BFCR_RESET_VALUE = 0x0;
    template<uint32_t X>
