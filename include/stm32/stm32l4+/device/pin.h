...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, OCTOSPIM_P1_DQS> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, SDMMC2_CMD> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, DCMI_D1> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, LTDC_G6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, PSSI_D1> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA11, LTDC_DE> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA12, LTDC_VSYNC> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA13, USB_OTG_FS_NOE> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA14, USB_OTG_FS_SOF> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, LTDC_HSYNC> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA2, OCTOSPIM_P1_NCS> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA3, OCTOSPIM_P1_CLK> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, DCMI_HSYNC> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, LTDC_CLK> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, OCTOSPIM_P1_NCS> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, PSSI_DE> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA5, LTDC_R7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA5, PSSI_D14> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA6, DCMI_PIXCLK> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA6, OCTOSPIM_P1_IO3> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA6, PSSI_PDCK> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, OCTOSPIM_P1_IO2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, LTDC_B7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA9, DCMI_D0> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA9, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA9, LTDC_G7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA9, PSSI_D0> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB0, LTDC_B6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB0, OCTOSPIM_P1_IO1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB1, LTDC_G6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB1, OCTOSPIM_P1_IO0> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB10, OCTOSPIM_P1_CLK> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB11, LTDC_VSYNC> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB11, OCTOSPIM_P1_NCS> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, OCTOSPIM_P1_NCLK> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, SAI2_FS_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, SDMMC2_CK> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, OCTOSPIM_P1_IO1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB14, OCTOSPIM_P1_IO6> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB14, SAI2_MCLK_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB14, SDMMC2_D0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB15, OCTOSPIM_P1_IO7> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB15, SDMMC2_D1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, OCTOSPIM_P1_DQS> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, OCTOSPIM_P1_IO4> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, SAI1_SCK_B> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, SDMMC2_D2> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, DCMI_D12> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, OCTOSPIM_P1_IO5> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, PSSI_D12> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, SAI1_MCLK_B> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, SDMMC2_D3> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, DCMI_D10> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, OCTOSPIM_P1_IO0> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, PSSI_D10> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, UART5_CTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, USART1_CK> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB6, DCMI_D5> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB6, LTDC_R6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB6, PSSI_D5> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB7, DCMI_VSYNC> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB7, LTDC_VSYNC> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB7, PSSI_RDY> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB7, UART4_CTS> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, DCMI_D6> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, LTDC_DE> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, PSSI_D6> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, SDMMC2_D4> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, DCMI_D7> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, PSSI_D7> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, SDMMC2_D5> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, LTDC_DE> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, SAI2_FS_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, SDMMC1_CMD> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, SDMMC2_CKIN> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC1, OCTOSPIM_P1_IO4> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, DCMI_D8> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, DCMI_VSYNC> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, PSSI_D8> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, PSSI_RDY> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, SYS_TRACED1> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, DCMI_D2> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, DCMI_D4> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, OCTOSPIM_P1_NCS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, PSSI_D2> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, PSSI_D4> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, DCMI_D9> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, LTDC_R6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, PSSI_D9> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC2, LTDC_HSYNC> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC2, OCTOSPIM_P1_IO5> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC3, OCTOSPIM_P1_IO6> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC4, OCTOSPIM_P1_IO7> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC4, OCTOSPIM_P2_NCS> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, LTDC_CLK> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, PSSI_D15> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, DCMI_D0> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, LTDC_G7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, PSSI_D0> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, SDMMC2_D6> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, DCMI_D1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, LTDC_B6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, PSSI_D1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, SDMMC2_D7> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC8, DCMI_D2> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC8, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC8, PSSI_D2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, DCMI_D3> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, I2C3_SDA> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, PSSI_D3> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, SYS_TRACED0> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, USB_OTG_FS_NOE> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, LTDC_B4> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, LTDC_B5> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, LTDC_R5> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD11, LTDC_R6> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD12, LTDC_R7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD14, LTDC_B2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, LTDC_B3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, TIM4_CH4> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, DCMI_D11> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, PSSI_D11> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, DCMI_D5> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, LTDC_CLK> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, OCTOSPIM_P2_NCS> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, PSSI_D5> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, OCTOSPIM_P1_IO4> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, SDMMC2_CKIN> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD5, OCTOSPIM_P1_IO5> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD5, USART2_TX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, DCMI_D10> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, LTDC_DE> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, OCTOSPIM_P1_IO6> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, PSSI_D10> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, SDMMC2_CK> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, OCTOSPIM_P1_IO7> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, SDMMC2_CMD> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, USART2_CK> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, DCMI_HSYNC> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, LTDC_R3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, PSSI_DE> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, USART3_TX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, DCMI_PIXCLK> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, LTDC_R4> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, PSSI_PDCK> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, DCMI_D2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, LTDC_HSYNC> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, PSSI_D2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, DCMI_D3> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, LTDC_VSYNC> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, PSSI_D3> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE10, LTDC_G3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE10, OCTOSPIM_P1_CLK> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, LTDC_G4> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, OCTOSPIM_P1_NCS> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE12, LTDC_G5> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE12, OCTOSPIM_P1_IO0> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, LTDC_G6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, OCTOSPIM_P1_IO1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, LTDC_G7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, OCTOSPIM_P1_IO2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, LTDC_R2> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, OCTOSPIM_P1_IO3> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, LTDC_R7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE3, LTDC_R6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE3, OCTOSPIM_P1_DQS> { static const alt_fun_t AF = AF3; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, DCMI_D4> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, LTDC_B7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, PSSI_D4> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, DCMI_D6> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, LTDC_G7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, PSSI_D6> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, DCMI_D7> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, LTDC_G6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, PSSI_D7> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE7, LTDC_B6> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE8, LTDC_B7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE9, LTDC_G2> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE9, OCTOSPIM_P1_NCLK> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF0, OCTOSPIM_P2_IO0> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF1, OCTOSPIM_P2_IO1> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, DCMI_D11> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, OCTOSPIM_P1_CLK> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, PSSI_D11> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, PSSI_D15> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, DCMI_D12> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, LTDC_DE> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, OCTOSPIM_P1_NCLK> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, PSSI_D12> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF12, LTDC_B0> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF12, OCTOSPIM_P2_DQS> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, LTDC_B1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, LTDC_G0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF15, LTDC_G1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF2, OCTOSPIM_P2_IO2> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF3, OCTOSPIM_P2_IO3> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF4, OCTOSPIM_P2_CLK> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF5, OCTOSPIM_P2_NCLK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF6, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF6, OCTOSPIM_P1_IO3> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF7, OCTOSPIM_P1_IO2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF8, OCTOSPIM_P1_IO0> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF9, OCTOSPIM_P1_IO1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG0, OCTOSPIM_P2_IO4> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG1, OCTOSPIM_P2_IO5> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, OCTOSPIM_P2_IO7> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, SAI2_FS_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, SDMMC2_D1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, OCTOSPIM_P1_IO5> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, SAI2_MCLK_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, SDMMC2_D2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, OCTOSPIM_P2_NCS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, SAI2_SD_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, SDMMC2_D3> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, LTDC_R0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, LTDC_R1> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, DCMI_D13> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, OCTOSPIM_P2_DQS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, PSSI_D13> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG2, SDMMC2_D4> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG3, SDMMC2_D5> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG4, SDMMC2_D6> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG5, SDMMC2_D7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG6, LTDC_R1> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG6, OCTOSPIM_P1_DQS> { static const alt_fun_t AF = AF3; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, OCTOSPIM_P2_DQS> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, OCTOSPIM_P2_IO6> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, SAI2_SCK_A> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, SDMMC2_D0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH10, DCMI_D1> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH10, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH10, OCTOSPIM_P2_IO5> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH10, PSSI_D1> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH10, TIM5_CH1> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH11, DCMI_D2> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH11, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH11, OCTOSPIM_P2_IO6> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH11, PSSI_D2> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH11, TIM5_CH2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH12, DCMI_D3> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH12, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH12, OCTOSPIM_P2_IO7> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH12, PSSI_D3> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH13, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH13, TIM8_CH1N> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH14, DCMI_D4> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH14, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH14, PSSI_D4> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH14, TIM8_CH2N> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH15, DCMI_D11> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH15, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH15, OCTOSPIM_P2_IO6> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH15, PSSI_D11> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH15, TIM8_CH3N> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH2, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH2, OCTOSPIM_P1_IO4> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH3, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH4, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH4, I2C2_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH4, OCTOSPIM_P2_DQS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH4, PSSI_D14> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH5, DCMI_PIXCLK> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH5, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH5, I2C2_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH5, PSSI_PDCK> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, DCMI_D8> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, I2C2_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, OCTOSPIM_P2_CLK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, PSSI_D8> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, DCMI_D9> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, I2C3_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, OCTOSPIM_P2_NCLK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, PSSI_D9> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH8, DCMI_HSYNC> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH8, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH8, I2C3_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH8, OCTOSPIM_P2_IO3> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH8, PSSI_DE> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH9, DCMI_D0> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH9, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH9, I2C3_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH9, OCTOSPIM_P2_IO4> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH9, PSSI_D0> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI0, DCMI_D13> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI0, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI0, OCTOSPIM_P1_IO5> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI0, PSSI_D13> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI1, DCMI_D8> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI1, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI1, PSSI_D8> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI1, SPI2_SCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, OCTOSPIM_P2_IO1> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, PSSI_D14> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI11, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI11, OCTOSPIM_P2_IO0> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI11, PSSI_D15> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI2, DCMI_D9> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI2, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI2, PSSI_D9> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI3, DCMI_D10> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI3, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI3, PSSI_D10> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI4, DCMI_D5> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI4, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI4, PSSI_D5> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI4, TIM8_BKIN> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI5, DCMI_VSYNC> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI5, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI5, OCTOSPIM_P2_NCS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI5, PSSI_RDY> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI5, TIM8_CH1> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI6, DCMI_D6> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI6, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI6, OCTOSPIM_P2_CLK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI6, PSSI_D6> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI6, TIM8_CH2> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI7, DCMI_D7> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI7, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI7, OCTOSPIM_P2_NCLK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI7, PSSI_D7> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI7, TIM8_CH3> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI8, DCMI_D12> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI8, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI8, OCTOSPIM_P2_NCS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI8, PSSI_D12> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI9, CAN1_RX> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI9, EVENTOUT> { static const alt_fun_t AF = AF15; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI9, OCTOSPIM_P2_IO2> { static const alt_fun_t AF = AF5; };
