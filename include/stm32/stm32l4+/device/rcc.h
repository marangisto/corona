...
struct stm32l4p5_rcc_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t PLLSAI2CFGR_PLLSAI2Q =              // SAI2PLL PLLSAI2CLK output enable
        bit_field_t<21, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CCIPR2_PLLSAI2DIVR =      // division factor for LTDC clock
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
