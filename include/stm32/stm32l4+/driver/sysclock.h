...
static inline uint32_t clock_tree_init()
{
    ...
    // pllN = 30.0, pllM = 2.0, pllP = 7.0, pllQ = 2.0, pllR = 2.0

    constexpr uint8_t pllM = 2 - 1; // 3 bits, valid range [1..8]-1
    constexpr uint8_t pllSRC = 2;   // 2 bits, 2 = HSI16, 3 = HSE
    constexpr uint16_t pllN = 30;   // 7 bits, valid range [8..86]
