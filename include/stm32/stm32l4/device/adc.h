...
struct stm32l476_adc1_t
{
    ...
    static constexpr uint32_t CFGR_ALIGN = 0x20; // ALIGN
    typedef bit_field_t<3, 0x3> CFGR_RES; // RES
    static constexpr uint32_t CFGR_DFSDMCFG = 0x4; // DFSDMCFG
    static constexpr uint32_t CFGR_DMACFG = 0x2; // DMACFG
    static constexpr uint32_t CFGR_DMAEN = 0x1; // DMAEN
...
// ADC123_COMMON: Analog-to-Digital Converter

struct stm32l4x5_adc123_common_t
{
...
struct stm32l412_adc12_common_t
{
    volatile uint32_t CSR; // ADC Common status register
    reserved_t<0x1> _0x4;
    volatile uint32_t CCR; // ADC common control register
...
template<>
struct peripheral_t<STM32L412, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l412_adc1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L412, ADC2>
{
...
template<>
struct peripheral_t<STM32L4x1, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x1, ADC2>
{
    static constexpr periph_t P = ADC2;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x1, ADC3>
{
...
template<>
struct peripheral_t<STM32L4x2, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x2, ADC2>
{
    static constexpr periph_t P = ADC2;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x2, ADC3>
{
    static constexpr periph_t P = ADC3;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x3, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x3, ADC2>
{
    static constexpr periph_t P = ADC2;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x3, ADC3>
{
    static constexpr periph_t P = ADC3;
    using T = stm32l412_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L476, ADC1>
{
    static constexpr periph_t P = ADC1;
...
template<>
struct peripheral_t<STM32L476, ADC2>
{
    static constexpr periph_t P = ADC2;
    using T = stm32l476_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L476, ADC3>
{
    static constexpr periph_t P = ADC3;
    using T = stm32l476_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L496, ADC1>
{
    static constexpr periph_t P = ADC1;
    using T = stm32l476_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L496, ADC2>
{
    static constexpr periph_t P = ADC2;
    using T = stm32l476_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L496, ADC3>
{
    static constexpr periph_t P = ADC3;
    using T = stm32l476_adc1_t;
    static T& V;
...
{
    static constexpr periph_t P = ADC1;
    using T = stm32l4x5_adc1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L4x5, ADC2>
{
    static constexpr periph_t P = ADC2;
    using T = stm32l4x5_adc1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x5, ADC3>
{
    static constexpr periph_t P = ADC3;
    using T = stm32l4x5_adc1_t;
    static T& V;
...
struct peripheral_t<STM32L4x5, ADC123_COMMON>
{
    ...
    using T = stm32l4x5_adc123_common_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L412, ADC12_COMMON>
{
...
using adc123_common_t = peripheral_t<svd, ADC123_COMMON>;
