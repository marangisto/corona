...
template<> struct can_traits<2>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_CAN2EN;
    }
    ...
    static void enable_sleep_mode()
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_CAN2SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_CAN2RST;
    }
};
