...
struct stm32l412_dbgmcu_t
{
    ...
    volatile uint32_t APB1FZR1; // [read-write] Debug MCU APB1 freeze register1
    volatile uint32_t APB1FZR2; // [read-write] Debug MCU APB1 freeze register 2
    volatile uint32_t APB2FZR;  // [read-write] Debug MCU APB2 freeze register
...
struct stm32l476_dbgmcu_t
{
    ...
    volatile uint32_t CR;        // [read-write] Debug MCU Configuration Register
    volatile uint32_t APB1_FZR1; // [read-write] APB Low Freeze Register 1
    volatile uint32_t APB1_FZR2; // [read-write] APB Low Freeze Register 2
    volatile uint32_t APB2_FZR;  // [read-write] APB High Freeze Register
    ...
    static constexpr uint32_t APB1_FZR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1_FZR2_RESET_VALUE = 0x0;
    static constexpr uint32_t APB1_FZR2_DBG_LPTIM2_STOP = 0x20; // LPTIM2 counter stopped when core is halted

    static constexpr uint32_t APB2_FZR_RESET_VALUE = 0x0;
