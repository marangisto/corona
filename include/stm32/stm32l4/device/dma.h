...
struct stm32l412_dma1_t
{
    ...
    typedef bit_field_t<24, 0xf> CSELR_C7S; // DMA channel 7 selection
    typedef bit_field_t<20, 0xf> CSELR_C6S; // DMA channel 6 selection
    typedef bit_field_t<16, 0xf> CSELR_C5S; // DMA channel 5 selection
    typedef bit_field_t<12, 0xf> CSELR_C4S; // DMA channel 4 selection
    typedef bit_field_t<8, 0xf> CSELR_C3S; // DMA channel 3 selection
    typedef bit_field_t<4, 0xf> CSELR_C2S; // DMA channel 2 selection
    typedef bit_field_t<0, 0xf> CSELR_C1S; // DMA channel 1 selection
};

template<>
struct peripheral_t<STM32L412, DMA1>
{
...
template<>
struct peripheral_t<STM32L412, DMA2>
{
...
template<>
struct peripheral_t<STM32L476, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L476, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L496, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L496, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x1, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x1, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x2, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x2, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x3, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x3, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x5, DMA1>
{
    static constexpr periph_t P = DMA1;
    using T = stm32l412_dma1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L4x5, DMA2>
{
    static constexpr periph_t P = DMA2;
    using T = stm32l412_dma1_t;
    static T& V;
