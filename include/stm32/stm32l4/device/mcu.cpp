...
typename peripheral_t<STM32L412, ADC2>::T&
    peripheral_t<STM32L412, ADC2>::V = *reinterpret_cast
        <typename peripheral_t<STM32L412, ADC2>::T*
        >(0x50040100);
...
typename peripheral_t<STM32L412, ADC12_COMMON>::T&
    peripheral_t<STM32L412, ADC12_COMMON>::V = *reinterpret_cast
        <typename peripheral_t<STM32L412, ADC12_COMMON>::T*
        >(0x50040300);
