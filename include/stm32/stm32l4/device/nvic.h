...
struct stm32l476_nvic_t
{
    ...
    typedef bit_field_t<16, 0xff> IPR22_IPR_N2; // IPR_N0
...
struct stm32l496_nvic_t
{
    ...
    volatile uint32_t IPR19; // Interrupt Priority Register
    volatile uint32_t IPR20; // Interrupt Priority Register
    volatile uint32_t IPR21; // IPR21
    volatile uint32_t IPR22; // IPR22
    volatile uint32_t IPR23; // IPR23
    volatile uint32_t IPR24; // IPR24
    volatile uint32_t IPR25; // IPR25
    ...
    typedef bit_field_t<24, 0xff> IPR25_IPR_N3; // IPR_N2
};
