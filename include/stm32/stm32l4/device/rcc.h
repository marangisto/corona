...
struct stm32l412_rcc_t
{
    ...
    static constexpr uint32_t ICSCR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0x1f> ICSCR_HSITRIM; // HSI clock trimming
    ...
    typedef bit_field_t<4, 0x7> PLLCFGR_PLLM; // Division factor for the main PLL and audio PLL (PLLSAI1 and PLLSAI2) input clock
    ...
    static constexpr uint32_t AHB1SMENR_RESET_VALUE = 0x0; // Reset value
    ...
    static constexpr uint32_t AHB2SMENR_RESET_VALUE = 0x5229f; // Reset value
    ...
    static constexpr uint32_t AHB3SMENR_RESET_VALUE = 0x100; // Reset value
    static constexpr uint32_t AHB3SMENR_QSPISMEN = 0x100; // QSPISMEN


    static constexpr uint32_t APB1SMENR1_RESET_VALUE = 0xf7e6ce31; // Reset value
    ...
    static constexpr uint32_t APB2SMENR_RESET_VALUE = 0x2357c01; // Reset value
    ...
    typedef bit_field_t<28, 0x3> CCIPR_ADCSEL; // ADCSEL
...
struct stm32l4x1_rcc_t
{
    ...
    typedef bit_field_t<2, 0x3> CCIPR_USART2SEL; // USART2 clock source selection
    typedef bit_field_t<0, 0x3> CCIPR_USART1SEL; // USART1 clock source selection
    typedef bit_field_t<6, 0x3> CCIPR_USART4SEL; // USART4 clock source selection
    typedef bit_field_t<4, 0x3> CCIPR_USART3SEL; // USART3 clock source selection
    typedef bit_field_t<14, 0x3> CCIPR_I2C2SEL; // I2C2 clock source selection
    ...
    static constexpr uint32_t CRRCR_RESET_VALUE = 0xc000600; // Reset value
    static constexpr uint32_t CRRCR_HSI48ON = 0x1; // HSI48 clock enable
    static constexpr uint32_t CRRCR_HSI48RDY = 0x2; // HSI48 clock ready flag
    typedef bit_field_t<7, 0x1ff> CRRCR_HSI48CAL; // HSI48 clock calibration
};
