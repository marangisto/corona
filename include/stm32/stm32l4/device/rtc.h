...
struct stm32l412_rtc_t
{
    ...
    typedef bit_field_t<0, 0x7> CR_WUCKSEL; // ck_wut wakeup clock selection
    ...
    typedef bit_field_t<0, 0x7fff> ALRMBSSR_SS; // Sub second value
...
{
    using rtc = rtc_t;
    static constexpr signal_t OUT2 = RTC_OUT2;
