...
{
    typedef stm32l412_scb_actrl_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4x6, SCB_ACTRL>
{
    typedef stm32l412_scb_actrl_t T;
    static T& V;
};
...
{
    typedef stm32l4x5_scb_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L4x6, SCB>
{
    typedef stm32l4x5_scb_t T;
    static T& V;
};
