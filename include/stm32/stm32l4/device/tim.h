...
struct stm32l412_tim15_t
{
    ...
    volatile uint32_t RCR;          // [read-write] repetition counter register
    volatile uint32_t CCR1;         // [read-write] capture/compare register 1
    volatile uint32_t CCR2;         // [read-write] TIM15 capture/compare register 2
...
struct stm32l4x2_tim15_t
{
    ...
    static constexpr uint32_t SMCR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t SMCR_SMS =             // SMS
        bit_field_t<0, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SMCR_TS =              // TS
        bit_field_t<4, 0x7>::value<X>();
...
struct stm32l412_tim2_t
{
    ...
    static constexpr uint32_t CNT_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CNT_CNT_M =              // Most significant part counter value
