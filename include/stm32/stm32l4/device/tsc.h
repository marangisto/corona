...
template<> struct tsc_traits<0>
{
    ...
    static void enable()
    {
        RCC::V.AHB1ENR |= RCC::T::AHB1ENR_TSCEN;
    }
    ...
    {
        RCC::V.AHB1SMENR |= RCC::T::AHB1SMENR_TSCSMEN;
    }
    ...
    static void reset()
    {
        RCC::V.AHB1RSTR |= RCC::T::AHB1RSTR_TSCRST;
    }
};
