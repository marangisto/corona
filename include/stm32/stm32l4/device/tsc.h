...
struct stm32l412_tsc_t
{
    ...
    volatile uint32_t IOG8CR; // [read-only] I/O group x counter register
    ...
    static constexpr uint32_t IOG8CR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t IOG8CR_CNT =   // Counter value
        bit_field_t<0, 0x3fff>::value<X>();
};
...
struct stm32l476_tsc_t
{
    ...
    static constexpr uint32_t IOHCR_RESET_VALUE = 0xffffffff;
    static constexpr uint32_t IOHCR_G8_IO4 = 0x80000000; // G8_IO4
    static constexpr uint32_t IOHCR_G8_IO3 = 0x40000000; // G8_IO3
    static constexpr uint32_t IOHCR_G8_IO2 = 0x20000000; // G8_IO2
    static constexpr uint32_t IOHCR_G8_IO1 = 0x10000000; // G8_IO1
    static constexpr uint32_t IOHCR_G7_IO4 = 0x8000000;  // G7_IO4
    static constexpr uint32_t IOHCR_G7_IO3 = 0x4000000;  // G7_IO3
    static constexpr uint32_t IOHCR_G7_IO2 = 0x2000000;  // G7_IO2
    static constexpr uint32_t IOHCR_G7_IO1 = 0x1000000;  // G7_IO1
    ...
    static constexpr uint32_t IOASCR_RESET_VALUE = 0x0;
    static constexpr uint32_t IOASCR_G8_IO4 = 0x80000000; // G8_IO4
    static constexpr uint32_t IOASCR_G8_IO3 = 0x40000000; // G8_IO3
    static constexpr uint32_t IOASCR_G8_IO2 = 0x20000000; // G8_IO2
    static constexpr uint32_t IOASCR_G8_IO1 = 0x10000000; // G8_IO1
    static constexpr uint32_t IOASCR_G7_IO4 = 0x8000000;  // G7_IO4
    static constexpr uint32_t IOASCR_G7_IO3 = 0x4000000;  // G7_IO3
    static constexpr uint32_t IOASCR_G7_IO2 = 0x2000000;  // G7_IO2
    static constexpr uint32_t IOASCR_G7_IO1 = 0x1000000;  // G7_IO1
    ...
    static constexpr uint32_t IOSCR_RESET_VALUE = 0x0;
    static constexpr uint32_t IOSCR_G8_IO4 = 0x80000000; // G8_IO4
    static constexpr uint32_t IOSCR_G8_IO3 = 0x40000000; // G8_IO3
    static constexpr uint32_t IOSCR_G8_IO2 = 0x20000000; // G8_IO2
    static constexpr uint32_t IOSCR_G8_IO1 = 0x10000000; // G8_IO1
    static constexpr uint32_t IOSCR_G7_IO4 = 0x8000000;  // G7_IO4
    static constexpr uint32_t IOSCR_G7_IO3 = 0x4000000;  // G7_IO3
    static constexpr uint32_t IOSCR_G7_IO2 = 0x2000000;  // G7_IO2
    static constexpr uint32_t IOSCR_G7_IO1 = 0x1000000;  // G7_IO1
    ...
    static constexpr uint32_t IOCCR_RESET_VALUE = 0x0;
    static constexpr uint32_t IOCCR_G8_IO4 = 0x80000000; // G8_IO4
    static constexpr uint32_t IOCCR_G8_IO3 = 0x40000000; // G8_IO3
    static constexpr uint32_t IOCCR_G8_IO2 = 0x20000000; // G8_IO2
    static constexpr uint32_t IOCCR_G8_IO1 = 0x10000000; // G8_IO1
    static constexpr uint32_t IOCCR_G7_IO4 = 0x8000000;  // G7_IO4
    static constexpr uint32_t IOCCR_G7_IO3 = 0x4000000;  // G7_IO3
    static constexpr uint32_t IOCCR_G7_IO2 = 0x2000000;  // G7_IO2
    static constexpr uint32_t IOCCR_G7_IO1 = 0x1000000;  // G7_IO1
...
template<>
struct peripheral_t<STM32L412, TSC>
{
    typedef stm32l412_tsc_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L476, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L496, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4x1, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4x2, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4x3, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4x5, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L4x6, TSC>
{
    typedef stm32l476_tsc_t T;
    static T& V;
};
