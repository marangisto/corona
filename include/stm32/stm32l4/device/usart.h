...
struct stm32l4x1_usart3_t
{
    ...
    static constexpr uint32_t BRR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xfff> BRR_BRR; // USARTDIV
...
template<> struct usart_traits<1>
{
    ...
    static void enable()
    {
        RCC::V.APB1ENR1 |= RCC::T::APB1ENR1_USART1EN;
    }
    ...
    static void enable_sleep_mode()
    {
        RCC::V.APB1SMENR1 |= RCC::T::APB1SMENR1_USART1SMEN;
    }
    ...
    static void reset()
    {
        RCC::V.APB1RSTR1 |= RCC::T::APB1RSTR1_USART1RST;
    }
};
