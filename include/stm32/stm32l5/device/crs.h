...
////
//
//      STM32L5 CRS peripherals
//
///

// CRS: Clock recovery system

struct stm32l552_crs_t
{
    ...
    static constexpr uint32_t CR_RESET_VALUE = 0x4000; // Reset value
    typedef bit_field_t<8, 0x7f> CR_TRIM; // HSI48 oscillator smooth trimming
...
using sec_crs_t = peripheral_t<svd, SEC_CRS>;
