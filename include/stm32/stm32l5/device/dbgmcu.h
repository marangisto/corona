...
struct stm32l552_dbgmcu_t
{
    ...
    volatile uint32_t APB1LFZR; // [read-write] Debug MCU APB1 freeze register1
    volatile uint32_t APB1HFZR; // [read-write] Debug MCU APB1 freeze register 2
    ...
    static constexpr uint32_t APB1LFZR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB1HFZR_RESET_VALUE = 0x0;
