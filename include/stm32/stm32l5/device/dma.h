...
struct stm32l552_dma1_t
{
    ...
    volatile uint32_t CM0AR1; // [read-write] channel x memory address register
    volatile uint32_t CM1AR1; // [read-write] channel x memory address register
    ...
    volatile uint32_t CM0AR2; // [read-write] channel x memory address register
    volatile uint32_t CM1AR2; // [read-write] channel x memory address register
    ...
    volatile uint32_t CM0AR3; // [read-write] channel x memory address register
    volatile uint32_t CM1AR3; // [read-write] channel x memory address register
    ...
    volatile uint32_t CM0AR4; // [read-write] channel x memory address register
    volatile uint32_t CM1AR4; // [read-write] channel x memory address register
    ...
    volatile uint32_t CM0AR5; // [read-write] channel x memory address register
    volatile uint32_t CM1AR5; // [read-write] channel x memory address register
    ...
    volatile uint32_t CM0AR6; // [read-write] channel x memory address register
    volatile uint32_t CM1AR6; // [read-write] channel x memory address register
    ...
    volatile uint32_t CM0AR7; // [read-write] channel x memory address register
    volatile uint32_t CM1AR7; // [read-write] channel x memory address register
    volatile uint32_t CCR8;   // [read-write] channel x configuration register
    volatile uint32_t CNDTR8; // [read-write] channel x number of data register
    volatile uint32_t CPAR8;  // [read-write] channel x peripheral address register
    volatile uint32_t CM0AR8; // [read-write] channel x peripheral address register
    volatile uint32_t CM1AR8; // [read-write] channel x peripheral address register
    ...
    static constexpr uint32_t CM1AR1_RESET_VALUE = 0x0;
    static constexpr uint32_t CM1AR1_MEM2MEM = 0x4000; // Memory to memory mode
    template<uint32_t X>
    static constexpr uint32_t CM1AR1_PL =              // Channel priority level
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM1AR1_MSIZE =           // Memory size
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM1AR1_PSIZE =           // Peripheral size
        bit_field_t<8, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CCR2_NDT =   // Number of data to transfer
        bit_field_t<0, 0x3ffff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CM0AR2_PL =              // Channel priority level
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR2_MSIZE =           // Memory size
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR2_PSIZE =           // Peripheral size
        bit_field_t<8, 0x3>::value<X>();
    ...
    static constexpr uint32_t CM1AR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CM1AR2_NDT =   // Number of data to transfer
        bit_field_t<0, 0x3ffff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CPAR3_PL =              // Channel priority level
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CPAR3_MSIZE =           // Memory size
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CPAR3_PSIZE =           // Peripheral size
        bit_field_t<8, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CM0AR3_NDT =   // Number of data to transfer
        bit_field_t<0, 0x3ffff>::value<X>();

    static constexpr uint32_t CM1AR3_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CNDTR4_PL =              // Channel priority level
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CNDTR4_MSIZE =           // Memory size
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CNDTR4_PSIZE =           // Peripheral size
        bit_field_t<8, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CPAR4_NDT =   // Number of data to transfer
        bit_field_t<0, 0x3ffff>::value<X>();

    static constexpr uint32_t CM0AR4_RESET_VALUE = 0x0;

    static constexpr uint32_t CM1AR4_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CM1AR5_RESET_VALUE = 0x0;
    static constexpr uint32_t CM1AR5_MEM2MEM = 0x4000; // Memory to memory mode
    template<uint32_t X>
    static constexpr uint32_t CM1AR5_PL =              // Channel priority level
        bit_field_t<12, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM1AR5_MSIZE =           // Memory size
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM1AR5_PSIZE =           // Peripheral size
        bit_field_t<8, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CCR6_NDT =   // Number of data to transfer
        bit_field_t<0, 0x3ffff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C7S =   // DMA channel 7 selection
        bit_field_t<24, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C6S =   // DMA channel 6 selection
        bit_field_t<20, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C5S =   // DMA channel 5 selection
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C4S =   // DMA channel 4 selection
        bit_field_t<12, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C3S =   // DMA channel 3 selection
        bit_field_t<8, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C2S =   // DMA channel 2 selection
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CM0AR6_C1S =   // DMA channel 1 selection
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t CM1AR6_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t CM1AR7_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t CNDTR8_PSIZE =           // peripheral size
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CNDTR8_MSIZE =           // memory size
        bit_field_t<10, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CNDTR8_PL =              // priority level
        bit_field_t<12, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t CPAR8_NDT =   // number of data to transfer
        bit_field_t<0, 0x3ffff>::value<X>();

    static constexpr uint32_t CM0AR8_RESET_VALUE = 0x0;

    static constexpr uint32_t CM1AR8_RESET_VALUE = 0x0;
