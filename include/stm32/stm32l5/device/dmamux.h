...
struct stm32l552_dmamux1_t
{
    ...
    volatile uint32_t CCFR; // DMA Channel Clear Flag Register
    ...
    reserved_t<0xa> _0x110;
    volatile uint32_t C14CR; // DMA Multiplexer Channel 10 Control register
    volatile uint32_t C15CR; // DMA Multiplexer Channel 10 Control register
    ...
    typedef bit_field_t<0, 0x7f> C0CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C1CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C2CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C3CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C4CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C5CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C6CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C7CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C8CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C9CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C10CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C11CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C12CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<0, 0x7f> C13CR_DMAREQ_ID; // DMA Request ID
    ...
    typedef bit_field_t<24, 0x1f> C14CR_SYNC_ID; // Synchronization identification
    typedef bit_field_t<19, 0x1f> C14CR_NBREQ; // Number of DMA requests minus 1 to forward
    typedef bit_field_t<17, 0x3> C14CR_SPOL; // Synchronization polarity
    ...
    typedef bit_field_t<0, 0x7f> C14CR_DMAREQ_ID; // DMA request identification

    static constexpr uint32_t C15CR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<24, 0x1f> C15CR_SYNC_ID; // Synchronization identification
    typedef bit_field_t<19, 0x1f> C15CR_NBREQ; // Number of DMA requests minus 1 to forward
    typedef bit_field_t<17, 0x3> C15CR_SPOL; // Synchronization polarity
    ...
    typedef bit_field_t<0, 0x7f> C15CR_DMAREQ_ID; // DMA request identification
...
{
    static constexpr periph_t P = SEC_DMAMUX1;
    using T = stm32l552_dmamux1_t;
    static T& V;
};
