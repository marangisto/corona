...
struct stm32l552_exti_t
{
    ...
    volatile uint32_t SECCFGR1;  // [read-write] EXTI security configuration register
    volatile uint32_t PRIVCFGR1; // [read-write] EXTI privilege configuration register
    ...
    volatile uint32_t RPR2;      // [read-write] EXTI rising edge pending register
    volatile uint32_t FPR2;      // [read-write] EXTI falling edge pending register
    volatile uint32_t PRIVCFGR2; // [read-write] EXTI security enable register
    volatile uint32_t SECCFGR2;  // [read-write] EXTI security enable register
    reserved_t<0x9> _0x60;
    ...
    volatile uint32_t LOCKRG;    // [read-write] EXTI lock register
    ...
    volatile uint32_t IMR2;      // [read-write] EXTI CPUm wakeup with interrupt mask register
    ...
    static constexpr uint32_t SECCFGR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t PRIVCFGR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t RPR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t FPR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SECCFGR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t PRIVCFGR2_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t EXTICR1_EXTI0_7 =     // EXTIm GPIO port selection
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR1_EXTI8_15 =    // EXTIm+1 GPIO port selection
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR1_EXTI16_23 =   // EXTIm+2 GPIO port selection
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR1_EXTI24_31 =   // EXTIm+3 GPIO port selection
        bit_field_t<24, 0xff>::value<X>();

    static constexpr uint32_t EXTICR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t EXTICR2_EXTI0_7 =     // EXTIm GPIO port selection
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR2_EXTI8_15 =    // EXTIm+1 GPIO port selection
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR2_EXTI16_23 =   // EXTIm+2 GPIO port selection
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR2_EXTI24_31 =   // EXTIm+3 GPIO port selection
        bit_field_t<24, 0xff>::value<X>();

    static constexpr uint32_t EXTICR3_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t EXTICR3_EXTI0_7 =     // EXTIm GPIO port selection
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR3_EXTI8_15 =    // EXTIm+1 GPIO port selection
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR3_EXTI16_23 =   // EXTIm+2 GPIO port selection
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR3_EXTI24_31 =   // EXTIm+3 GPIO port selection
        bit_field_t<24, 0xff>::value<X>();

    static constexpr uint32_t EXTICR4_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t EXTICR4_EXTI0_7 =     // EXTIm GPIO port selection
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR4_EXTI8_15 =    // EXTIm+1 GPIO port selection
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR4_EXTI16_23 =   // EXTIm+2 GPIO port selection
        bit_field_t<16, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTICR4_EXTI24_31 =   // EXTIm+3 GPIO port selection
        bit_field_t<24, 0xff>::value<X>();

    static constexpr uint32_t LOCKRG_RESET_VALUE = 0x0;
    static constexpr uint32_t LOCKRG_LOCK = 0x1; // LOCK

    static constexpr uint32_t IMR1_RESET_VALUE = 0xff9e0000;
    ...
    static constexpr uint32_t IMR2_RESET_VALUE = 0x787;
...
using sec_exti_t = peripheral_t<mcu_svd, SEC_EXTI>;
