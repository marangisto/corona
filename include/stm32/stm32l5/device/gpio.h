...
struct stm32l552_gpioa_t
{
    ...
    volatile uint32_t SECCFGR; // [write-only] GPIO secure configuration register
...
using sec_gpioa_t = peripheral_t<mcu_svd, SEC_GPIOA>;
using sec_gpiob_t = peripheral_t<mcu_svd, SEC_GPIOB>;
using sec_gpioc_t = peripheral_t<mcu_svd, SEC_GPIOC>;
using sec_gpiod_t = peripheral_t<mcu_svd, SEC_GPIOD>;
using sec_gpioe_t = peripheral_t<mcu_svd, SEC_GPIOE>;
using sec_gpiof_t = peripheral_t<mcu_svd, SEC_GPIOF>;
using sec_gpiog_t = peripheral_t<mcu_svd, SEC_GPIOG>;
using sec_gpioh_t = peripheral_t<mcu_svd, SEC_GPIOH>;
