...
////
//
//      STM32L5 HASH peripherals
//
///

// HASH: Hash processor

struct stm32l552_hash_t
{
    volatile uint32_t CR; // control register
    volatile uint32_t DIN; // data input register
    volatile uint32_t STR; // start register
    volatile uint32_t HRA0; // HASH aliased digest register 0
    volatile uint32_t HRA1; // HASH aliased digest register 1
    volatile uint32_t HRA2; // HASH aliased digest register 2
    volatile uint32_t HRA3; // HASH aliased digest register 3
    volatile uint32_t HRA4; // HASH aliased digest register 4
    ...
    volatile uint32_t HR0; // digest register 0
    volatile uint32_t HR1; // digest register 1
    volatile uint32_t HR2; // digest register 4
    volatile uint32_t HR3; // digest register 3
    volatile uint32_t HR4; // digest register 4
    volatile uint32_t HR5; // supplementary digest register 5
    volatile uint32_t HR6; // supplementary digest register 6
    volatile uint32_t HR7; // supplementary digest register 7
    ...
    static constexpr uint32_t CR_ALGO1 = 0x40000; // Algorithm selection
    ...
    static constexpr uint32_t HRA0_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HRA0_H0; // H0

    static constexpr uint32_t HRA1_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HRA1_H1; // H1

    static constexpr uint32_t HRA2_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HRA2_H2; // H2

    static constexpr uint32_t HRA3_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HRA3_H3; // H3

    static constexpr uint32_t HRA4_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HRA4_H4; // H4
    ...
    static constexpr uint32_t CSR0_RESET_VALUE = 0x2; // Reset value
    ...
    static constexpr uint32_t HR5_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HR5_H5; // H5

    static constexpr uint32_t HR6_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HR6_H6; // H6

    static constexpr uint32_t HR7_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffffffff> HR7_H7; // H7
};

template<>
struct peripheral_t<STM32L552, HASH>
{
    static constexpr periph_t P = HASH;
    using T = stm32l552_hash_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_HASH>
{
    static constexpr periph_t P = SEC_HASH;
    using T = stm32l552_hash_t;
    static T& V;
};

template<>
struct peripheral_t<STM32L562, HASH>
{
    static constexpr periph_t P = HASH;
    using T = stm32l552_hash_t;
    static T& V;
...
template<>
struct peripheral_t<STM32L562, SEC_HASH>
{
    static constexpr periph_t P = SEC_HASH;
    using T = stm32l552_hash_t;
    static T& V;
...
using sec_hash_t = peripheral_t<svd, SEC_HASH>;
...
template<> struct hash_traits<0>
{
    ...
    {
        RCC::V.AHB2SMENR |= RCC::T::AHB2SMENR_HASHSMEN;
    }
...
{
    static constexpr unsigned ID = 92;
};
