...
struct stm32l552_rcc_t
{
    ...
    volatile uint32_t CCIPR1;      // [read-write] CCIPR1
    ...
    reserved_t<0x6> _0xb8;
    volatile uint32_t SECCFGR;     // [read-write] RCC secure configuration register
    volatile uint32_t SECSR;       // [read-write] RCC secure status register
    reserved_t<0xa> _0xe8;
    volatile uint32_t AHB1SECSR;   // [read-only] RCC AHB1 security status register
    volatile uint32_t AHB2SECSR;   // [read-only] RCC AHB2 security status register
    volatile uint32_t AHB3SECSR;   // [read-only] RCC AHB3 security status register
    reserved_t<0x1> _0xf8;
    volatile uint32_t APB1SECSR1;  // [read-only] RCC APB1 security status register 1
    volatile uint32_t APB1SECSR2;  // [read-only] RCC APB1 security status register 2
    volatile uint32_t APB2SECSR;   // [read-only] RCC APB2 security status register
    ...
    static constexpr uint32_t PLLSAI1CFGR_PLLSAI1N =              // SAI1PLL multiplication factor for VCO
        bit_field_t<8, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAI1CFGR_PLLSAI1M =              // Division factor for PLLSAI1 input clock
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAI1CFGR_PLLSAI1SRC =            // PLLSAI1SRC
        bit_field_t<0, 0x3>::value<X>();
    ...
    static constexpr uint32_t PLLSAI2CFGR_PLLSAI2N =            // SAI2PLL multiplication factor for VCO
        bit_field_t<8, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAI2CFGR_PLLSAI2M =            // Division factor for PLLSAI2 input clock
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLSAI2CFGR_PLLSAI2SRC =          // PLLSAI2SRC
        bit_field_t<0, 0x3>::value<X>();
    ...
    static constexpr uint32_t AHB1ENR_DMAMUX1EN = 0x4;   // DMAMUX clock enable
    ...
    static constexpr uint32_t AHB1SMENR_RESET_VALUE = 0xc11307;
    ...
    static constexpr uint32_t AHB2SMENR_RESET_VALUE = 0x6f22ff;
    ...
    static constexpr uint32_t APB1SMENR1_RESET_VALUE = 0xf1fecc3f;
    ...
    static constexpr uint32_t APB1SMENR2_RESET_VALUE = 0xa00223;
    ...
    static constexpr uint32_t APB2SMENR_RESET_VALUE = 0x1677801;
    ...
    template<uint32_t X>
    static constexpr uint32_t CCIPR1_CLK48MSEL =    // 48 MHz clock source selection
        bit_field_t<26, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR1_FDCANSEL =     // FDCAN clock source selection
        bit_field_t<24, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR1_LPTIM3SEL =    // Low-power timer 3 clock source selection
        bit_field_t<22, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR1_LPTIM2SEL =    // Low power timer 2 clock source selection
    ...
    template<uint32_t X>
    static constexpr uint32_t CCIPR2_ADFSDMSEL =        // Digital filter for sigma delta modulator audio clock source selection
        bit_field_t<3, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR2_SAI1SEL =          // SAI1 clock source selection
        bit_field_t<5, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CCIPR2_SAI2SEL =          // SAI2 clock source selection
        bit_field_t<8, 0x7>::value<X>();
    static constexpr uint32_t CCIPR2_SDMMCSEL = 0x4000; // SDMMC clock selection
    template<uint32_t X>
    static constexpr uint32_t CCIPR2_OSPISEL =          // Octospi clock source selection
        bit_field_t<20, 0x3>::value<X>();
    ...
    static constexpr uint32_t AHB1SECSR_RESET_VALUE = 0x400300;
    ...
    static constexpr uint32_t AHB2SECSR_RESET_VALUE = 0x2002ff;
    ...
    static constexpr uint32_t APB1SECSR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t APB2SECSR_RESET_VALUE = 0x0;
...
using sec_rcc_t = peripheral_t<mcu_svd, SEC_RCC>;
