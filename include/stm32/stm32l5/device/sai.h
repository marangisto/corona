...
struct stm32l552_sai1_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t PDMCR_MICNBR =       // MICNBR
        bit_field_t<4, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM1L =   // Delay line adjust for first microphone of pair 1
        bit_field_t<0, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM1R =   // Delay line adjust for second microphone of pair 1
    ...
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM3L =   // DLYM3L
        bit_field_t<16, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM3R =   // DLYM3R
        bit_field_t<20, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM4L =   // DLYM4L
        bit_field_t<24, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PDMDLY_DLYM4R =   // DLYM4R
        bit_field_t<28, 0x7>::value<X>();
};


template<>
struct peripheral_t<STM32L552, SAI1>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SAI2>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_SAI1>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_SAI2>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SAI1>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SAI2>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_SAI1>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_SAI2>
{
    typedef stm32l552_sai1_t T;
    static T& V;
};
...
using sec_sai1_t = peripheral_t<mcu_svd, SEC_SAI1>;
using sec_sai2_t = peripheral_t<mcu_svd, SEC_SAI2>;
...
template<int INST> struct sec_sai_traits {};

template<> struct sec_sai_traits<1>
{
    using sec_sai = sec_sai1_t;
};

template<> struct sec_sai_traits<2>
{
    using sec_sai = sec_sai2_t;
};
