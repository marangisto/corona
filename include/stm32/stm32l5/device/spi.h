...
template<>
struct peripheral_t<STM32L552, SPI1>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SPI2>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SPI3>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_SPI1>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_SPI2>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_SPI3>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SPI1>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SPI2>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SPI3>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_SPI1>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_SPI2>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_SPI3>
{
    typedef stm32l552_spi1_t T;
    static T& V;
};

using sec_spi1_t = peripheral_t<mcu_svd, SEC_SPI1>;
using sec_spi2_t = peripheral_t<mcu_svd, SEC_SPI2>;
using sec_spi3_t = peripheral_t<mcu_svd, SEC_SPI3>;
using spi1_t = peripheral_t<mcu_svd, SPI1>;
using spi2_t = peripheral_t<mcu_svd, SPI2>;
using spi3_t = peripheral_t<mcu_svd, SPI3>;

template<int INST> struct sec_spi_traits {};

template<> struct sec_spi_traits<1>
{
    using sec_spi = sec_spi1_t;
};

template<> struct sec_spi_traits<2>
{
    using sec_spi = sec_spi2_t;
};

template<> struct sec_spi_traits<3>
{
    using sec_spi = sec_spi3_t;
};
