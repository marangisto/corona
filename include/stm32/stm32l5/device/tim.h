...
struct stm32l552_tim2_t
{
    ...
    volatile uint32_t DCR; // DMA control register
    volatile uint32_t DMAR; // DMA address for full transfer
    volatile uint32_t OR1; // TIM2 option register
    ...
    static constexpr uint32_t DMAR_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> DMAR_DMAB; // Low Capture/Compare 2 value
...
struct stm32l552_tim6_t
{
    ...
    static constexpr uint32_t CNT_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> CNT_CNT_BIT0; // CNT
    ...
    static constexpr uint32_t ARR_RESET_VALUE = 0xffffffff; // Reset value
    typedef bit_field_t<0, 0xffff> ARR_ARR_BIT0; // ARR_bit0
};
...
struct stm32l552_tim15_t
{
    ...
    static constexpr uint32_t PSC_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<0, 0xffff> PSC_CCR2; // Capture/Compare 2 value
    typedef bit_field_t<0, 0xffff> PSC_PSC; // Prescaler value
