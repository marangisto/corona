...
struct stm32l552_tim1_t
{
    ...
    static constexpr uint32_t CR2_OIS5 = 0x8000;  // Output Idle state 5 (OC5 output)
    static constexpr uint32_t CR2_OIS6 = 0x10000; // Output Idle state 6
    template<uint32_t X>
    ...
    static constexpr uint32_t CCMR1_Output_OC1M_bit3 = 0x10000;   // Output Compare 1 mode - bit 3
    static constexpr uint32_t CCMR1_Output_OC2M_bit3 = 0x1000000; // Output Compare 2 mode - bit 3
    ...
    static constexpr uint32_t CCMR2_Output_CC3S =                 // Capture/Compare 3 selection
        bit_field_t<0, 0x3>::value<X>();
    static constexpr uint32_t CCMR2_Output_OC3M_bit3 = 0x10000;   // Output Compare 3 mode - bit 3
    static constexpr uint32_t CCMR2_Output_OC4M_bit3 = 0x1000000; // Output Compare 4 mode - bit 3
...
struct stm32l552_tim15_t
{
    volatile uint32_t CR1;          // [read-write] control register 1
    volatile uint32_t CR2;          // [read-write] control register 2
    volatile uint32_t SMCR;         // [read-write] TIM15 slave mode control register
    volatile uint32_t DIER;         // [read-write] DMA/Interrupt enable register
    volatile uint32_t SR;           // [read-write] status register
    volatile uint32_t EGR;          // [write-only] event generation register
    ...
    volatile uint32_t DCR;          // [read-write] DMA control register
    volatile uint32_t DMAR;         // [read-write] DMA address for full transfer
    volatile uint32_t OR1;          // [read-write] TIM15 option register 1
    reserved_t<0x3> _0x60;
    volatile uint32_t OR2;          // [read-write] TIM15 option register 2
    ...
    static constexpr uint32_t CCMR1_Output_RESET_VALUE = 0x0;
    static constexpr uint32_t CCMR1_Output_OC1M_bit3 = 0x10000;   // Output Compare 1 mode
    template<uint32_t X>
    static constexpr uint32_t CCMR1_Output_OC1M =                 // Output Compare 1 mode
        bit_field_t<4, 0x7>::value<X>();
    static constexpr uint32_t CCMR1_Output_OC1PE = 0x8;           // Output Compare 1 preload enable
...
struct stm32l552_tim16_t
{
    ...
    static constexpr uint32_t OR2_BKCMP1E = 0x2;     // BRK COMP1 enable
    static constexpr uint32_t OR2_BKCMP2E = 0x4;     // BRK COMP2 enable
    static constexpr uint32_t OR2_BKDF1BK1E = 0x100; // BRK dfsdm1_break[1] enable
    static constexpr uint32_t OR2_BKINP = 0x200;     // BRK BKIN input polarity
    static constexpr uint32_t OR2_BKCMP1P = 0x400;   // BRK COMP1 input polarity
...
struct stm32l552_tim17_t
{
    ...
    static constexpr uint32_t OR2_BKCMP1E = 0x2;     // BRK COMP1 enable
    static constexpr uint32_t OR2_BKCMP2E = 0x4;     // BRK COMP2 enable
    static constexpr uint32_t OR2_BKDF1BK2E = 0x100; // BRK dfsdm1_break[2] enable
    static constexpr uint32_t OR2_BKINP = 0x200;     // BRK BKIN input polarity
    static constexpr uint32_t OR2_BKCMP1P = 0x400;   // BRK COMP1 input polarity
    static constexpr uint32_t OR2_BKCMP2P = 0x800;   // BRK COMP2 input polarit
};
...
struct stm32l552_tim2_t
{
    ...
    volatile uint32_t DCR;          // [read-write] DMA control register
    volatile uint32_t DMAR;         // [read-write] DMA address for full transfer
    volatile uint32_t OR1;          // [read-write] TIM2 option register
    reserved_t<0x3> _0x60;
    ...
    static constexpr uint32_t CCMR2_Output_CC3S =                 // Capture/Compare 3 selection
        bit_field_t<0, 0x3>::value<X>();
    static constexpr uint32_t CCMR2_Output_OC4M_bit3 = 0x1000000; // Output Compare 2 mode - bit 3
    static constexpr uint32_t CCMR2_Output_OC3M_bit3 = 0x10000;   // Output Compare 1 mode - bit 3
    ...
    static constexpr uint32_t CNT_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CNT_CNT_H =                 // Most significant part counter value (on TIM2 and TIM5)
        bit_field_t<16, 0x7fff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CNT_CNT_L =                 // Least significant part of counter value
        bit_field_t<0, 0xffff>::value<X>();
    ...
    static constexpr uint32_t DMAR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DMAR_DMAB =   // Low Capture/Compare 2 value
        bit_field_t<0, 0xffff>::value<X>();

    static constexpr uint32_t OR1_RESET_VALUE = 0x0;
    static constexpr uint32_t OR1_ITR1_RMP = 0x1; // Internal trigger 1 remap
    template<uint32_t X>
    static constexpr uint32_t OR1_TI4_RMP =       // Input Capture 4 remap
        bit_field_t<2, 0x3>::value<X>();
...
struct stm32l552_tim6_t
{
    ...
    static constexpr uint32_t CR1_UDIS = 0x2;      // Update disable
    static constexpr uint32_t CR1_CEN = 0x1;       // Counter enable
    static constexpr uint32_t CR1_UIFREMA = 0x800; // UIF status bit remapping
    ...
    static constexpr uint32_t CNT_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t CNT_CNT_bit0 =           // CNT
        bit_field_t<0, 0xffff>::value<X>();
    static constexpr uint32_t CNT_UIFCPY = 0x80000000; // UIFCPY or Res
    ...
    static constexpr uint32_t ARR_RESET_VALUE = 0xffffffff;
    template<uint32_t X>
    static constexpr uint32_t ARR_ARR_bit0 =   // ARR_bit0
        bit_field_t<0, 0xffff>::value<X>();
};
...
struct stm32l552_tim8_t
{
    ...
    static constexpr uint32_t OR3_BK2CMP1E = 0x2;    // BRK2 COMP1 enable
    static constexpr uint32_t OR3_BK2CMP2E = 0x4;    // BRK2 COMP2 enable
    static constexpr uint32_t OR3_BK2DFBK3E = 0x100; // BRK2 DFSDM_BREAK0 enable
    static constexpr uint32_t OR3_BK2INP = 0x200;    // BRK2 BKIN input polarity
    static constexpr uint32_t OR3_BK2CMP1P = 0x400;  // BRK2 COMP1 input polarity
    static constexpr uint32_t OR3_BK2CMP2P = 0x800;  // BRK2 COMP2 input polarity
};
...
template<>
struct peripheral_t<STM32L552, TIM1>
{
    typedef stm32l552_tim1_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM1>
{
    typedef stm32l552_tim1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM1>
{
    typedef stm32l552_tim1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM1>
{
    typedef stm32l552_tim1_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM15>
{
    typedef stm32l552_tim15_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM15>
{
    typedef stm32l552_tim15_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM15>
{
    typedef stm32l552_tim15_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM15>
{
    typedef stm32l552_tim15_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM16>
{
    typedef stm32l552_tim16_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM16>
{
    typedef stm32l552_tim16_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM16>
{
    typedef stm32l552_tim16_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM16>
{
    typedef stm32l552_tim16_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM17>
{
    typedef stm32l552_tim17_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM17>
{
    typedef stm32l552_tim17_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM17>
{
    typedef stm32l552_tim17_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM17>
{
    typedef stm32l552_tim17_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM2>
{
    typedef stm32l552_tim2_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM2>
{
    typedef stm32l552_tim2_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM2>
{
    typedef stm32l552_tim2_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM2>
{
    typedef stm32l552_tim2_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM3>
{
    typedef stm32l552_tim3_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM3>
{
    typedef stm32l552_tim3_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM3>
{
    typedef stm32l552_tim3_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM3>
{
    typedef stm32l552_tim3_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM4>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM4>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM5>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_TIM5>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM4>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM4>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM5>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM5>
{
    typedef stm32l552_tim4_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM6>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM6>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM7>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, SEC_TIM7>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM6>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM6>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM7>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM7>
{
    typedef stm32l552_tim6_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L552, TIM8>
{
    typedef stm32l552_tim8_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TIM8>
{
    typedef stm32l552_tim8_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TIM8>
{
    typedef stm32l552_tim8_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TIM8>
{
    typedef stm32l552_tim8_t T;
    static T& V;
};

using sec_tim1_t = peripheral_t<mcu_svd, SEC_TIM1>;
using sec_tim15_t = peripheral_t<mcu_svd, SEC_TIM15>;
using sec_tim16_t = peripheral_t<mcu_svd, SEC_TIM16>;
using sec_tim17_t = peripheral_t<mcu_svd, SEC_TIM17>;
using sec_tim2_t = peripheral_t<mcu_svd, SEC_TIM2>;
using sec_tim3_t = peripheral_t<mcu_svd, SEC_TIM3>;
using sec_tim4_t = peripheral_t<mcu_svd, SEC_TIM4>;
using sec_tim5_t = peripheral_t<mcu_svd, SEC_TIM5>;
using sec_tim6_t = peripheral_t<mcu_svd, SEC_TIM6>;
using sec_tim7_t = peripheral_t<mcu_svd, SEC_TIM7>;
using sec_tim8_t = peripheral_t<mcu_svd, SEC_TIM8>;
...
template<int INST> struct sec_tim_traits {};

template<> struct sec_tim_traits<1>
{
    using sec_tim = sec_tim1_t;
};

template<> struct sec_tim_traits<15>
{
    using sec_tim = sec_tim15_t;
};

template<> struct sec_tim_traits<16>
{
    using sec_tim = sec_tim16_t;
};

template<> struct sec_tim_traits<17>
{
    using sec_tim = sec_tim17_t;
};

template<> struct sec_tim_traits<2>
{
    using sec_tim = sec_tim2_t;
};

template<> struct sec_tim_traits<3>
{
    using sec_tim = sec_tim3_t;
};

template<> struct sec_tim_traits<4>
{
    using sec_tim = sec_tim4_t;
};

template<> struct sec_tim_traits<5>
{
    using sec_tim = sec_tim5_t;
};

template<> struct sec_tim_traits<6>
{
    using sec_tim = sec_tim6_t;
};

template<> struct sec_tim_traits<7>
{
    using sec_tim = sec_tim7_t;
};

template<> struct sec_tim_traits<8>
{
    using sec_tim = sec_tim8_t;
};
