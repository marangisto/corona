...
template<>
struct peripheral_t<STM32L552, TSC>
{
    typedef stm32l552_tsc_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32L552, SEC_TSC>
{
    typedef stm32l552_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, TSC>
{
    typedef stm32l552_tsc_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32L562, SEC_TSC>
{
    typedef stm32l552_tsc_t T;
    static T& V;
};

using sec_tsc_t = peripheral_t<mcu_svd, SEC_TSC>;
