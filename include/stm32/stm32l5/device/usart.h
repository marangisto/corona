...
template<int INST> struct sec_lpuart_traits {};

template<> struct sec_lpuart_traits<1>
{
    using sec_lpuart = sec_lpuart1_t;
};

template<int INST> struct sec_uart_traits {};

template<> struct sec_uart_traits<4>
{
    using sec_uart = sec_uart4_t;
};

template<> struct sec_uart_traits<5>
{
    using sec_uart = sec_uart5_t;
};

template<int INST> struct sec_usart_traits {};

template<> struct sec_usart_traits<1>
{
    using sec_usart = sec_usart1_t;
};

template<> struct sec_usart_traits<2>
{
    using sec_usart = sec_usart2_t;
};

template<> struct sec_usart_traits<3>
{
    using sec_usart = sec_usart3_t;
};
...
{
    using uart = uart4_t;
    static constexpr alternate_function_t CTS_NSS = UART4_CTS_NSS;
...
{
    using uart = uart5_t;
    static constexpr alternate_function_t CTS_NSS = UART5_CTS_NSS;
