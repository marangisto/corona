...
struct stm32mp15xxx_adc_common_t
{
    ...
    volatile uint32_t CDR2; // [read-only] Common regular data register for dual mode
...
template<>
struct peripheral_t<STM32MP15xxx, ADC>
{
    typedef stm32mp15xxx_adc_t T;
    static T& V;
};
