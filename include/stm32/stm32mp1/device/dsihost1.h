...
struct stm32mp15xxx_dsihost1_t
{
    volatile uint32_t DSI_VR;      // [read-only] Host version register
    ...
    reserved_t<0x5> _0xf4;
    volatile uint32_t DSI_DLTRCR;  // [read-write] DSI Host data lane timer read configuration register
    ...
    reserved_t<0x4> _0x430;
    volatile uint32_t DSI_WRPCR;   // [read-write] DSI wrapper regulator and PLL control register
    reserved_t<0xef> _0x7f0;
    volatile uint32_t DSI_HWCFGR;  // [read-only] DSI Host hardware configuration register
    volatile uint32_t DSI_VERR;    // [read-only] DSI Host version register
    volatile uint32_t DSI_IPIDR;   // [read-only] DSI Host identification register
    volatile uint32_t DSI_SIDR;    // [read-only] DSI Host size identification register

    static constexpr uint32_t DSI_VR_RESET_VALUE = 0x3133312a;
    ...
    static constexpr uint32_t DSI_DLTRCR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t DSI_DLTRCR_MRD_TIME =   // MRD_TIME
        bit_field_t<0, 0x7fff>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_SKEWCL =             // SKEWCL
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_SKEWDL =             // SKEWDL
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_LPTXSRCL =           // LPTXSRCL
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_WPCR1_LPTXSRDL =           // LPTXSRDL
        bit_field_t<8, 0x3>::value<X>();
    static constexpr uint32_t DSI_WPCR1_SDDCCL = 0x1000;     // SDDCCL
    static constexpr uint32_t DSI_WPCR1_SDDCDL = 0x2000;     // SDDCDL
    static constexpr uint32_t DSI_WPCR1_HSTXSRUCL = 0x10000; // HSTXSRUCL
    static constexpr uint32_t DSI_WPCR1_HSTXSRDCL = 0x20000; // HSTXSRDCL
    static constexpr uint32_t DSI_WPCR1_HSTXSRUDL = 0x40000; // HSTXSRUDL
    static constexpr uint32_t DSI_WPCR1_HSTXSRDDL = 0x80000; // HSTXSRDDL
    ...
    static constexpr uint32_t DSI_WRPCR_BGREN = 0x10000000; // BGREN

    static constexpr uint32_t DSI_HWCFGR_RESET_VALUE = 0x5a01;
    template<uint32_t X>
    static constexpr uint32_t DSI_HWCFGR_TECHNO =     // TECHNO
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_HWCFGR_FIFOSIZE =   // FIFOSIZE
        bit_field_t<4, 0xfff>::value<X>();

    static constexpr uint32_t DSI_VERR_RESET_VALUE = 0x20;
    template<uint32_t X>
    static constexpr uint32_t DSI_VERR_MINREV =   // MINREV
        bit_field_t<0, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t DSI_VERR_MAJREV =   // MAJREV
        bit_field_t<4, 0xf>::value<X>();

    static constexpr uint32_t DSI_IPIDR_RESET_VALUE = 0x160071;

    static constexpr uint32_t DSI_SIDR_RESET_VALUE = 0xa3c5dd02;
};


template<>
struct peripheral_t<STM32MP15xxx, DSIHOST1>
{
    typedef stm32mp15xxx_dsihost1_t T;
    static T& V;
};
