...
struct stm32mp15xxx_lptim2_t
{
    ...
    volatile uint32_t LPTIM_CFGR2;   // [read-write] LPTIM configuration register 2
    reserved_t<0xf2> _0x3f0;
    volatile uint32_t LPTIM2_HWCFGR; // [read-only] LPTIM 2 peripheral hardware configuration register
    ...
    static constexpr uint32_t LPTIM2_HWCFGR_RESET_VALUE = 0x10804;
    template<uint32_t X>
    static constexpr uint32_t LPTIM2_HWCFGR_CFG1 =   // CFG1
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM2_HWCFGR_CFG2 =   // CFG2
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM2_HWCFGR_CFG3 =   // CFG3
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM2_HWCFGR_CFG4 =   // CFG4
    ...
    static constexpr uint32_t LPTIM_CFGR2_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t LPTIM_CFGR2_IN1SEL =   // IN1SEL
        bit_field_t<0, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM_CFGR2_IN2SEL =   // IN2SEL
...
template<>
struct peripheral_t<STM32MP15xxx, LPTIM2>
{
    typedef stm32mp15xxx_lptim2_t T;
    static T& V;
};
