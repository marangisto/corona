...
struct stm32mp15xxx_lptim4_t
{
    ...
    volatile uint32_t LPTIM4_HWCFGR; // [read-only] LPTIM 4 peripheral hardware configuration register
    ...
    static constexpr uint32_t LPTIM4_HWCFGR_RESET_VALUE = 0x804;
    template<uint32_t X>
    static constexpr uint32_t LPTIM4_HWCFGR_CFG1 =   // CFG1
        bit_field_t<0, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM4_HWCFGR_CFG2 =   // CFG2
        bit_field_t<8, 0xff>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM4_HWCFGR_CFG3 =   // CFG3
        bit_field_t<16, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t LPTIM4_HWCFGR_CFG4 =   // CFG4
...
template<>
struct peripheral_t<STM32MP15xxx, LPTIM4>
{
    typedef stm32mp15xxx_lptim4_t T;
    static T& V;
};
