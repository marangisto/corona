...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA0, ETH1_CRS> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, ETH1_CLK> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, ETH1_REF_CLK> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA1, ETH1_RX_CLK> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, I2S3_WS> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, SAI4_FS_B> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA10, SPI3_NSS> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA11, I2C5_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA11, I2C6_SCL> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA12, I2C5_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA12, I2C6_SDA> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA13, DEBUG_DBTRGI> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA13, DEBUG_DBTRGO> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA13, RCC_MCO_1> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA13, UART4_TX> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA14, DEBUG_DBTRGI> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA14, DEBUG_DBTRGO> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA14, RCC_MCO_2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, CEC> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, DEBUG_DBTRGI> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, LTDC_R1> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, SAI4_D2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, SAI4_FS_A> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, SDMMC1_CDIR> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, SDMMC1_D5> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, SDMMC2_CDIR> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, SDMMC2_D5> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA15, UART7_TX> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA2, ETH1_MDIO> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA2, LPTIM4_OUT> { static const alt_fun_t AF = AF3; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA2, SDMMC2_D0DIR> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA3, ETH1_COL> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA3, LPTIM5_OUT> { static const alt_fun_t AF = AF3; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, HDP_HDP0> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, SAI4_D2> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA4, SAI4_FS_A> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA5, SAI4_CK1> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA5, SAI4_MCLK_A> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA6, SAI4_CK2> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA6, SAI4_SCK_A> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, ETH1_CRS_DV> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, ETH1_RX_CTL> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, ETH1_RX_DV> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, I2S1_SDO> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, QUADSPI_CLK> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, SAI4_D1> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA7, SAI4_SD_A> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, I2S3_SDO> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, SAI4_SD_B> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, SDMMC2_CKIN> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, SDMMC2_D4> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, SPI3_MOSI> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, UART7_RX> { static const alt_fun_t AF = AF13; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA8, USB_OTG_HS_SOF> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA9, SDMMC2_CDIR> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PA9, SDMMC2_D5> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB0, ETH1_RXD2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB0, MDIOS_MDIO> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB1, ETH1_RXD3> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB1, MDIOS_MDC> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB10, ETH1_RX_ER> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB10, QUADSPI_BK1_NCS> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB11, DSIHOST_TE> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB11, ETH1_TX_CTL> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB11, ETH1_TX_EN> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, ETH1_TXD0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, I2C6_SMBA> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB12, USART3_RX> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, DFSDM1_CKIN1> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, DFSDM1_CKOUT> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, ETH1_TXD1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB13, LPTIM2_OUT> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, DEBUG_TRACED4> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, DFSDM1_CKIN1> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, I2S3_SDO> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, I2S_CKIN> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, QUADSPI_CLK> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, RTC_OUT2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, RTC_OUT_ALARM2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, RTC_OUT_CALIB2> { static const alt_fun_t AF = AF1; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, UART4_RX> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB2, USART1_RX> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, DEBUG_TRACED9> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, SAI4_CK1> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, SAI4_MCLK_A> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB3, UART7_RX> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, DEBUG_TRACED8> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, SAI4_CK2> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, SAI4_SCK_A> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB4, UART7_TX> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, DCMI_D10> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, ETH1_CLK> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, ETH1_PPS_OUT> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, LTDC_G7> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, SAI4_D1> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, SAI4_SD_A> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB5, UART5_RX> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB6, UART5_TX> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB7, SDMMC2_D1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, ETH1_TXD3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, FDCAN1_RX> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, HDP_HDP6> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, SDMMC1_CKIN> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, SDMMC1_D4> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB8, SDMMC2_CKIN> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, HDP_HDP7> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, SDMMC1_CDIR> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, SDMMC1_D5> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PB9, SDMMC2_CDIR> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, LPTIM2_IN2> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, LTDC_R5> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC0, QUADSPI_BK2_NCS> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC1, ETH1_MDC> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, DEBUG_TRACED2> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC10, SAI4_MCLK_B> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, DEBUG_TRACED3> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC11, SAI4_SCK_B> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, DEBUG_TRACECLK> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, I2S3_SDO> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, RCC_MCO_2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, SAI4_D3> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC12, SAI4_SD_B> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC2, DCMI_PIXCLK> { static const alt_fun_t AF = AF13; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC2, ETH1_TXD2> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC3, DEBUG_TRACECLK> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC3, DFSDM1_DATIN1> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC3, ETH1_TX_CLK> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC4, ETH1_RXD0> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC4, I2S1_MCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC4, SPDIFRX_IN2> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, DFSDM1_DATIN2> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, ETH1_RXD1> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, SAI1_D3> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, SAI1_D4> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, SAI4_D3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, SAI4_D4> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC5, SPDIFRX_IN3> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, DSIHOST_TE> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, HDP_HDP1> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC6, SDMMC2_D0DIR> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, HDP_HDP4> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC7, SDMMC2_D123DIR> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC8, DEBUG_TRACED0> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC8, UART4_TX> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PC9, DEBUG_TRACED1> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, DFSDM1_DATIN7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, I2C5_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, I2C6_SDA> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, SAI3_SCK_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, SDMMC3_CMD> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD0, UART4_RX> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, DFSDM1_CKIN7> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, I2C5_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, I2C6_SCL> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, SAI3_SD_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD1, SDMMC3_D0> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, I2C5_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, I2S3_SDI> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, LTDC_B3> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, RTC_REFIN> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, SAI3_FS_B> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, SPI3_MISO> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD10, TIM16_BKIN> { static const alt_fun_t AF = AF1; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD11, I2C1_SMBA> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD12, I2C1_SCL> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD13, DSIHOST_TE> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD13, I2C1_SDA> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD13, I2C4_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD13, I2S3_MCK> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD14, SAI3_MCLK_B> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, LTDC_R1> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, SAI3_MCLK_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, TIM4_CH4> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD15, UART8_CTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, DCMI_D11> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, I2C5_SMBA> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD2, UART4_RX> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, HDP_HDP5> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, SDMMC1_D123DIR> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, SDMMC1_D7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, SDMMC2_D123DIR> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD3, SDMMC2_D7> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, DFSDM1_CKIN0> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, FMC_NOE> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, SAI3_FS_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD4, SDMMC3_D1> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD5, SDMMC3_D2> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, TIM16_CH1N> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD6, USART2_RX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, DEBUG_TRACED6> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, I2C2_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, SDMMC3_D3> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD7, SPDIFRX_IN0> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, LTDC_B7> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, SAI3_SCK_B> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, SPDIFRX_IN1> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD8, USART3_TX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, DCMI_HSYNC> { static const alt_fun_t AF = AF13; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, LTDC_B0> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PD9, SAI3_SD_B> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, I2S3_CK> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, SAI4_MCLK_B> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE0, SPI3_SCK> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, I2S2_MCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, LPTIM1_IN2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE1, SAI3_SD_B> { static const alt_fun_t AF = AF6; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, DCMI_D4> { static const alt_fun_t AF = AF13; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE11, USART6_CK> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE12, SDMMC1_D0DIR> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, DCMI_D6> { static const alt_fun_t AF = AF13; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE13, HDP_HDP2> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, LTDC_G0> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, SAI2_MCLK_B> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, SDMMC1_D123DIR> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, UART8_DE> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE14, UART8_RTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, FMC_D12> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, FMC_NCE2> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, HDP_HDP3> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, LTDC_R7> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, TIM15_BKIN> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, TIM1_BKIN> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, UART8_CTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, USART2_CTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE15, USART2_NSS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, DEBUG_TRACECLK> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, ETH1_TXD3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE2, I2C4_SCL> { static const alt_fun_t AF = AF4; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE3, SDMMC2_CK> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, SDMMC1_CKIN> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, SDMMC1_D4> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, SDMMC2_CKIN> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE4, SDMMC2_D4> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, DEBUG_TRACED3> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, SDMMC1_D0DIR> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, SDMMC1_D6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, SDMMC2_D0DIR> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE5, SDMMC2_D6> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, DEBUG_TRACED2> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, SDMMC1_D2> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE6, SDMMC2_D0> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PE7, TIM3_ETR> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF0, SDMMC3_CKIN> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF0, SDMMC3_D0> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF1, I2C2_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF1, SDMMC3_CDIR> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF1, SDMMC3_CMD> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, QUADSPI_CLK> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, SAI1_D3> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, SAI1_D4> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, SAI4_D3> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF10, SAI4_D4> { static const alt_fun_t AF = AF3; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF11, LTDC_G5> { static const alt_fun_t AF = AF14; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF12, DEBUG_TRACED4> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF12, ETH1_RXD4> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, DEBUG_TRACED5> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, DFSDM1_DATIN3> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, DFSDM1_DATIN6> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, ETH1_RXD5> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, I2C1_SMBA> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF13, I2C4_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, DEBUG_TRACED6> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, DFSDM1_CKIN6> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, ETH1_RXD6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, I2C1_SCL> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF14, I2C4_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF15, DEBUG_TRACED7> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF15, ETH1_RXD7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF15, I2C1_SDA> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF2, SDMMC1_D0DIR> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF2, SDMMC2_D0DIR> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF2, SDMMC3_D0DIR> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF3, ETH1_TX_ER> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF4, SDMMC3_D1> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF4, SDMMC3_D123DIR> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF4, USART2_RX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF5, SDMMC3_D2> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF5, USART2_TX> { static const alt_fun_t AF = AF7; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF6, SAI4_SCK_B> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF8, DEBUG_TRACED12> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PF9, DEBUG_TRACED13> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG0, DEBUG_TRACED0> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG0, DFSDM1_DATIN0> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG0, ETH1_TXD4> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG1, DEBUG_TRACED1> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG1, ETH1_TXD5> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, DCMI_D2> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, DEBUG_TRACED10> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, QUADSPI_BK2_IO2> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, SAI2_SD_B> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG10, UART8_CTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, DCMI_D3> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, DEBUG_TRACED11> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, ETH1_TX_CTL> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, ETH1_TX_EN> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, LTDC_B3> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, SPDIFRX_IN0> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, UART4_TX> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG11, USART1_TX> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, ETH1_PHY_INTN> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, SAI4_CK2> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, SAI4_SCK_A> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG12, SPDIFRX_IN1> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, DEBUG_TRACED0> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, ETH1_TXD0> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, SAI1_CK2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, SAI1_SCK_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, SAI4_CK1> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, SAI4_MCLK_A> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG13, USART6_NSS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, DEBUG_TRACED1> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, ETH1_TXD1> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, SAI4_D1> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG14, SAI4_SD_A> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, DEBUG_TRACED7> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, I2C2_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, SAI1_D2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, SAI1_FS_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, SDMMC3_CK> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, USART6_CTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG15, USART6_NSS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG2, DEBUG_TRACED2> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG2, ETH1_TXD6> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG2, RCC_MCO_2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG2, TIM8_BKIN> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG3, DEBUG_TRACED3> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG3, DFSDM1_CKIN1> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG3, ETH1_TXD7> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG3, TIM8_BKIN2> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG4, ETH1_GTX_CLK> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG4, TIM1_BKIN2> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG5, ETH1_CLK125> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG6, DEBUG_TRACED14> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG6, LTDC_R7> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG6, SDMMC2_CMD> { static const alt_fun_t AF = AF10; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, DEBUG_TRACED5> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, LTDC_CLK> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, QUADSPI_BK2_IO3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, QUADSPI_CLK> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, SAI1_MCLK_A> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, UART8_DE> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, UART8_RTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG7, USART6_CK> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, DEBUG_TRACED15> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, ETH1_CLK> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, ETH1_PPS_OUT> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, LTDC_G7> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, SAI4_D2> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, SAI4_FS_A> { static const alt_fun_t AF = AF10; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, SPDIFRX_IN2> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, SPI6_NSS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, TIM2_CH1> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, TIM2_ETR> { static const alt_fun_t AF = AF1; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, TIM8_ETR> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, USART3_DE> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG8, USART3_RTS> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, DEBUG_DBTRGO> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, FMC_NCE> { static const alt_fun_t AF = AF12; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, LTDC_R1> { static const alt_fun_t AF = AF14; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PG9, SPDIFRX_IN3> { static const alt_fun_t AF = AF8; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH10, I2C1_SMBA> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH11, I2C1_SCL> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH12, HDP_HDP2> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH12, I2C1_SDA> { static const alt_fun_t AF = AF5; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH2, ETH1_CRS> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH3, DFSDM1_CKIN4> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH3, ETH1_COL> { static const alt_fun_t AF = AF11; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH5, SAI4_SD_B> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, ETH1_RXD2> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, I2C2_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH6, MDIOS_MDIO> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, ETH1_RXD3> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, I2C3_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PH7, MDIOS_MDC> { static const alt_fun_t AF = AF12; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, ETH1_RX_ER> { static const alt_fun_t AF = AF11; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, HDP_HDP0> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, LTDC_HSYNC> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, USART3_CTS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI10, USART3_NSS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI11, I2S_CKIN> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI11, LTDC_G6> { static const alt_fun_t AF = AF9; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI11, RCC_MCO_1> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI12, DEBUG_TRACED0> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI12, HDP_HDP0> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI12, LTDC_HSYNC> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI13, DEBUG_TRACED1> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI13, HDP_HDP1> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI13, LTDC_VSYNC> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI14, DEBUG_TRACECLK> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PI9, HDP_HDP1> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ0, DEBUG_TRACED8> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ1, DEBUG_TRACED9> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ13, LTDC_G4> { static const alt_fun_t AF = AF9; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ2, DEBUG_TRACED10> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ2, DSIHOST_TE> { static const alt_fun_t AF = AF13; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ2, LTDC_R3> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ3, DEBUG_TRACED11> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ3, LTDC_R4> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ4, DEBUG_TRACED12> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ4, LTDC_R5> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ5, DEBUG_TRACED2> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ5, HDP_HDP2> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ5, LTDC_R6> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ6, DEBUG_TRACED3> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ6, HDP_HDP3> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ7, DEBUG_TRACED13> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ8, DEBUG_TRACED14> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PJ9, DEBUG_TRACED15> { static const alt_fun_t AF = AF0; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK1, DEBUG_TRACED4> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK1, HDP_HDP4> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK2, DEBUG_TRACED5> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK2, HDP_HDP5> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK5, DEBUG_TRACED6> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK5, HDP_HDP6> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK5, LTDC_B6> { static const alt_fun_t AF = AF14; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK6, DEBUG_TRACED7> { static const alt_fun_t AF = AF0; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PK6, HDP_HDP7> { static const alt_fun_t AF = AF2; };
...
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ0, I2C2_SCL> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ0, I2C6_SCL> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ0, I2S1_CK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ0, SPI1_SCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ0, SPI6_SCK> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ0, USART1_CK> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, I2C2_SDA> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, I2C4_SDA> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, I2C5_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, I2C6_SDA> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, I2S1_SDI> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, SPI1_MISO> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, SPI6_MISO> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ1, USART1_RX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, I2C2_SCL> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, I2C4_SMBA> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, I2C5_SMBA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, I2C6_SCL> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, I2S1_SDO> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, SPI1_MOSI> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, SPI6_MOSI> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ2, USART1_TX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, I2C2_SDA> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, I2C4_SDA> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, I2C5_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, I2C6_SDA> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, I2S1_WS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, SPI1_NSS> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, SPI6_NSS> { static const alt_fun_t AF = AF8; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, USART1_CTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ3, USART1_NSS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ4, I2C2_SCL> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ4, I2C4_SCL> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ4, I2C5_SCL> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ4, I2C6_SCL> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ5, I2C2_SDA> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ5, I2C4_SDA> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ5, I2C5_SDA> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ5, I2C6_SDA> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ5, USART1_DE> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ5, USART1_RTS> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ6, I2C2_SCL> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ6, I2C4_SMBA> { static const alt_fun_t AF = AF6; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ6, I2C6_SCL> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ6, I2S1_MCK> { static const alt_fun_t AF = AF5; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ6, USART1_CK> { static const alt_fun_t AF = AF4; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ6, USART1_RX> { static const alt_fun_t AF = AF7; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ7, I2C2_SDA> { static const alt_fun_t AF = AF3; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ7, I2C6_SDA> { static const alt_fun_t AF = AF2; };
template<gpio_conf_t CFG> struct alt_fun_traits<CFG, PZ7, USART1_TX> { static const alt_fun_t AF = AF7; };
