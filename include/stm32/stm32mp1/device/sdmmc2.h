...
template<> struct sdmmc_traits<2>
{
    ...
    static constexpr alternate_function_t CDIR = SDMMC2_CDIR;
    static constexpr alternate_function_t CK = SDMMC2_CK;
    static constexpr alternate_function_t CKIN = SDMMC2_CKIN;
    static constexpr alternate_function_t CMD = SDMMC2_CMD;
    static constexpr alternate_function_t D0 = SDMMC2_D0;
    static constexpr alternate_function_t D0DIR = SDMMC2_D0DIR;
    static constexpr alternate_function_t D1 = SDMMC2_D1;
    static constexpr alternate_function_t D123DIR = SDMMC2_D123DIR;
...
template<> struct sdmmc_traits<3>
{
    using sdmmc = sdmmc3_t;
    static constexpr alternate_function_t CDIR = SDMMC3_CDIR;
    static constexpr alternate_function_t CK = SDMMC3_CK;
    static constexpr alternate_function_t CKIN = SDMMC3_CKIN;
    static constexpr alternate_function_t CMD = SDMMC3_CMD;
    static constexpr alternate_function_t D0 = SDMMC3_D0;
    static constexpr alternate_function_t D0DIR = SDMMC3_D0DIR;
    static constexpr alternate_function_t D1 = SDMMC3_D1;
    static constexpr alternate_function_t D123DIR = SDMMC3_D123DIR;
    static constexpr alternate_function_t D2 = SDMMC3_D2;
    static constexpr alternate_function_t D3 = SDMMC3_D3;
};
