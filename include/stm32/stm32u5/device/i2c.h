...
////
//
//      STM32U5 I2C peripherals
//
///

// I2C1: Inter-integrated circuit

struct stm32u5xx_i2c1_t
{
    ...
    volatile uint32_t I2C_AUTOCR; // I2C Autonomous mode control register
    ...
    static constexpr uint32_t CR1_FMP = 0x1000000; // Fast-mode Plus 20 mA drive enable
    static constexpr uint32_t CR1_ADDRACLR = 0x40000000; // Address match flag (ADDR) automatic clear
    static constexpr uint32_t CR1_STOPFACLR = 0x80000000; // STOP detection flag (STOPF) automatic clear
    ...
    static constexpr uint32_t I2C_AUTOCR_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t I2C_AUTOCR_TCDMAEN = 0x40; // DMA request enable on Transfer Complete event
    static constexpr uint32_t I2C_AUTOCR_TCRDMAEN = 0x80; // DMA request enable on Transfer Complete Reload event
    typedef bit_field_t<16, 0xf> I2C_AUTOCR_TRIGSEL; // Trigger selection
    static constexpr uint32_t I2C_AUTOCR_TRIGPOL = 0x100000; // Trigger polarity
    static constexpr uint32_t I2C_AUTOCR_TRIGEN = 0x200000; // Trigger enable
};

template<>
struct peripheral_t<STM32U5xx, I2C1>
{
    static constexpr periph_t P = I2C1;
    using T = stm32u5xx_i2c1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32U5xx, I2C2>
{
...
template<>
struct peripheral_t<STM32U5xx, I2C3>
{
...
template<>
struct peripheral_t<STM32U5xx, I2C4>
{
...
template<>
struct peripheral_t<STM32U5xx, SEC_I2C1>
{
    static constexpr periph_t P = SEC_I2C1;
    using T = stm32u5xx_i2c1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32U5xx, SEC_I2C2>
{
    static constexpr periph_t P = SEC_I2C2;
    using T = stm32u5xx_i2c1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32U5xx, SEC_I2C3>
{
    static constexpr periph_t P = SEC_I2C3;
    using T = stm32u5xx_i2c1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32U5xx, SEC_I2C4>
{
    static constexpr periph_t P = SEC_I2C4;
    using T = stm32u5xx_i2c1_t;
    static T& V;
};
...
using sec_i2c1_t = peripheral_t<svd, SEC_I2C1>;
using sec_i2c2_t = peripheral_t<svd, SEC_I2C2>;
using sec_i2c3_t = peripheral_t<svd, SEC_I2C3>;
using sec_i2c4_t = peripheral_t<svd, SEC_I2C4>;
