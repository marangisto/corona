...
////
//
//      STM32U5 ICACHE peripherals
//
///

// ICACHE: ICache

struct stm32u5xx_icache_t
{
...
template<>
struct peripheral_t<STM32U5xx, ICACHE>
{
    static constexpr periph_t P = ICACHE;
    using T = stm32u5xx_icache_t;
    static T& V;
};

template<>
struct peripheral_t<STM32U5xx, SEC_ICACHE>
{
