...
////
//
//      STM32U5 RTC peripherals
//
///

// RTC: Real-time clock

struct stm32u5xx_rtc_t
{
    ...
    volatile uint32_t SECCFGR; // RTC secure mode control register
    ...
    typedef bit_field_t<0, 0xffffffff> SSR_SS; // SS
    ...
    typedef bit_field_t<8, 0x3> ICSR_BIN; // BIN
    typedef bit_field_t<10, 0x7> ICSR_BCDU; // BCDU
    ...
    static constexpr uint32_t CR_SSRUIE = 0x80; // SSRUIE
    ...
    static constexpr uint32_t CR_ALRAFCLR = 0x8000000; // ALRAFCLR
    static constexpr uint32_t CR_ALRBFCLR = 0x10000000; // ALRBFCLR
    ...
    static constexpr uint32_t SECCFGR_SEC = 0x8000; // SEC
    static constexpr uint32_t SECCFGR_INITSEC = 0x4000; // INITSEC
    static constexpr uint32_t SECCFGR_CALSEC = 0x2000; // CALSEC
    static constexpr uint32_t SECCFGR_TSSEC = 0x8; // TSSEC
    static constexpr uint32_t SECCFGR_WUTSEC = 0x4; // WUTSEC
    static constexpr uint32_t SECCFGR_ALRBSEC = 0x2; // ALRBSEC
    static constexpr uint32_t SECCFGR_ALRASEC = 0x1; // ALRASEC
    ...
    static constexpr uint32_t ALRMASSR_SSCLR = 0x80000000; // SSCLR
    ...
    static constexpr uint32_t ALRMBSSR_SSCLR = 0x80000000; // SSCLR
    ...
    static constexpr uint32_t SR_SSRUF = 0x40; // SSRUF
    ...
    static constexpr uint32_t MISR_SSRUMF = 0x40; // SSRUMF
    ...
    static constexpr uint32_t SMISR_SSRUMF = 0x40; // SSRUMF
    ...
    static constexpr uint32_t SCR_CSSRUF = 0x40; // CSSRUF
...
template<>
struct peripheral_t<STM32U5xx, RTC>
{
    static constexpr periph_t P = RTC;
    using T = stm32u5xx_rtc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32U5xx, SEC_RTC>
{
