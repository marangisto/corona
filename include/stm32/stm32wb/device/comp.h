...
struct stm32wb30_cm4_comp_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t COMP1_CSR_COMP1_PWRMODE =           // Comparator power mode
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP1_CSR_COMP1_INMSEL =            // Comparator input minus selection
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP1_CSR_COMP1_INPSEL =            // Comparator input plus selection
        bit_field_t<7, 0x3>::value<X>();
    static constexpr uint32_t COMP1_CSR_COMP1_POLARITY = 0x8000;  // Comparator output polarity
    template<uint32_t X>
    static constexpr uint32_t COMP1_CSR_COMP1_HYST =              // Comparator hysteresis
        bit_field_t<16, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP1_CSR_COMP1_BLANKING =          // Comparator blanking source
    ...
    template<uint32_t X>
    static constexpr uint32_t COMP1_CSR_COMP1_INMESEL =           // Comparator input minus extended selection
    ...
    static constexpr uint32_t COMP2_CSR_COMP2_PWRMODE =           // Power Mode of the comparator 2
        bit_field_t<2, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP2_CSR_COMP2_INMSEL =            // Comparator 2 input minus selection bits
        bit_field_t<4, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t COMP2_CSR_COMP2_INPSEL =            // Comparator 1 input plus selection bit
        bit_field_t<7, 0x3>::value<X>();
    ...
    template<uint32_t X>
    static constexpr uint32_t COMP2_CSR_COMP2_INMESEL =           // comparator 2 input minus extended selection bits.
        bit_field_t<25, 0x3>::value<X>();
...
template<>
struct peripheral_t<STM32WB30_CM4, COMP>
{
    typedef stm32wb30_cm4_comp_t T;
    static T& V;
};
