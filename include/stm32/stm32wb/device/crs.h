...
{
    volatile uint32_t CR;   // [read-write] CRS control register
    volatile uint32_t CFGR; // [read-write] CRS configuration register
    ...
    template<uint32_t X>
    static constexpr uint32_t CFGR_SYNCDIV =             // SYNCDIV
