...
struct stm32wb30_cm4_crs_t
{
    ...
    static constexpr uint32_t CR_SWSYNC = 0x80; // Automatic trimming enable
    ...
    typedef bit_field_t<24, 0x7> CFGR_SYNCDIV; // SYNCDIV
    ...
    static constexpr uint32_t ICR_SYNCWARNC = 0x2; // warning clear flag
