...
struct stm32wb30_cm4_dbgmcu_t
{
    ...
    reserved_t<0xd> _0x3c;
    volatile uint32_t APB1FZR1;    // [read-write] APB1 Low Freeze Register CPU1
    volatile uint32_t C2AP_B1FZR1; // [read-write] APB1 Low Freeze Register CPU2
    volatile uint32_t APB1FZR2;    // [read-write] APB1 High Freeze Register CPU1
    volatile uint32_t C2APB1FZR2;  // [read-write] APB1 High Freeze Register CPU2
    volatile uint32_t APB2FZR;     // [read-write] APB2 Freeze Register CPU1
    ...
    static constexpr uint32_t APB1FZR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2AP_B1FZR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2APB2FZR_RESET_VALUE = 0x0;
    static constexpr uint32_t C2APB2FZR_DBG_TIM1_STOP = 0x800;    // TIM1 counter stopped when core is halted
    static constexpr uint32_t C2APB2FZR_DBG_TIM16_STOP = 0x20000; // TIM16 counter stopped when core is halted
    static constexpr uint32_t C2APB2FZR_DBG_TIM17_STOP = 0x40000; // TIM17 counter stopped when core is halted
};
...
{
    typedef stm32wb30_cm4_dbgmcu_t T;
    static T& V;
};
