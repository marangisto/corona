...
struct stm32wb30_cm4_dmamux_t
{
    ...
    static constexpr uint32_t RGCFR_RESET_VALUE = 0x0; // Reset value
    static constexpr uint32_t RGCFR_COF0 = 0x1; // Clear trigger Overrun Flag 0
    static constexpr uint32_t RGCFR_COF1 = 0x2; // Clear trigger Overrun Flag 1
    static constexpr uint32_t RGCFR_COF2 = 0x4; // Clear trigger Overrun Flag 2
    static constexpr uint32_t RGCFR_COF3 = 0x8; // Clear trigger Overrun Flag 3
};

template<>
struct peripheral_t<STM32WB10_CM4, DMAMUX>
{
    static constexpr periph_t P = DMAMUX;
    using T = stm32wb10_cm4_dmamux_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WB15_CM4, DMAMUX>
{
    static constexpr periph_t P = DMAMUX;
    using T = stm32wb10_cm4_dmamux_t;
    static T& V;
