...
struct stm32wb30_cm4_gpioe_t
{
    ...
    static constexpr uint32_t MODER_RESET_VALUE = 0x3ff;
    template<uint32_t X>
    static constexpr uint32_t MODER_MODER4 =   // Port x configuration bits (y = 0..15)
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
...
struct stm32wb30_cm4_gpioh_t
{
    ...
    static constexpr uint32_t MODER_RESET_VALUE = 0xcf;
    template<uint32_t X>
    static constexpr uint32_t MODER_MODER3 =   // Port x configuration bits (y = 0..15)
        bit_field_t<6, 0x3>::value<X>();
    template<uint32_t X>
...
{
    typedef stm32wb30_cm4_gpioa_t T;
    static T& V;
};
...
{
    typedef stm32wb30_cm4_gpiob_t T;
    static T& V;
};
...
{
    typedef stm32wb30_cm4_gpioc_t T;
    static T& V;
};
...
{
    typedef stm32wb30_cm4_gpioe_t T;
    static T& V;
};
...
{
    typedef stm32wb30_cm4_gpioh_t T;
    static T& V;
};
