...
struct stm32wb30_cm4_pwr_t
{
    ...
    volatile uint32_t PUCRH;  // [read-write] Power Port H pull-up control register
    volatile uint32_t PDCRH;  // [read-write] Power Port H pull-down control register
    reserved_t<0x8> _0x80;
    volatile uint32_t C2CR1;  // [read-write] CPU2 Power control register 1
    volatile uint32_t C2CR3;  // [read-write] CPU2 Power control register 3
    ...
    template<uint32_t X>
    static constexpr uint32_t CR1_LPMS =        // Low-power mode selection for CPU1
    ...
    static constexpr uint32_t SR2_RESET_VALUE = 0x2;
    ...
    static constexpr uint32_t CR5_RESET_VALUE = 0x4270;
    ...
    template<uint32_t X>
    static constexpr uint32_t CR5_SDSC =           // Step Down converter supplt startup current selection
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CR5_SDVOS =          // Step Down converter voltage output scaling
    ...
    static constexpr uint32_t PUCRH_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t PDCRH_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2CR1_RESET_VALUE = 0x0;
    ...
    template<uint32_t X>
    static constexpr uint32_t C2CR1_LPMS =             // Low-power mode selection for CPU2
        bit_field_t<0, 0x7>::value<X>();

    static constexpr uint32_t C2CR3_RESET_VALUE = 0x8000;
    ...
    static constexpr uint32_t EXTSCR_RESET_VALUE = 0x0;
