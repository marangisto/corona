...
struct stm32wb30_cm4_rcc_t
{
    ...
    volatile uint32_t PLLCFGR;      // [read-write] PLLSYS configuration register
    ...
    volatile uint32_t APB3RSTR;     // [read-write] APB3 peripheral reset register
    ...
    reserved_t<0x1a> _0x108;
    volatile uint32_t EXTCFGR;      // Extended clock recovery register
    reserved_t<0xf> _0x148;
    volatile uint32_t C2AHB1ENR;    // [read-write] CPU2 AHB1 peripheral clock enable register
    volatile uint32_t C2AHB2ENR;    // [read-write] CPU2 AHB2 peripheral clock enable register
    volatile uint32_t C2AHB3ENR;    // [read-write] CPU2 AHB3 peripheral clock enable register
    reserved_t<0x1> _0x158;
    volatile uint32_t C2APB1ENR1;   // [read-write] CPU2 APB1ENR1
    volatile uint32_t C2APB1ENR2;   // [read-write] CPU2 APB1 peripheral clock enable register 2
    volatile uint32_t C2APB2ENR;    // [read-write] CPU2 APB2ENR
    volatile uint32_t C2APB3ENR;    // [read-write] CPU2 APB3ENR
    volatile uint32_t C2AHB1SMENR;  // [read-write] CPU2 AHB1 peripheral clocks enable in Sleep and Stop modes register
    volatile uint32_t C2AHB2SMENR;  // [read-write] CPU2 AHB2 peripheral clocks enable in Sleep and Stop modes register
    volatile uint32_t C2AHB3SMENR;  // [read-write] CPU2 AHB3 peripheral clocks enable in Sleep and Stop modes register
    reserved_t<0x1> _0x178;
    volatile uint32_t C2APB1SMENR1; // [read-write] CPU2 APB1SMENR1
    volatile uint32_t C2APB1SMENR2; // [read-write] CPU2 APB1 peripheral clocks enable in Sleep and Stop modes register 2
    volatile uint32_t C2APB2SMENR;  // [read-write] CPU2 APB2SMENR
    volatile uint32_t C2APB3SMENR;  // [read-write] CPU2 APB3SMENR

    static constexpr uint32_t CR_RESET_VALUE = 0x61;
    ...
    static constexpr uint32_t CFGR_RESET_VALUE = 0x70000;
    template<uint32_t X>
    ...
    static constexpr uint32_t PLLCFGR_RESET_VALUE = 0x22040100;
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLR =               // Main PLLSYS division factor R for SYSCLK (system clock)
        bit_field_t<29, 0x7>::value<X>();
    static constexpr uint32_t PLLCFGR_PLLREN = 0x10000000; // Main PLLSYSR PLLCLK output enable
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLQ =               // Main PLLSYS division factor Q for PLLSYSUSBCLK
        bit_field_t<25, 0x7>::value<X>();
    static constexpr uint32_t PLLCFGR_PLLQEN = 0x1000000;  // Main PLLSYSQ output enable
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLP =               // Main PLL division factor P for PPLSYSSAICLK
        bit_field_t<17, 0x1f>::value<X>();
    static constexpr uint32_t PLLCFGR_PLLPEN = 0x10000;    // Main PLLSYSP output enable
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLN =               // Main PLLSYS multiplication factor N
        bit_field_t<8, 0x7f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLM =               // Division factor M for the main PLL and audio PLL (PLLSAI1 and PLLSAI2) input clock
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t PLLCFGR_PLLSRC =             // Main PLL, PLLSAI1 and PLLSAI2 entry clock source
        bit_field_t<0, 0x3>::value<X>();

    static constexpr uint32_t PLLSAI1CFGR_RESET_VALUE = 0x22040100;
    template<uint32_t X>
    static constexpr uint32_t PLLSAI1CFGR_PLLR =               // PLLSAI division factor R for PLLADC1CLK (ADC clock)
        bit_field_t<29, 0x7>::value<X>();
    static constexpr uint32_t PLLSAI1CFGR_PLLREN = 0x10000000; // PLLSAI PLLADC1CLK output enable
    template<uint32_t X>
    static constexpr uint32_t PLLSAI1CFGR_PLLQ =               // SAIPLL division factor Q for PLLSAIUSBCLK (48 MHz clock)
        bit_field_t<25, 0x7>::value<X>();
    static constexpr uint32_t PLLSAI1CFGR_PLLQEN = 0x1000000;  // SAIPLL PLLSAIUSBCLK output enable
    template<uint32_t X>
    static constexpr uint32_t PLLSAI1CFGR_PLLP =               // SAI1PLL division factor P for PLLSAICLK (SAI1clock)
        bit_field_t<17, 0x1f>::value<X>();
    static constexpr uint32_t PLLSAI1CFGR_PLLPEN = 0x10000;    // SAIPLL PLLSAI1CLK output enable
    template<uint32_t X>
    static constexpr uint32_t PLLSAI1CFGR_PLLN =               // SAIPLL multiplication factor for VCO
        bit_field_t<8, 0x7f>::value<X>();
    ...
    static constexpr uint32_t SMPSCR_RESET_VALUE = 0x301;
    template<uint32_t X>
    static constexpr uint32_t SMPSCR_SMPSSWS =   // Step Down converter clock switch status
        bit_field_t<8, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SMPSCR_SMPSDIV =   // Step Down converter clock prescaler
        bit_field_t<4, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SMPSCR_SMPSSEL =   // Step Down converter clock selection
        bit_field_t<0, 0x3>::value<X>();
    ...
    static constexpr uint32_t AHB3ENR_RESET_VALUE = 0x2080000;
    ...
    static constexpr uint32_t AHB1SMENR_RESET_VALUE = 0x11207;
    ...
    static constexpr uint32_t AHB2SMENR_RESET_VALUE = 0x1209f;
    ...
    static constexpr uint32_t AHB3SMENR_RESET_VALUE = 0x3070100;
    ...
    static constexpr uint32_t APB1SMENR1_RESET_VALUE = 0x85a04e01;
    ...
    static constexpr uint32_t APB1SMENR2_RESET_VALUE = 0x21;
    ...
    static constexpr uint32_t APB2SMENR_RESET_VALUE = 0x265800;
    ...
    template<uint32_t X>
    static constexpr uint32_t CCIPR_RNGSEL =       // RNG clock source selection
    ...
    template<uint32_t X>
    static constexpr uint32_t BDCR_LSCOSEL =           // Low speed clock output selection
    ...
    template<uint32_t X>
    static constexpr uint32_t CSR_RFWKPSEL =             // RF system wakeup clock source selection
        bit_field_t<14, 0x3>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t CSR_LSI2BW =               // LSI2 oscillator bias configuration
    ...
    static constexpr uint32_t HSECR_RESET_VALUE = 0x30;
    template<uint32_t X>
    static constexpr uint32_t HSECR_HSETUNE =       // HSE capacitor tuning
        bit_field_t<8, 0x3f>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t HSECR_HSEGMC =        // HSE current control
        bit_field_t<4, 0x7>::value<X>();
    ...
    static constexpr uint32_t EXTCFGR_RESET_VALUE = 0x30000;
    ...
    template<uint32_t X>
    static constexpr uint32_t EXTCFGR_C2HPRE =            // CPU2 AHB prescaler
        bit_field_t<4, 0xf>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t EXTCFGR_SHDHPRE =           // Shared AHB prescaler
        bit_field_t<0, 0xf>::value<X>();

    static constexpr uint32_t C2AHB1ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2AHB2ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2AHB3ENR_RESET_VALUE = 0x2080000;
    ...
    static constexpr uint32_t C2APB1ENR1_RESET_VALUE = 0x400;
    ...
    static constexpr uint32_t C2APB1ENR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2APB2ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2APB3ENR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2AHB1SMENR_RESET_VALUE = 0x11207;
    ...
    static constexpr uint32_t C2AHB2SMENR_RESET_VALUE = 0x1209f;
    ...
    static constexpr uint32_t C2AHB3SMENR_RESET_VALUE = 0x3070000;
    ...
    static constexpr uint32_t C2APB1SMENR1_RESET_VALUE = 0x85a04601;
    ...
    static constexpr uint32_t C2APB1SMENR2_RESET_VALUE = 0x21;
    ...
    static constexpr uint32_t C2APB2SMENR_RESET_VALUE = 0x265800;
    ...
    static constexpr uint32_t C2APB3SMENR_RESET_VALUE = 0x3;
