...
struct stm32wb35_cm4_sai1_t
{
    ...
    volatile uint32_t BFRCR; // Bframe configuration register
    volatile uint32_t BSLOTR; // BSlot register
    volatile uint32_t BIM; // BInterrupt mask register
    ...
    static constexpr uint32_t ACR1_SAIEN = 0x10000; // Audio block B enable
    ...
    typedef bit_field_t<7, 0x3f> ACR2_MUTECNT; // Mute counter
    ...
    static constexpr uint32_t ASR_WCKCFG = 0x4; // Wrong clock configuration flag
    ...
    static constexpr uint32_t BCR1_SAIEN = 0x10000; // Audio block B enable
    ...
    typedef bit_field_t<7, 0x3f> BCR2_MUTECNT; // Mute counter
    ...
    typedef bit_field_t<4, 0x3> PDMCR_MICNBR; // Number of microphones
    static constexpr uint32_t PDMCR_PDMEN = 0x1; // PDM enable

    static constexpr uint32_t PDMDLY_RESET_VALUE = 0x0; // Reset value
    typedef bit_field_t<28, 0x7> PDMDLY_DLYM4R; // Delay line for second microphone of pair 4
    typedef bit_field_t<24, 0x7> PDMDLY_DLYM4L; // Delay line for first microphone of pair 4
    typedef bit_field_t<20, 0x7> PDMDLY_DLYM3R; // Delay line for second microphone of pair 3
    typedef bit_field_t<16, 0x7> PDMDLY_DLYM3L; // Delay line for first microphone of pair 3
    ...
    typedef bit_field_t<4, 0x7> PDMDLY_DLYM1R; // Delay line for second microphone of pair 1
    typedef bit_field_t<0, 0x7> PDMDLY_DLYM1L; // Delay line for first microphone of pair 1
};
...
template<>
struct peripheral_t<STM32WB35_CM4, SAI1>
{
    static constexpr periph_t P = SAI1;
    using T = stm32wb35_cm4_sai1_t;
    static T& V;
};
