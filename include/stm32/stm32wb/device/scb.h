...
{
    typedef stm32wb30_cm4_scb_actrl_t T;
    static T& V;
};
...
template<>
struct peripheral_t<STM32WB50_CM4, SCB>
{
    typedef stm32wb50_cm4_scb_t T;
    static T& V;
};

template<>
struct peripheral_t<STM32WB55_CM4, SCB>
{
    typedef stm32wb50_cm4_scb_t T;
    static T& V;
};
