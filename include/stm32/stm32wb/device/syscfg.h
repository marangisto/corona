...
struct stm32wb30_cm4_syscfg_t
{
    ...
    volatile uint32_t SWPR;    // [write-only] SRAM2 write protection register
    volatile uint32_t SKR;     // [write-only] SKR
    volatile uint32_t SWPR2;   // [write-only] SRAM2 write protection register 2
    reserved_t<0x35> _0x100;
    volatile uint32_t IMR1;    // [read-write] CPU1 interrupt mask register 1
    volatile uint32_t IMR2;    // [read-write] CPU1 interrupt mask register 2
    volatile uint32_t C2IMR1;  // [read-write] CPU2 interrupt mask register 1
    volatile uint32_t C2IMR2;  // [read-write] CPU2 interrupt mask register 1
    volatile uint32_t SIPCR;   // [read-write] secure IP control register
    ...
    static constexpr uint32_t IMR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t IMR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2IMR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t C2IMR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SIPCR_RESET_VALUE = 0x0;
...
{
    typedef stm32wb30_cm4_syscfg_t T;
    static T& V;
};
