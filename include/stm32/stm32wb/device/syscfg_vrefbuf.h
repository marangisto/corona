...
////
//
//      STM32WB SYSCFG_VREFBUF peripherals
//
////
...
struct stm32wb55_cm4_syscfg_vrefbuf_t
{
    volatile uint32_t SYSCFG_MEMRMP;  // [read-write] memory remap register
    ...
    volatile uint32_t SYSCFG_SWPR;    // [write-only] SRAM2 write protection register
    volatile uint32_t SYSCFG_SKR;     // [write-only] SKR
    volatile uint32_t SYSCFG_SWPR2;   // [write-only] SRAM2 write protection register 2
    reserved_t<0x1> _0x30;
    volatile uint32_t VREFBUF_CSR;    // VREF control and status register
    volatile uint32_t VREFBUF_CCR;    // [read-write] calibration control register
    reserved_t<0x32> _0x100;
    volatile uint32_t SYSCFG_IMR1;    // [read-write] CPU1 interrupt mask register 1
    volatile uint32_t SYSCFG_IMR2;    // [read-write] CPU1 interrupt mask register 2
    volatile uint32_t SYSCFG_C2IMR1;  // [read-write] CPU2 interrupt mask register 1
    volatile uint32_t SYSCFG_C2IMR2;  // [read-write] CPU2 interrupt mask register 1
    volatile uint32_t SYSCFG_SIPCR;   // [read-write] secure IP control register

    static constexpr uint32_t SYSCFG_MEMRMP_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_MEMRMP_MEM_MODE =   // Memory mapping selection
        bit_field_t<0, 0x7>::value<X>();

    static constexpr uint32_t SYSCFG_CFGR1_RESET_VALUE = 0x7c000001;
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_CFGR1_FPU_IE =               // Floating Point Unit interrupts enable bits
    ...
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_EXTICR4_EXTI15 =   // EXTI15 configuration bits
        bit_field_t<12, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_EXTICR4_EXTI14 =   // EXTI14 configuration bits
        bit_field_t<8, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_EXTICR4_EXTI13 =   // EXTI13 configuration bits
        bit_field_t<4, 0x7>::value<X>();
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_EXTICR4_EXTI12 =   // EXTI12 configuration bits
        bit_field_t<0, 0x7>::value<X>();

    static constexpr uint32_t SYSCFG_SCSR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_SWPR_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_SKR_RESET_VALUE = 0x0;
    template<uint32_t X>
    static constexpr uint32_t SYSCFG_SKR_KEY =   // SRAM2 write protection key for software erase
        bit_field_t<0, 0xff>::value<X>();

    static constexpr uint32_t SYSCFG_SWPR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_IMR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_IMR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_C2IMR1_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_C2IMR2_RESET_VALUE = 0x0;
    ...
    static constexpr uint32_t SYSCFG_SIPCR_RESET_VALUE = 0x0;
...
template<>
struct peripheral_t<STM32WB55_CM4, SYSCFG_VREFBUF>
{
    typedef stm32wb55_cm4_syscfg_vrefbuf_t T;
    static T& V;
};
