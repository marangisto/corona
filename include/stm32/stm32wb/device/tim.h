...
template<>
struct peripheral_t<STM32WB10_CM4, TIM1>
{
    static constexpr periph_t P = TIM1;
    using T = stm32wb10_cm4_tim1_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WB15_CM4, TIM1>
{
    static constexpr periph_t P = TIM1;
    using T = stm32wb10_cm4_tim1_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WB10_CM4, TIM2>
{
    static constexpr periph_t P = TIM2;
    using T = stm32wb10_cm4_tim2_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WB15_CM4, TIM2>
{
    static constexpr periph_t P = TIM2;
    using T = stm32wb10_cm4_tim2_t;
    static T& V;
