...
////
//
//      STM32WL CRC peripherals
//
///

// CRC: Cyclic redundancy check calculation unit

struct stm32wl5x_cm0p_crc_t
{
...
template<>
struct peripheral_t<STM32WL5x_CM0P, CRC>
{
    static constexpr periph_t P = CRC;
    using T = stm32wl5x_cm0p_crc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, CRC>
{
    static constexpr periph_t P = CRC;
    using T = stm32wl5x_cm0p_crc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, CRC>
{
    static constexpr periph_t P = CRC;
    using T = stm32wl5x_cm0p_crc_t;
    static T& V;
