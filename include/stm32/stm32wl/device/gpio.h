...
////
//
//      STM32WL GPIO peripherals
//
///

// GPIOA: General-purpose I/Os

struct stm32wl5x_cm0p_gpioa_t
{
    ...
    typedef bit_field_t<30, 0x3> MODER_MODER15; // MODER15
    typedef bit_field_t<28, 0x3> MODER_MODER14; // MODER14
    typedef bit_field_t<26, 0x3> MODER_MODER13; // MODER13
    typedef bit_field_t<24, 0x3> MODER_MODER12; // MODER12
    typedef bit_field_t<22, 0x3> MODER_MODER11; // MODER11
    typedef bit_field_t<20, 0x3> MODER_MODER10; // MODER10
    typedef bit_field_t<18, 0x3> MODER_MODER9; // MODER9
    typedef bit_field_t<16, 0x3> MODER_MODER8; // MODER8
    typedef bit_field_t<14, 0x3> MODER_MODER7; // MODER7
    typedef bit_field_t<12, 0x3> MODER_MODER6; // MODER6
    typedef bit_field_t<10, 0x3> MODER_MODER5; // MODER5
    typedef bit_field_t<8, 0x3> MODER_MODER4; // MODER4
    typedef bit_field_t<6, 0x3> MODER_MODER3; // MODER3
    typedef bit_field_t<4, 0x3> MODER_MODER2; // MODER2
    typedef bit_field_t<2, 0x3> MODER_MODER1; // MODER1
    typedef bit_field_t<0, 0x3> MODER_MODER0; // MODER0
...
struct stm32wl5x_cm0p_gpioc_t
{
    ...
    static constexpr uint32_t MODER_RESET_VALUE = 0xfc003fff; // Reset value
    typedef bit_field_t<30, 0x3> MODER_MODER15; // Port x configuration bits (y = 0..15)
    typedef bit_field_t<28, 0x3> MODER_MODER14; // Port x configuration bits (y = 0..15)
    typedef bit_field_t<26, 0x3> MODER_MODER13; // Port x configuration bits (y = 0..15)
    typedef bit_field_t<12, 0x3> MODER_MODER6; // Port x configuration bits (y = 0..15)
...
struct stm32wl5x_cm0p_gpioh_t
{
    ...
    static constexpr uint32_t MODER_RESET_VALUE = 0xc0; // Reset value
    typedef bit_field_t<6, 0x3> MODER_MODER3; // Port x configuration bits (y = 0..15)
...
template<>
struct peripheral_t<STM32WL5x_CM0P, GPIOA>
{
    static constexpr periph_t P = GPIOA;
    using T = stm32wl5x_cm0p_gpioa_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, GPIOA>
{
    static constexpr periph_t P = GPIOA;
    using T = stm32wl5x_cm0p_gpioa_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, GPIOA>
{
    static constexpr periph_t P = GPIOA;
    using T = stm32wl5x_cm0p_gpioa_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WL5x_CM0P, GPIOB>
{
    static constexpr periph_t P = GPIOB;
    using T = stm32wl5x_cm0p_gpiob_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, GPIOB>
{
    static constexpr periph_t P = GPIOB;
    using T = stm32wl5x_cm0p_gpiob_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, GPIOB>
{
    static constexpr periph_t P = GPIOB;
    using T = stm32wl5x_cm0p_gpiob_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WL5x_CM0P, GPIOC>
{
    static constexpr periph_t P = GPIOC;
    using T = stm32wl5x_cm0p_gpioc_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, GPIOC>
{
    static constexpr periph_t P = GPIOC;
    using T = stm32wl5x_cm0p_gpioc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, GPIOC>
{
    static constexpr periph_t P = GPIOC;
    using T = stm32wl5x_cm0p_gpioc_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WL5x_CM0P, GPIOH>
{
    static constexpr periph_t P = GPIOH;
    using T = stm32wl5x_cm0p_gpioh_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, GPIOH>
{
    static constexpr periph_t P = GPIOH;
    using T = stm32wl5x_cm0p_gpioh_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, GPIOH>
{
    static constexpr periph_t P = GPIOH;
    using T = stm32wl5x_cm0p_gpioh_t;
    static T& V;
