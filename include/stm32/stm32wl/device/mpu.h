...
////
//
//      STM32WL MPU peripherals
//
///

// MPU: Memory protection unit

struct stm32wl5x_cm0p_mpu_t
{
...
template<>
struct peripheral_t<STM32WL5x_CM0P, MPU>
{
    static constexpr periph_t P = MPU;
    using T = stm32wl5x_cm0p_mpu_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, MPU>
{
    static constexpr periph_t P = MPU;
    using T = stm32wl5x_cm0p_mpu_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, MPU>
{
    static constexpr periph_t P = MPU;
    using T = stm32wl5x_cm0p_mpu_t;
    static T& V;
