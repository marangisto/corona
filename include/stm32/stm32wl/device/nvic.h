...
////
//
//      STM32WL NVIC peripherals
//
///

// NVIC: Nested Vectored Interrupt Controller

struct stm32wl5x_cm0p_nvic_t
{
...
struct stm32wl5x_cm0p_nvic_stir_t
{
...
template<>
struct peripheral_t<STM32WL5x_CM0P, NVIC>
{
    static constexpr periph_t P = NVIC;
    using T = stm32wl5x_cm0p_nvic_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, NVIC>
{
    static constexpr periph_t P = NVIC;
    using T = stm32wl5x_cm4_nvic_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WLE5_CM4, NVIC>
{
    static constexpr periph_t P = NVIC;
    using T = stm32wl5x_cm4_nvic_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WL5x_CM0P, NVIC_STIR>
{
    static constexpr periph_t P = NVIC_STIR;
    using T = stm32wl5x_cm0p_nvic_stir_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, NVIC_STIR>
{
    static constexpr periph_t P = NVIC_STIR;
    using T = stm32wl5x_cm0p_nvic_stir_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, NVIC_STIR>
{
    static constexpr periph_t P = NVIC_STIR;
    using T = stm32wl5x_cm0p_nvic_stir_t;
    static T& V;
