...
////
//
//      STM32WL SCB peripherals
//
///

// SCB: System control block

struct stm32wl5x_cm0p_scb_t
{
...
struct stm32wl5x_cm0p_scb_actrl_t
{
...
template<>
struct peripheral_t<STM32WL5x_CM0P, SCB>
{
    static constexpr periph_t P = SCB;
    using T = stm32wl5x_cm0p_scb_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, SCB>
{
    static constexpr periph_t P = SCB;
    using T = stm32wl5x_cm0p_scb_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, SCB>
{
    static constexpr periph_t P = SCB;
    using T = stm32wl5x_cm0p_scb_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WL5x_CM0P, SCB_ACTRL>
{
    static constexpr periph_t P = SCB_ACTRL;
    using T = stm32wl5x_cm0p_scb_actrl_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, SCB_ACTRL>
{
    static constexpr periph_t P = SCB_ACTRL;
    using T = stm32wl5x_cm0p_scb_actrl_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, SCB_ACTRL>
{
    static constexpr periph_t P = SCB_ACTRL;
    using T = stm32wl5x_cm0p_scb_actrl_t;
    static T& V;
