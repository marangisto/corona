...
////
//
//      STM32WL STK peripherals
//
///

// STK: SysTick timer

struct stm32wl5x_cm0p_stk_t
{
...
template<>
struct peripheral_t<STM32WL5x_CM0P, STK>
{
    static constexpr periph_t P = STK;
    using T = stm32wl5x_cm0p_stk_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, STK>
{
    static constexpr periph_t P = STK;
    using T = stm32wl5x_cm0p_stk_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, STK>
{
    static constexpr periph_t P = STK;
    using T = stm32wl5x_cm0p_stk_t;
    static T& V;
