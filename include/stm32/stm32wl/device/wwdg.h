...
////
//
//      STM32WL WWDG peripherals
//
///

// WWDG: System window watchdog

struct stm32wl5x_cm0p_wwdg_t
{
...
template<>
struct peripheral_t<STM32WL5x_CM0P, WWDG>
{
    static constexpr periph_t P = WWDG;
    using T = stm32wl5x_cm0p_wwdg_t;
    static T& V;
};

template<>
struct peripheral_t<STM32WL5x_CM4, WWDG>
{
    static constexpr periph_t P = WWDG;
    using T = stm32wl5x_cm0p_wwdg_t;
    static T& V;
...
template<>
struct peripheral_t<STM32WLE5_CM4, WWDG>
{
    static constexpr periph_t P = WWDG;
    using T = stm32wl5x_cm0p_wwdg_t;
    static T& V;
